...
public class xread
{
    ...
    throws FileNotFoundException, IOException
  {
    ...
    Object localObject1 = new ResolvingXMLReader();
    try
    {
      ((XMLFilterImpl)localObject1).setFeature("http://xml.org/sax/features/namespaces", bool1);
      ((XMLFilterImpl)localObject1).setFeature("http://xml.org/sax/features/validation", bool2);
    }
    catch (SAXException localSAXException1) {}
    Catalog localCatalog = ((ResolvingXMLFilter)localObject1).getCatalog();
    ...
    ((XMLFilterImpl)localObject1).setErrorHandler((ErrorHandler)localObject2);
    ...
    try
    {
      ((ResolvingXMLFilter)localObject1).parse(str1);
    }
    catch (SAXException localSAXException2)
    {
      System.out.println("SAX Exception: " + localSAXException2);
    }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\1.0\org\apache\xml\resolver\apps\xread.class
