  ...
  extends NGCCHandler
{
  ...
  private void action0()
    throws SAXException
  {
    this.result = new ModelGroupDeclImpl(this.$runtime.currentSchema, this.annotation, this.loc, this.$runtime.currentSchema.getTargetNamespace(), this.name, this.term);
  }
    ...
    throws SAXException
  {
    ...
    case 6: 
      ...
      {
        NGCCHandler h = new annotation(this, this._source, this.$runtime, 404, null, AnnotationContext.MODELGROUP_DECL);
    ...
    case 3: 
      ...
      {
        NGCCHandler h = new modelGroupBody(this, this._source, this.$runtime, 400, this.mloc, this.compositorName);
        spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
      }
      else
      {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\1.0\com\sun\xml\xsom\impl\parser\state\group.class
