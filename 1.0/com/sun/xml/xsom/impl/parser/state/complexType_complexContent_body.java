  ...
  extends NGCCHandler
{
    ...
    throws SAXException
  {
    ...
    case 1: 
      ...
      {
        NGCCHandler h = new attributeUses(this, this._source, this.$runtime, 245, this.owner);
    ...
    case 2: 
      ...
      {
        NGCCHandler h = new particle(this, this._source, this.$runtime, 247);
        spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
      }
      else
      {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\1.0\com\sun\xml\xsom\impl\parser\state\complexType_complexContent_body.class
