  ...
  extends NGCCHandler
{
    ...
    throws SAXException
  {
    ...
    case 9: 
      ...
      {
        NGCCHandler h = new annotation(this, this._source, this.$runtime, 565, null, AnnotationContext.WILDCARD);
  ...
  {
    return (this.$_ngcc_current_state == 0) || (this.$_ngcc_current_state == 9) || (this.$_ngcc_current_state == 1) || (this.$_ngcc_current_state == 5);
  }
  ...
  private WildcardImpl makeResult()
  {
    ...
    if ((this.ns == null) || (this.ns.equals("##any"))) {
      return new WildcardImpl.Any(this.$runtime.currentSchema, this.annotation, this.locator, mode);
    }
    if (this.ns.equals("##other")) {
      return new WildcardImpl.Other(this.$runtime.currentSchema, this.annotation, this.locator, this.$runtime.currentSchema.getTargetNamespace(), mode);
    }
    ...
    return new WildcardImpl.Finite(this.$runtime.currentSchema, this.annotation, this.locator, s, mode);
  }
}


/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\1.0\com\sun\xml\xsom\impl\parser\state\wildcardBody.class
