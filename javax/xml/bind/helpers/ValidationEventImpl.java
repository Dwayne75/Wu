  ...
  implements ValidationEvent
{
  ...
  public String toString()
  {
    ...
    return MessageFormat.format("[severity={0},message={1},locator={2}]", new Object[] { s, getMessage(), getLocator() });
  }
}


/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\javax\xml\bind\helpers\ValidationEventImpl.class
