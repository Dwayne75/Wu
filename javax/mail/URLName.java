...
public class URLName
{
  ...
  protected void parseString(String url)
  {
    ...
    if (url.regionMatches(protocolEnd + 1, "//", 0, 2))
    {
      ...
      if ((fullhost.length() > 0) && (fullhost.charAt(0) == '[')) {
        portindex = fullhost.indexOf(':', fullhost.indexOf(93));
      } else {
  ...
  public boolean equals(Object obj)
  {
    ...
    InetAddress a1 = getHostAddress();InetAddress a2 = u2.getHostAddress();
    if ((a1 != null) && (a2 != null))
    {
      if (!a1.equals(a2)) {
        return false;
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\javax\mail\URLName.class
