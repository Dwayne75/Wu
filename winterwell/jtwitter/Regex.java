...
public class Regex
{
  ...
  private static final String URL_VALID_DOMAIN = "(?:" + 
    ...
    "(?:" + "(?:(?:aero|asia|biz|cat|com|coop|edu|gov|info|int|jobs|mil|mobi|museum|name|net|org|pro|tel|travel|xxx)(?=\\P{Alnum}|$))" + "|" + "(?:xn--[0-9a-z]+)" + ")" + 
    ")" + 
    "|(?:" + "(?<=https?://)" + 
    "(?:" + 
  ...
  private static final String VALID_URL_PATTERN_STRING = "(((?:[^A-Z0-9@＠$#＃‪-‮]|^))((https?://)?(" + 
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\winterwell\jtwitter\Regex.class
