...
public final class MeshIO
{
  ...
  private boolean[] rowDirty = new boolean['Ȁ'];
  private int rowId = 0;
  ...
  public final void saveAllDirtyRows()
    throws IOException
  {
    for (int i = 0; i < 512; i++) {
      saveNextDirtyRow();
  ...
  public final void saveNextDirtyRow()
    throws IOException
  {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\javaone\MeshIO.class
