  ...
  implements MiscConstants, IntraServerConnectionListener, TimeConstants, Comparable<ServerEntry>, MonetaryConstants
{
  ...
  {
    if ((this.consumerKeyToUse != null) && (this.consumerKeyToUse.length() > 5) && (this.consumerSecretToUse != null) && 
      (this.consumerSecretToUse.length() > 5) && (this.applicationToken != null) && (this.applicationToken.length() > 5) && (this.applicationSecret != null) && 
      (this.applicationSecret.length() > 5)) {
      this.canTwit = true;
    } else {
      this.canTwit = false;
    }
    if ((this.champConsumerKeyToUse != null) && (this.champConsumerKeyToUse.length() > 5) && (this.champConsumerSecretToUse != null) && 
      (this.champConsumerSecretToUse.length() > 5) && (this.champApplicationToken != null) && (this.champApplicationToken.length() > 5) && (this.champApplicationSecret != null) && 
  ...
  public void createChampTwit(String message)
  {
    ...
    {
      Twit t = new Twit(this.name, message, this.champConsumerKeyToUse, this.champConsumerSecretToUse, this.champApplicationToken, this.champApplicationSecret, false);
      if (t != null) {
        Twit.twit(t);
      }
    }
  ...
  public void setAvailable(boolean available, boolean maintain, int currentPlayerCount, int plimit, int secsToShutdown, int mSize)
  {
    ...
    if (available != this.isAvailable)
    {
      ...
      if (available)
      {
        ...
        new ServerEntry.1(this, "ServerEntry.setAvailable-Thread", serverId)
  ...
  public final void sendSpawnpoints()
  {
    if (Servers.getLocalServerId() != this.id)
    {
      ...
      for (Kingdom kingdom : Kingdoms.getAllKingdoms())
      {
        ...
        if (villages.length > 0) {
          for (Village vill : villages)
          {
            ...
            lSpawns.add(new Spawnpoint(vill.getName(), (byte)1, toSend, (short)vill.getTokenX(), 
              (short)vill.getTokenY(), true, vill.kingdom));
          }
        }
      }
      if (lSpawns.size() > 0)
      {
        ...
        wcp.setSpawns((Spawnpoint[])lSpawns.toArray(new Spawnpoint[lSpawns.size()]));
  ...
  private final void sendKingdomInfo()
  {
    ...
    WcEpicStatusReport report;
    if (Servers.localServer.LOGINSERVER)
    {
      lsw.setWeather(Server.getWeather().getWindRotation(), Server.getWeather().getWindPower(), Server.getWeather()
        .getWindDir());
      WcKingdomInfo wc = new WcKingdomInfo(WurmId.getNextWCCommandId(), false, (byte)0);
      wc.encode();
      lsw.sendWebCommand((short)7, wc);
      report = new WcEpicStatusReport(WurmId.getNextWCCommandId(), false, 0, (byte)-1, -1);
    ...
    if ((this.client != null) && (!this.done)) {
      if (!this.client.isConnecting)
      {
        ...
        if (!this.done) {
          ...
          {
            if (this.client.loggedIn) {
              if (System.currentTimeMillis() - this.lastPing > 10000L)
              {
  ...
  {
    if (!kingdomExists(kingdomId)) {
      this.existingKingdoms.add(Byte.valueOf(kingdomId));
    }
  }
  
  boolean kingdomExists(byte kingdomId)
  {
    return this.existingKingdoms.contains(Byte.valueOf(kingdomId));
  }
  
  boolean removeKingdom(byte kingdomId)
  {
    return this.existingKingdoms.remove(Byte.valueOf(kingdomId));
  }
  ...
  {
    return 
      "ServerEntry [id: " + this.id + ", Name: " + this.name + ", IntraIP: " + this.INTRASERVERADDRESS + ':' + this.INTRASERVERPORT + ", ExternalIP: " + this.EXTERNALIP + ':' + this.EXTERNALPORT + ", canTwit: " + canTwit() + ']';
  }
  ...
  public final void movedArtifacts()
  {
    ...
    try
    {
      ...
      ps.setLong(1, getMovedArtifacts());
      ps.setInt(2, this.id);
      ps.executeUpdate();
    }
    catch (SQLException sqx)
  ...
  public final void saveNewGui(int oldId)
  {
    ...
    try
    {
      ...
      ps.setFloat(25, getSkillbasicval());
      ps.setFloat(26, getSkillmindval());
      ps.setFloat(27, getSkillfightval());
      ps.setFloat(28, getSkilloverallval());
      ps.setBoolean(29, this.EPIC);
      ps.setFloat(30, getCombatRatingModifier());
      ps.setString(31, getSteamServerPassword());
      ps.setBoolean(32, isUpkeep());
      ps.setInt(33, getMaxDeedSize());
      ps.setBoolean(34, isFreeDeeds());
      ps.setInt(35, getTraderMaxIrons());
      ps.setInt(36, getInitialTraderIrons());
      ps.setLong(37, getBreedingTimer());
      ps.setLong(38, getFieldGrowthTime());
      ps.setInt(39, getKingsmoneyAtRestart());
      ps.setString(40, this.motd);
      ps.setInt(41, getTunnelingHits());
      ps.setFloat(42, getSkillbcval());
      ps.setInt(43, oldId);
      ps.executeUpdate();
    }
    catch (SQLException sqx)
  ...
  public final void saveTimers()
  {
    ...
    try
    {
      ...
      ps.setLong(1, getSkillDaySwitch());
      ps.setLong(2, getSkillWeekSwitch());
      ps.setLong(3, getNextEpicPoll());
      ps.setLong(4, getFatigueSwitch());
      ps.setLong(5, getNextHota());
  ...
  {
    return getCurrentPlayersForSort() - entry.getCurrentPlayersForSort();
  }
  ...
  public void updateSpawns()
  {
    ...
    {
      logger.log(Level.WARNING, "Failed to update spawnpoints." + sqex
        .getMessage(), sqex);
    }
    finally
    {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\ServerEntry.class
