  ...
  implements MiscConstants
{
  ...
  public String toString()
  {
    ...
    {
      String verb = com.wurmonline.server.behaviours.Actions.actionEntrys[this.act].getActionString();
      if (this.rec != null)
      {
        buf.append(this.perf);
        buf.append(" ");
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\combat\BattleEvent.class
