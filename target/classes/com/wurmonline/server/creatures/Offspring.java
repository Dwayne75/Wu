...
public final class Offspring
{
  ...
  {
    offsprings.remove(Long.valueOf(motherid));
    Connection dbcon = null;
    PreparedStatement ps = null;
    try
    {
  ...
  {
    return (Offspring)offsprings.get(Long.valueOf(wurmid));
  }
  ...
  static String generateMaleName()
  {
    if (MALE_NAMES.length > 0)
    {
      ...
      if (num < 50) {
        return generateGenericPrefix() + MALE_NAMES[Server.rand.nextInt(MALE_NAMES.length)];
      }
      return MALE_NAMES[Server.rand.nextInt(MALE_NAMES.length)] + generateGenericPrefix();
    }
    return "";
  }
  ...
  static String generateFemaleName()
  {
    if (FEMALE_NAMES.length > 0)
    {
      ...
      if (num < 50) {
        return generateGenericPrefix() + FEMALE_NAMES[Server.rand.nextInt(FEMALE_NAMES.length)];
      }
      return FEMALE_NAMES[Server.rand.nextInt(FEMALE_NAMES.length)] + generateGenericPrefix();
    }
    return "";
  }
  ...
  static String[] createMaleNames()
  {
    ...
    return (String[])malelist.toArray(new String[malelist.size()]);
  }
  ...
  static String[] createFemaleNames()
  {
    ...
    return (String[])femalelist.toArray(new String[femalelist.size()]);
  }
  ...
  static String[] createGenericNames()
  {
    ...
    return (String[])genericlist.toArray(new String[genericlist.size()]);
  }
  ...
  private static String[] createMaleUnicornNames()
  {
    ...
    mul.add("Vulcan");
    mul.add("Saro");
    return (String[])mul.toArray(new String[mul.size()]);
  }
  ...
  private static String[] createFemaleUnicornNames()
  {
    ...
    ful.add("Venus");
    ful.add("Victoria");
    return (String[])ful.toArray(new String[ful.size()]);
  }
}


/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\creatures\Offspring.class
