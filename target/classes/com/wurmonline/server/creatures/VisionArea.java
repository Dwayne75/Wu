...
public class VisionArea
{
  ...
  {
    broadCastUpdateSelectBar(toUpdate, false);
  }
  
  public void broadCastUpdateSelectBar(long toUpdate, boolean keepSelection)
  {
    Zone[] zones = Zones.getZonesCoveredBy(getSurface());
    ...
    zones = Zones.getZonesCoveredBy(getUnderGround());
    if (zones != null)
    {
      for (int i = 0; i < zones.length; i++)
      {
    ...
    throws IOException
  {
    while (xChange != 0)
    {
      ...
      if (this.owner.isPlayer())
      {
        ...
        sendVerticalStrip(positive);
        sendVerticalCaveStrip(positive);
        if ((this.xPos - this.startPosX) % 16L == 0L) {
          sendVerticalStripFar(positive);
        }
      }
    }
    while (yChange != 0)
    {
      ...
      {
        increaseCaveMoveCounter();
        sendHorisontalStrip(positive);
        sendHorisontalCaveStrip(positive);
        if ((this.yPos - this.startPosY) % 16L == 0L) {
          sendHorisontalStripFar(positive);
        }
      }
    }
  }
  ...
  private void sendFarStrips()
  {
    if (this.owner != null)
    {
      ...
      {
        comm.sendTileStripFar((short)(int)(this.startPosX / 16L - 151L), (short)(int)(this.startPosY / 16L + this.currentStrip), 302, 1);
  ...
  private void sendHorisontalStrip(boolean positive)
    throws IOException
  {
    Communicator comm = this.owner.getCommunicator();
    if (positive)
  ...
  private void sendVerticalStrip(boolean positive)
    throws IOException
  {
    Communicator comm = this.owner.getCommunicator();
    if (positive)
  ...
  private void sendHorisontalStripFar(boolean positive)
  {
    Communicator comm = this.owner.getCommunicator();
    if (positive) {
      comm.sendTileStripFar((short)(int)(this.xPos / 16L - 151L), (short)(int)(this.yPos / 16L + 150L), 302, 1);
    } else {
      comm.sendTileStripFar((short)(int)(this.xPos / 16L - 151L), (short)(int)(this.yPos / 16L - 151L), 302, 1);
    }
  }
  ...
  private void sendVerticalStripFar(boolean positive)
  {
    Communicator comm = this.owner.getCommunicator();
    if (positive) {
      comm.sendTileStripFar((short)(int)(this.xPos / 16L + 150L), (short)(int)(this.yPos / 16L - 151L), 1, 302);
    } else {
      comm.sendTileStripFar((short)(int)(this.xPos / 16L - 151L), (short)(int)(this.yPos / 16L - 151L), 1, 302);
    }
  }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\creatures\VisionArea.class
