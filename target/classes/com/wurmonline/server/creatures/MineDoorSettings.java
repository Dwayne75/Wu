  ...
  implements MiscConstants
{
  ...
  public static boolean mayPass(PermissionsPlayerList.ISettings is, long objectId, Creature creature)
  {
    ...
    return hasPermission(is, objectId, creature, MineDoorSettings.MinedoorPermissions.PASS.getBit());
  }
  ...
  public static boolean isExcluded(PermissionsPlayerList.ISettings is, long objectId, Creature creature)
  {
    ...
    return hasPermission(is, objectId, creature, MineDoorSettings.MinedoorPermissions.EXCLUDE.getBit());
  }
}


/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\creatures\MineDoorSettings.class
