  ...
  implements Serializable
{
  ...
  Effect(long aOwner, int aNumber)
    throws IOException
  {
    this.owner = aOwner;
    this.id = aNumber;
  ...
  {
    return Zones.calculatePosZ(getPosX(), getPosY(), tile, isOnSurface(), false, getPosZ(), null, -10L);
  }
  ...
  {
    if ((posX != getPosX()) || (posY != getPosY()) || (posZ != getPosZ())) {
      try
      {
        if (sendUpdate)
        {
          Zone zone = Zones.getZone((int)(getPosX() / 4.0F), (int)(getPosY() / 4.0F), isOnSurface());
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\effects\Effect.class
