...
{
  WurmINI("wurm.ini", true),  Sqlite("sqlite", true),  OriginalDir("originaldir", false),  TopLayer("top_layer.map", true),  RockLayer("rock_layer.map", true),  Flags("flags.map", false),  Cave("map_cave.map", false),  Resources("resources.map", false),  ProtectedTiles("protectedTiles.bmap", false);
  ...
  public void createIn(PresetFolder folder)
    throws IOException
  {
  ...
  public void deleteFrom(PresetFolder folder)
    throws IOException
  {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\gui\folders\PresetEntity.class
