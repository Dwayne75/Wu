...
{
  CurrentDir("currentdir", false),  GameDir("gamedir", false),  WurmINI("wurm.ini", true),  Sqlite("sqlite", true),  TopLayer("top_layer.map", true),  RockLayer("rock_layer.map", true),  Flags("flags.map", false),  Cave("map_cave.map", false),  Resources("resources.map", false),  Recipes("recipes", false),  ProtectedTiles("protectedTiles.bmap", false);
  ...
  public void createIn(GameFolder gameFolder)
    throws IOException
  {
  ...
  public void deleteFrom(GameFolder gameFolder)
    throws IOException
  {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\gui\folders\GameEntity.class
