  ...
  implements Serializable, CounterTypes
{
  ...
  public static final long getNextItemId()
  {
    ...
    savecounter += 1;
    checkSave();
    return BigInteger.valueOf(itemIdCounter).shiftLeft(24).longValue() + (Servers.localServer.id << 8) + 2L;
  }
  ...
  public static final long getNextPlayerId()
  {
    ...
    savecounter += 1;
    checkSave();
    return BigInteger.valueOf(playerIdCounter).shiftLeft(24).longValue() + (Servers.localServer.id << 8) + 0L;
  }
  
  public static final long getNextBodyPartId(long creatureId, byte bodyplace, boolean isPlayer)
  {
    return 
      BigInteger.valueOf(BigInteger.valueOf(creatureId >> 8).shiftLeft(1).longValue() + (isPlayer ? 1 : 0)).shiftLeft(16).longValue() + (bodyplace << 8) + 19L;
  }
  ...
  {
    return (int)(bodypartId >> 8 & 0xFF);
  }
  
  public static final long getNextCreatureId()
  {
    creatureIdCounter += 1L;
    
    savecounter += 1;
    checkSave();
    return BigInteger.valueOf(creatureIdCounter).shiftLeft(24).longValue() + (Servers.localServer.id << 8) + 1L;
  }
  
  public static final long getNextStructureId()
  {
    structureIdCounter += 1L;
    savecounter += 1;
    checkSave();
    return BigInteger.valueOf(structureIdCounter).shiftLeft(24).longValue() + (Servers.localServer.id << 8) + 4L;
  }
  
  public static final long getNextTempItemId()
  {
    tempIdCounter += 1L;
    return BigInteger.valueOf(tempIdCounter).shiftLeft(24).longValue() + (Servers.localServer.id << 8) + 6L;
  }
  
  public static final long getNextIllusionId()
  {
    illusionIdCounter += 1L;
    return BigInteger.valueOf(illusionIdCounter).shiftLeft(24).longValue() + 24L;
  }
  
  public static final long getNextTemporaryWoundId()
  {
    temporaryWoundIdCounter += 1L;
    return BigInteger.valueOf(temporaryWoundIdCounter).shiftLeft(24).longValue() + (Servers.localServer.id << 8) + 32L;
  }
  ...
  public static final long getNextWoundId()
  {
    ...
    savecounter += 1;
    checkSave();
    return BigInteger.valueOf(woundIdCounter).shiftLeft(24).longValue() + (Servers.localServer.id << 8) + 8L;
  }
  
  public static final long getNextTemporarySkillId()
  {
    temporarySkillsIdCounter += 1L;
    return BigInteger.valueOf(temporarySkillsIdCounter).shiftLeft(24).longValue() + (Servers.localServer.id << 8) + 31L;
  }
  
  public static final long getNextPlayerSkillId()
  {
    playerSkillsIdCounter += 1L;
    savecounter += 1;
    checkSave();
    return BigInteger.valueOf(playerSkillsIdCounter).shiftLeft(24).longValue() + (Servers.localServer.id << 8) + 10L;
  }
  
  public static final long getNextCreatureSkillId()
  {
    creatureSkillsIdCounter += 1L;
    savecounter += 1;
    checkSave();
    return BigInteger.valueOf(creatureSkillsIdCounter).shiftLeft(24).longValue() + (Servers.localServer.id << 8) + 9L;
  }
  ...
  public static final long getNextBankId()
  {
    ...
    savecounter += 1;
    checkSave();
    return BigInteger.valueOf(bankIdCounter).shiftLeft(24).longValue() + (Servers.localServer.id << 8) + 13L;
  }
  ...
  public static final long getNextSpellId()
  {
    ...
    savecounter += 1;
    checkSave();
    return BigInteger.valueOf(spellIdCounter).shiftLeft(24).longValue() + (Servers.localServer.id << 8) + 15L;
  }
  ...
  public static final long getNextWCCommandId()
  {
    ...
    savecounter += 1;
    checkSave();
    return BigInteger.valueOf(wccommandCounter).shiftLeft(24).longValue() + (Servers.localServer.id << 8) + 21L;
  }
  ...
  public static final long getNextPlanId()
  {
    ...
    savecounter += 1;
    checkSave();
    return BigInteger.valueOf(planIdCounter).shiftLeft(24).longValue() + (Servers.localServer.id << 8) + 16L;
  }
  ...
  public static final long getNextBodyId()
  {
    ...
    savecounter += 1;
    checkSave();
    return BigInteger.valueOf(bodyIdCounter).shiftLeft(24).longValue() + (Servers.localServer.id << 8) + 19L;
  }
  ...
  public static final long getNextCoinId()
  {
    ...
    savecounter += 1;
    checkSave();
    return BigInteger.valueOf(coinIdCounter).shiftLeft(24).longValue() + (Servers.localServer.id << 8) + 20L;
  }
  ...
  public static final long getNextPoiId()
  {
    ...
    savecounter += 1;
    checkSave();
    return BigInteger.valueOf(poiIdCounter).shiftLeft(24).longValue() + (Servers.localServer.id << 8) + 26L;
  }
  ...
  public static final long getNextCouponId()
  {
    ...
    savecounter += 1;
    checkSave();
    return BigInteger.valueOf(couponIdCounter).shiftLeft(24).longValue() + (Servers.localServer.id << 8) + 29L;
  }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\WurmId.class
