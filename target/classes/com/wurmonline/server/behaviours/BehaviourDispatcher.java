  ...
  implements CounterTypes, ItemTypes, MiscConstants
{
  ...
  public static final BehaviourDispatcher.RequestParam requestActionForTiles(Creature creature, long target, boolean onSurface, Item item, Behaviour behaviour)
  {
  ...
  private static final BehaviourDispatcher.RequestParam requestActionForTileCorner(Creature creature, long target, boolean onSurface, Item item, Behaviour behaviour)
  {
    int x = Tiles.decodeTileX(target);
    int y = Tiles.decodeTileY(target);
  ...
  public static final BehaviourDispatcher.RequestParam requestActionForCreaturesPlayers(Creature creature, long target, Item item, int targetType, Behaviour behaviour)
    throws NoSuchPlayerException, NoSuchCreatureException
  {
    ...
    if (targetType == 1) {
      return new BehaviourDispatcher.RequestParam(availableActions, targetc.getTemplate().getName().replaceAll(" ", "_"));
    }
    return new BehaviourDispatcher.RequestParam(availableActions, "Player:" + targetc.getName().replaceAll(" ", "_"));
  }
  
  public static final BehaviourDispatcher.RequestParam requestActionForItemsBodyIdsCoinIds(Creature creature, long target, Item item, Behaviour behaviour)
  ...
  private static final BehaviourDispatcher.RequestParam requestActionForWalls(Creature creature, long target, Item item, Behaviour behaviour)
  ...
  private static final BehaviourDispatcher.RequestParam requestActionForFloors(Creature creature, long target, boolean onSurface, Item item, Behaviour behaviour)
  {
    int x = Tiles.decodeTileX(target);
    int y = Tiles.decodeTileY(target);
    int heightOffset = Tiles.decodeHeightOffset(target);
  ...
  private static final BehaviourDispatcher.RequestParam requestActionForIllusions(Creature creature, long target, Item item, int targetType, Behaviour behaviour)
    throws NoSuchPlayerException, NoSuchCreatureException
  {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\behaviours\BehaviourDispatcher.class
