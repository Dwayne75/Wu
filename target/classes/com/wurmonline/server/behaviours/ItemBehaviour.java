...
import com.wurmonline.server.items.Recipe.LiquidResult;
...
public class ItemBehaviour
  extends Behaviour
  implements ItemTypes, MiscConstants, QuestionTypes, TimeConstants, MonetaryConstants, ItemMaterials
{
  ...
  public List<ActionEntry> getBehavioursFor(Creature performer, Item target)
  {
    ...
    if (!target.isTraded())
    {
      if (target.canBePlanted())
      {
        ...
        if (ownerId == -10L)
        {
          if (performer.isWithinDistanceTo(target.getPosX(), target.getPosY(), target.getPosZ(), 4.0F))
          {
            ...
            else if (((!target.isBulkContainer()) && (target.getTemplate().getInitialContainers() == null)) || 
              (target.isEmpty(true))) {
              if (!target.isNoTake(performer)) {
                if (isSignManipulationOk(target, performer, (short)6))
                {
                  ...
                  if (((target.getParentId() == -10L) && (tid != 26)) || (tid != 298)) {
                    toReturn.add(Actions.actionEntrys['Ν']);
                  }
                }
                else if (isPvpServer)
                {
        ...
        if (target.getTemplateId() == 835)
        {
          ...
          if (village != null)
          {
            ...
            else
            {
              ...
              if ((cit != null) && (cit.getRole().mayInviteCitizens()))
              {
                toReturn.add(Actions.actionEntrys['ɚ']);
                toReturn.add(Actions.actionEntrys['ɛ']);
              }
            }
          }
          else {
      ...
      try
      {
        ...
        {
          if ((target.isLight()) || (target.isFire())) {
          ...
          try
          {
            ...
            if (p != null) {
              ...
              else if ((target.getTemplateId() == 94) || 
              ...
              {
                toReturn.add(Actions.actionEntrys['Ϋ']);
              }
            }
          }
          ...
          else
          {
            ...
            if ((templateId == 26) || (templateId == 298))
            {
              ...
              toReturn.add(Actions.actionEntrys['ɾ']);
            }
          ...
          if ((tid == 175) || (tid == 651) || (tid == 1097) || (tid == 1098) || ((tid == 466) && 
            (target.getAuxData() == 1)))
          {
          ...
          else if (tid == 1172)
          {
            ...
            toReturn.add(Actions.actionEntrys['ˡ']);
            toReturn.add(Actions.actionEntrys['ˠ']);
            toReturn.add(Actions.actionEntrys['˟']);
            toReturn.add(Actions.actionEntrys['˞']);
            toReturn.add(Actions.actionEntrys['˝']);
            toReturn.add(Actions.actionEntrys['˜']);
          ...
          {
            toReturn.add(Actions.actionEntrys['Ψ']);
          }
          else if (tid == 479)
          {
            toReturn.add(Actions.actionEntrys['Ω']);
          }
          short nos;
          if (tid == 176)
          {
            if (performer.getPower() >= 2)
            {
              ...
              toReturn.add(Actions.actionEntrys['Ƿ']);
              toReturn.add(Actions.actionEntrys['ˏ']);
            }
            if (performer.getPower() >= 3)
            {
              ...
              toReturn.add(Actions.actionEntrys['Ô']);
              toReturn.add(Actions.actionEntrys['ǡ']);
              if (Servers.isThisLoginServer()) {
                toReturn.add(Actions.actionEntrys['ɡ']);
              }
              if (Servers.isThisLoginServer()) {
                toReturn.add(Actions.actionEntrys['ɻ']);
              }
            }
          ...
          else if (target.isLiquid())
          {
            ...
            if ((!target.isKingdomMarker()) || (performer.isFriendlyKingdom(target.getAuxData()))) {
              toReturn.add(Actions.actionEntrys['¢']);
            }
          }
          ...
          } else if (target.isGem())
          {
            ...
            toReturn.add(Actions.actionEntrys['ʪ']);
          ...
          if (target.isInstaDiscard()) {
            toReturn.add(Actions.actionEntrys['ɘ']);
          }
        }
      ...
      catch (NotOwnedException ex)
      {
        if (!target.isBanked())
        {
          ...
          if ((target.getTopParent() == performer.getVehicle()) || (performer.isWithinDistanceTo(target.getPosX(), target.getPosY(), target
            .getPosZ(), maxDist)))
          {
            result = target.getWurmId() == performer.getVehicle() ? null : Blocking.getBlockerBetween(performer, target, 4);
            if (result == null)
            {
              sameStruct = true;
              VolaTile tile2;
              try
              {
                ...
                if (tile != null)
                {
                  ...
                  tile2 = performer.getCurrentTile();
                  if (tile2 != null)
                  {
              ...
              if (sameStruct)
              {
                if ((target.isLight()) || (target.isFire()) || (target.getTemplateId() == 1243)) {
                  ...
                  else if ((target.isLight()) || (target.getTemplateId() == 742)) {
                ...
                if ((!target.isNoTake(performer)) && (!target.isOutsideOnly()) && (!target.canBePlanted())) {
                  if (!target.isLiquid()) {
                ...
                if (target.isHollow()) {
                  if (((target.isSealedByPlayer()) || ((target.getTemplateId() == 1342) && (!target.isPlanted())) ? 1 : 0) == 0) {
                    if ((!target.getTemplate().hasViewableSubItems()) || (target.getTemplate().isContainerWithSubItems()) || 
                      (performer.getPower() > 0))
                    {
                      boolean isTop = (target.getWurmId() == target.getTopParent()) || ((target.getTopParentOrNull() != null) && (target.getTopParentOrNull().getTemplate().hasViewableSubItems()) && ((!target.getTopParentOrNull().getTemplate().isContainerWithSubItems()) || (target.isPlacedOnParent())));
                      Creature lWatcher;
                        ...
                        try
                        {
                          ...
                          if (hasKey)
                          {
                            try
                            {
                              Creature[] watchers = target.getWatchers();
                              boolean watching = false;
                              Creature[] arrayOfCreature1 = watchers;lWatcher = arrayOfCreature1.length;
                              for (Creature localCreature1 = 0; localCreature1 < lWatcher; localCreature1++)
                              {
                                Creature lWatcher = arrayOfCreature1[localCreature1];
                                if (lWatcher == performer)
                                {
                                  watching = true;
                                  break;
                      ...
                      if (target.isMailBox()) {
                        if (target.isEmpty(false)) {
                          toReturn.add(Actions.actionEntrys['Ő']);
                        } else {
                          toReturn.add(Actions.actionEntrys['ő']);
                        }
                      }
                ...
                if ((target.getTemplateId() != 272) || (target.getWasBrandedTo() == -10L) || (target.mayCommand(performer))) {
                  toReturn.addAll(makeMoveSubMenu(performer, target));
                }
                ...
                if (target.isBed()) {
                  addBedOptions(performer, target, toReturn);
                }
                if (target.isFood())
                {
                  if (!target.isNoEatOrDrink())
                ...
                if (((target.lastOwner == performer.getWurmId()) || (performer.getPower() >= 2) || (target.isShelf())) && 
                  (!target.isNoRename()) && ((!target.isVehicle()) || (target.isChair()) || (target.isTent()))) {
                  if ((target.isShelf()) && (performer.getPower() < 1) && 
                ...
                {
                  MissionTrigger[] mr1 = MissionTriggers.getMissionTriggersWith(-1, 501, target
                    .getWurmId());
                  if (mr1.length > 0) {
                    toReturn.add(Actions.actionEntrys['ǵ']);
                  }
                  MissionTrigger[] mr2 = MissionTriggers.getMissionTriggersWith(-1, 496, target
                    .getWurmId());
                  if (mr2.length > 0) {
                    toReturn.add(Actions.actionEntrys['ǰ']);
                  }
                  MissionTrigger[] mr3 = MissionTriggers.getMissionTriggersWith(-1, 498, target
                    .getWurmId());
                  if (mr3.length > 0) {
                    toReturn.add(Actions.actionEntrys['ǲ']);
                  }
                  MissionTrigger[] mr4 = MissionTriggers.getMissionTriggersWith(-1, 500, target
                    .getWurmId());
                  if (mr4.length > 0) {
                    toReturn.add(Actions.actionEntrys['Ǵ']);
                  }
                  MissionTrigger[] mr5 = MissionTriggers.getMissionTriggersWith(-1, 502, target
                    .getWurmId());
                  if (mr5.length > 0) {
                    toReturn.add(Actions.actionEntrys['Ƕ']);
                  }
                  MissionTrigger[] mr6 = MissionTriggers.getMissionTriggersWith(-1, 497, target
                    .getWurmId());
                  if (mr6.length > 0) {
                    toReturn.add(Actions.actionEntrys['Ǳ']);
                  }
                  MissionTrigger[] mr7 = MissionTriggers.getMissionTriggersWith(-1, 499, target
                    .getWurmId());
                  if (mr7.length > 0) {
                    toReturn.add(Actions.actionEntrys['ǳ']);
                  }
      ...
      if (target.canHavePermissions())
      {
        ...
        if ((target.isBed()) && (target.mayManage(performer))) {
          ...
          permissions.add(Actions.actionEntrys['ʰ']);
        }
      ...
      {
        Item liquid = null;
        maxDist = target.getItemsAsArray();result = maxDist.length;
        for (sameStruct = false; sameStruct < result; sameStruct++)
        {
          Item item = maxDist[sameStruct];
          if (item.isLiquid())
          {
            liquid = item;
            break;
      ...
      if (((target.isFoodMaker()) || (target.getTemplate().isCooker())) && (!target.isSealedByPlayer())) {
        toReturn.add(Actions.actionEntrys['ĝ']);
      }
    }
    else
    {
      ...
      if (target.getData() != -10L) {
        try
        {
          ...
          if ((cagedCreature != null) && 
            (!cagedCreature.isPlayer()) && (!cagedCreature.isHuman()) && (!cagedCreature.isGhost()) && (!cagedCreature.isReborn()) && (
  ...
  private static void addLockOptions(Creature performer, Item source, Item target, long lockId, int stid, boolean isTop, List<ActionEntry> toReturn, Creature[] watchers)
  {
    ...
    else
    {
      ...
      if ((!target.isTent()) || 
        (target.getLastOwnerId() == performer.getWurmId()) || (target.getOwnerId() == performer.getWurmId())) {
        if ((lockId == -10L) && ((target.getParentId() != -10L) || (watchers == null) || (watchers.length == 0)) && (
  ...
  protected static void addLockPickEntry(Creature performer, Item source, Item target, Item lock, List<ActionEntry> toReturn)
  {
    ...
    float difficulty = MethodsItems.getPickChance(target.getCurrentQualityLevel(), source.getCurrentQualityLevel(), lock.getCurrentQualityLevel(), (float)performer.getLockPickingSkillVal(), (byte)(isLargeVehicle ? 2 : 0)) / rarityMod * (1.0F + Item.getMaterialLockpickBonus(source.getMaterial()));
  ...
  {
    if ((target.isUseOnGroundOnly()) && (!target.isDomainItem()) && 
      (!target.isKingdomMarker()) && 
      (!target.hideAddToCreationWindow()) && (!target.isNoDrop()) && 
      (!target.isMailBox()))
    {
  ...
  {
    if ((item.getTemplateId() == 176) && (performer.getPower() > 1) && 
  ...
  public List<ActionEntry> getBehavioursFor(Creature performer, Item source, Item target)
  {
    ...
    if (!target.isTraded())
    {
      ...
      if (target.canBePlanted())
      {
        ...
        if (ownerId == -10L)
        {
          ...
          if ((Features.Feature.SINGLE_PLAYER_BRIDGES.isEnabled()) && (source.getTemplateId() == 903) && 
            (target.getTemplateId() == 901))
          {
        ...
        if (target.getTemplateId() == 835)
        {
          village = Villages.getVillageForCreature(performer);
          if (village != null)
          {
            if (!RecruitmentAds.containsAdForVillage(village.getId()))
            {
        ...
        if (owner == performer.getWurmId())
        {
            ...
            if (p != null) {
                ...
                (target.getTopParent() == performer.getInventory().getWurmId()) || (p.isBodyPart())))
              {
                ...
                if (lockId == -10L)
                {
                  ...
                  else if ((Features.Feature.TRANSFORM_RESOURCE_TILES.isEnabled()) && (ttid == 1020) && 
                    (source.isLiquid()))
                  {
                    if (getTileTransmutationLiquidAuxData(source, target) != 0)
                    {
                      toReturn.add(new ActionEntry((short)-2, "Alchemy", "Alchemy"));
                      toReturn.add(Actions.actionEntrys['ě']);
                      toReturn.add(Actions.actionEntrys['ĝ']);
                    }
                  }
                }
              ...
              else
              {
                ...
                if ((ttid == 1394) && ((source.isWeaponKnife()) || 
                  (source.getTemplateId() == 258))) {
          ...
          if (!source.equals(target))
          {
            ...
            if ((ttid == 1076) && (source.isGem())) {
              if (target.getData1() <= 0) {
                toReturn.add(Actions.actionEntrys['Ǐ']);
              }
            }
            if ((source.isCombine()) && (stid == ttid) && 
              (source.getRarity() == target.getRarity())) {
              toReturn.add(Actions.actionEntrys[93]);
            }
            if (((stid == 1193) || (stid == 417)) && (ttid == stid) && 
            ...
            if (ttid == 1307) {
              if ((target.getData1() > 0) && (stid == 1307) && 
                (source.getRealTemplateId() == target.getRealTemplateId())) {
                toReturn.add(Actions.actionEntrys['ΐ']);
              }
            }
            if ((target.isLight()) || (target.isFire()) || (ttid == 1243)) {
              ...
              {
                if (((stid == 143) || ((stid == 176) && 
                  (performer.getPower() >= 2))) && 
                  (target.getAuxData() > 0) && (target.isPlanted())) {
                  toReturn.add(Actions.actionEntrys[12]);
                }
              }
              else if ((stid == 143) || ((stid == 176) && 
                (performer.getPower() >= 2)) || 
            ...
            if (source.isWeaponKnife()) {
              if ((ttid == 92) || (ttid == 129) || (
                (target.getTemplate().getFoodGroup() == 1201) && (ttid != 369))) {
            ...
            if ((source.isWeaponKnife()) || (source.getTemplateId() == 258)) {
              if (ttid == 729) {
                ...
                if ((!target.getName().contains("portion of ")) || (!target.getName().contains("slice of "))) {
                  if (stid == 258) {
            ...
            if ((stid == 1255) && (target.canBeSealedByPlayer()) && (!target.isSealedByPlayer())) {
              toReturn.add(Actions.actionEntrys['ˣ']);
            }
            if ((!target.isLiquid()) && (target.isWrapped())) {
              toReturn.add(new ActionEntry((short)740, "Unwrap", "unwrapping", emptyIntArr));
            } else if ((target.isRaw()) && (target.canBeRawWrapped()) && (target.isPStateNone())) {
              toReturn.add(new ActionEntry((short)739, "Wrap", "wrapping", emptyIntArr));
            } else if (((stid == 748) || (stid == 1272)) && 
              (target.canBePapyrusWrapped()) && (!target.isWrapped()) && (source.getAuxData() == 2)) {
              toReturn.add(new ActionEntry((short)739, "Wrap", "wrapping", emptyIntArr));
            } else if (((stid == 213) || (stid == 926)) && 
              (target.canBeClothWrapped()) && (!target.isWrapped())) {
              toReturn.add(new ActionEntry((short)739, "Wrap", "wrapping", emptyIntArr));
            }
            if ((target.isSealedByPlayer()) && (target.getTemplateId() != 1309) && (!target.isCrate()))
            {
              Item liquid = null;
              lockId = target.getItemsAsArray();village = lockId.length;
              for (nse = 0; nse < village; nse++)
              {
                item = lockId[nse];
                if (item.isLiquid())
                {
            ...
            if (source.getTemplate().isRune())
            {
              ...
              chance = soulDepth.getChance(diff, null, source.getCurrentQualityLevel());
      ...
      catch (NotOwnedException noe)
      {
        Item item;
        double chance;
        if (((source.getTemplateId() == 25) && (target.getAuxData() == 30) && 
          (target.getTemplateId() == 180)) || 
          ((source.getTemplateId() == 25) && (target.getAuxData() == 30) && 
          ...
          (target.getTemplateId() == 1028)))
        {
          BlockingResult result = Blocking.getBlockerBetween(performer, target, 4);
          if (result == null) {
            toReturn.add(Actions.actionEntrys['Κ']);
          }
        }
        ...
        {
          if (target.isRiftAltar()) {
            if ((stid == 764) || (stid == 1096)) {
          ...
          if (target.getWurmId() != performer.getVehicle())
          {
            if (!performer.isWithinDistanceTo(target.getPosX(), target.getPosY(), target.getPosZ(), 
              (target.isVehicle()) && (!target.isTent()) && (!target.isChair()) ? Math.max(4, target.getSizeZ() / 100) : 4.0F)) {}
          }
          else
          {
            ...
            if (result == null)
            {
              ...
              {
                Item liquid = null;
                chance = target.getItemsAsArray();item = chance.length;
                for (Item localItem1 = 0; localItem1 < item; localItem1++)
                {
                  Item item = chance[localItem1];
                  if (item.isLiquid())
                  {
                    liquid = item;
                    break;
              ...
              {
                Skill soulDepth = performer.getSoulDepth();
                diff = 20.0F + source.getDamage() - (source.getCurrentQualityLevel() + source.getRarity() - 45.0D);
                ...
                if ((RuneUtilities.isEnchantRune(source)) && (RuneUtilities.canApplyRuneTo(source, target)))
                {
                  ...
                  if ((!target.isInventory()) && (!target.isTemporary()) && (!target.isNotSpellTarget())) {
                    toReturn.add(new ActionEntry((short)945, "Use Rune: " + chance + "%", "using rune", emptyIntArr));
                  }
                }
              }
              if (((stid != 143) && ((stid != 176) || (performer.getPower() < 2))) || ((ttid == 180) || (ttid == 178) || (ttid == 37) || (ttid == 74) || (ttid == 889) || (ttid == 1023) || (ttid == 1028) || 
              
                (target.isLight()) || (ttid == 1178) || 
              ...
              else if ((source.isCoin()) && (target.isSpringFilled())) {
        ...
        {
          if (((stid == 143) || ((stid == 176) && (performer.getPower() >= 2))) && 
            (!target.isOnFire()))
          {
            if ((target.getTemplateId() != 729) || (target.getAuxData() > 0)) {
              toReturn.add(Actions.actionEntrys[12]);
        ...
        else
        {
          ...
          {
            short nums = -1;
            c = Cultist.getCultist(performer.getWurmId());
            if (c != null)
            {
              nums = (short)(nums - 1);
              if (c.getLevel() > 2) {
          ...
          {
            Item liquid = null;
            c = target.getItemsAsArray();diff = c.length;
            for (item = 0; item < diff; item++)
            {
              Item item = c[item];
              if (item.isLiquid())
              {
    ...
    if (((source.getTemplateId() == 315) && (target.getTemplateId() == 1310)) || (
      (source.getTemplateId() == 176) && (target.getTemplateId() == 1310))) {
      toReturn.add(Actions.actionEntrys['΍']);
    }
    ...
    if (!target.isTraded())
    {
      ...
      if (owner == performer.getWurmId())
      {
        ...
        if ((ttid == 175) || (ttid == 651) || (ttid == 1097) || (ttid == 1098) || ((ttid == 466) && 
          (target.getAuxData() == 1))) {
          toReturn.add(Actions.actionEntrys[3]);
        } else if (ttid == 782) {
          toReturn.add(Actions.actionEntrys['Ȇ']);
        ...
        else if (source.isSmearable())
        {
          ...
          toReturn.add(Actions.actionEntrys['ɹ']);
        }
        else if ((target.isAbility()) && (!target.canBePlanted()))
        {
          toReturn.add(Actions.actionEntrys[118]);
      ...
      else if (target.getZoneId() != -10L)
      {
        ...
        {
          if (!performer.isWithinDistanceTo(target.getPosX(), target.getPosY(), target.getPosZ(), 
            (target.isVehicle()) && (!target.isTent()) && (!target.isChair()) ? Math.max(6, target.getSizeZ() / 100) : 6.0F)) {}
        }
        else
        {
          BlockingResult result = target.getWurmId() == performer.getVehicle() ? null : Blocking.getBlockerBetween(performer, target, 4);
          if (result == null)
          {
            ...
            if (mayManipulate)
            {
              ...
              if (ttid == 865)
              {
                ...
                else if (isTop)
                {
                  try
                  {
                    Creature[] watchers = target.getWatchers();
                    boolean watching = false;
                    nsc = watchers;watching = nsc.length;
                    for (boolean bool1 = false; bool1 < watching; bool1++)
                    {
                      Creature lWatcher = nsc[bool1];
                      if (lWatcher == performer) {
                        watching = true;
                      }
                    }
              ...
              if ((stid == 20) && ((ttid == 692) || (ttid == 696) || 
                (target.getTemplate().isRiftStoneDeco()))) {
                toReturn.add(Actions.actionEntrys['']);
              }
      ...
      if (mayManipulate)
      {
        ...
        {
          if ((Spell.mayBeEnchanted(target)) && (target.getRarity() < source.getRarity())) {
            toReturn.add(Actions.actionEntrys['ɸ']);
          }
        }
        ...
        if ((target.color2 != -1) && (target.supportsSecondryColor()) && (!target.isLiquid())) {
          if (target.getTemplateId() == 1396)
          {
            ...
            toReturn.add(Actions.actionEntrys['Μ']);
          } else if ((!target.isColorable()) && (stid == 441)) {
            toReturn.add(new ActionEntry((short)924, "Remove paint", "removing"));
          }
        }
        if (ttid == 1307) {
          if ((target.getData1() <= 0) && ((stid == 441) || (stid == 97))) {
            toReturn.add(Actions.actionEntrys['Ώ']);
          }
        }
        if ((stid == 788) && (target.isMetal()) && (!target.isLiquid())) {
          if ((!target.isIndestructible()) && (!target.getTemplate().isRune()) && (target.getTemplateId() != 1307) && 
            (!target.getTemplate().isStatue()) && (target.getTemplateId() != 1423)) {
        ...
        if (target.isServerPortal()) {
          ...
          ((!source.isLight()) && (!source.isFire())) || ((source.isOnFire()) || (stid == 315) || (stid == 176) || (stid == 143)))) {
          toReturn.add(Actions.actionEntrys[118]);
        } else if (ttid == 972) {
          toReturn.add(new ActionEntry((short)118, "Pat", "patting"));
        } else if (ttid == 738) {
        ...
        if ((stid == 489) || (
          (performer.getPower() >= 2) && ((stid == 176) || (stid == 315)))) {
        ...
        else if (target.isLiquid())
        {
          ...
          if ((source.isContainerLiquid()) || (source.isOilConsuming())) {
            if ((source.getWurmId() != target.getParentId()) && 
              (!source.isSealedByPlayer())) {
              toReturn.add(Actions.actionEntrys['½']);
            }
          }
          if (stid == 386)
          ...
          else if ((source.isRepairable()) && (source.creationState != 0))
          {
            if ((!source.isNewbieItem()) && (!source.isChallengeNewbieItem()))
            {
              byte material = MethodsItems.getImproveMaterial(source);
              int tid = MethodsItems.getItemForImprovement(material, source.creationState);
        ...
        if ((target.isRepairable()) || (improvable) || (ttid == 179) || (ttid == 386))
        {
          ...
          templateId = MethodsItems.getImproveTemplateId(target);
          if (target.creationState != 0) {
            templateId = MethodsItems.getItemForImprovement(material, target.creationState);
          }
          if ((skillNum != -10) && (
            (templateId == source.getTemplateId()) || ((source.getTemplateId() == 176) && 
            (performer.getPower() >= 2)))) {
            if (!target.isNewbieItem()) {
              improvable = true;
            }
          }
          if (improvable) {
        ...
        if ((performer.mayDestroy(target)) && (!target.isIndestructible()) && (!target.isRoadMarker()))
        {
          ...
          if ((!target.isWarmachine()) && (target.getTemplateId() != 938) && 
            (target.getTemplateId() != 931)) {
        ...
        if (source.isHolyItem()) {
          if ((!target.isInventory()) && (!target.isTemporary()) && (!target.isNotSpellTarget())) {
            if ((performer.getDeity() != null) && ((performer.isPriest()) || (performer.getPower() > 0))) {
              if (source.isHolyItem(performer.getDeity()))
              {
                ...
                if (spells.length > 0)
                {
                  ...
                  Spell[] arrayOfSpell1 = spells;nsc = arrayOfSpell1.length;
                  for (watching = false; watching < nsc; watching++)
                  {
                    Spell lSpell = arrayOfSpell1[watching];
        ...
        if (((target.getOwnerId() == performer.getWurmId()) || (target.lastOwner == performer.getWurmId()) || 
          (performer.getPower() >= 2)) && (!target.isNoRename()) && (
        ...
        if ((target.isEpicTargetItem()) || (target.isKingdomMarker()))
        {
          ...
          MissionTrigger[] mr1 = MissionTriggers.getMissionTriggersWith(stid, 501, target
            .getWurmId());
          if (mr1.length > 0) {
            toReturn.add(Actions.actionEntrys['ǵ']);
          }
          MissionTrigger[] mr2 = MissionTriggers.getMissionTriggersWith(stid, 496, target
            .getWurmId());
          if (mr2.length > 0) {
            toReturn.add(Actions.actionEntrys['ǰ']);
          }
          MissionTrigger[] mr3 = MissionTriggers.getMissionTriggersWith(stid, 498, target
            .getWurmId());
          if (mr3.length > 0) {
            toReturn.add(Actions.actionEntrys['ǲ']);
          }
          MissionTrigger[] mr4 = MissionTriggers.getMissionTriggersWith(stid, 500, target
            .getWurmId());
          if (mr4.length > 0) {
            toReturn.add(Actions.actionEntrys['Ǵ']);
          }
          MissionTrigger[] mr5 = MissionTriggers.getMissionTriggersWith(stid, 502, target
            .getWurmId());
          if (mr5.length > 0) {
            toReturn.add(Actions.actionEntrys['Ƕ']);
          }
          MissionTrigger[] mr6 = MissionTriggers.getMissionTriggersWith(stid, 497, target
            .getWurmId());
          if (mr6.length > 0) {
            toReturn.add(Actions.actionEntrys['Ǳ']);
          }
          MissionTrigger[] mr7 = MissionTriggers.getMissionTriggersWith(stid, 499, target
            .getWurmId());
          if (mr7.length > 0) {
            toReturn.add(Actions.actionEntrys['ǳ']);
          }
      ...
      else if (target.getTemplateId() == 931)
      {
        if (performer.isWithinDistanceTo(target.getPosX(), target.getPosY(), target.getPosZ(), 4.0F))
        {
          BlockingResult result = Blocking.getBlockerBetween(performer, target, 4);
          ...
          if (result == null) {
            ...
            if (result.getFirstBlocker().isFence()) {
              if ((result.getFirstBlocker() instanceof Fence))
              {
      ...
      if ((stid == 176) && (WurmPermissions.mayUseDeityWand(performer)))
      {
        ...
        toReturn.add(Actions.actionEntrys['³']);
        toReturn.add(Actions.actionEntrys['ʢ']);
        if ((Servers.localServer.testServer) && (ttid == 1437)) {
          toReturn.add(Actions.actionEntrys['Ǧ']);
        }
        if (performer.getPower() >= 3)
        ...
        toReturn.add(Actions.actionEntrys['Ǔ']);
        toReturn.add(Actions.actionEntrys['ˏ']);
        if (performer.getPower() >= 4) {
          toReturn.add(Actions.actionEntrys['ȗ']);
        }
        if (performer.getPower() >= 3) {
  ...
  public boolean action(Action act, Creature performer, Item target, short action, float counter)
  {
    ...
    {
      if (((action == 177) || (action == 178)) && (target.isTurnable(performer)) && (
        (!target.isRoadMarker()) || (!target.isPlanted())))
      {
      ...
      if (Recipes.isRecipeAction(action))
      {
        ...
        if (recipe == null)
        {
          performer.getCommunicator().sendNormalServerMessage("Recipe" + (performer
            .getPower() > 1 ? " " + action : "") + " not found, most odd!");
          return true;
        }
      ...
      {
        readVillageMessages(performer, target);
      }
      else
      {
        if (((action == 6) || (action == 100) || ((action == 925) && 
          (target.getOwnerId() != performer.getWurmId()) && (counter == 1.0F))) && (!target.isNoTake(performer)))
        {
          if ((target.getTemplateId() == 1178) && (target.getTemperature() > 399) && (target.getParentId() == -10L) && 
            (!target.isEmpty(true)))
          {
          ...
          if (((target.isBulkContainer()) || (target.getTemplate().getInitialContainers() != null) || 
          ...
          if ((target.getTemplateId() == 1175) && (target.hasQueen()) && (!WurmCalendar.isSeasonWinter()))
          {
            ...
            performer.addWoundOfType(null, (byte)5, 2, true, 1.0F, false, 5000.0F + Server.rand
              .nextFloat() * 7000.0F, 0.0F, 30.0F, false, false);
            return true;
          }
          if (target.isPlanted())
          {
            ...
            if (ok)
            {
              ...
              if (result == TakeResultEnum.SUCCESS)
              {
                ...
                comm.sendNormalServerMessage("You get " + target
                  .getNameWithGenus() + ".");
                Server.getInstance().broadCastAction(performer
                  .getName() + " gets " + target.getNameWithGenus() + ".", performer, 
                  Math.min(Math.max(3, target.getSizeZ() / 10), 10));
            ...
            else
            {
              comm.sendNormalServerMessage("The " + target
                .getName() + " is firmly planted in the ground.");
            }
          }
          else
          {
    ...
    if (action == 1)
    {
      ...
      if ((target.isKingdomMarker()) || (target.getTemplateId() == 996))
      {
        ...
        Long last = (Long)conquers.get(Long.valueOf(target.getWurmId()));
        if (last != null) {
          if (System.currentTimeMillis() - last.longValue() < 3600000L) {
            descString = descString + " You will have to wait " + Server.getTimeFor(last.longValue() + 3600000L - System.currentTimeMillis()) + " if you want to receive battle rank for conquering the " + target.getName() + ".";
          }
        }
      }
      ...
      if (target.isBed())
      {
        ...
        if (info != null) {
          comm.sendNormalServerMessage("Some kind of mysterious haze lingers over the " + target
            .getName() + ", and you notice that the " + target
            .getName() + " is occupied by the spirit of " + info.getName() + ".");
        }
        if (target.getData() > 0L)
        {
          info = PlayerInfoFactory.getPlayerInfoWithWurmId(target.getData());
          if (info != null) {
            if ((info.lastLogin > 0L) || (info.lastLogout < System.currentTimeMillis() - 86400000L)) {
              comm.sendNormalServerMessage(info
                .getName() + " has rented the " + target.getName() + ".");
            }
          }
        }
      }
      if ((target.isHitchTarget()) || ((target.isVehicle()) && (!Vehicles.getVehicle(target).isChair())))
      {
        ...
        if (performer.getPower() > 3)
        {
          comm.sendNormalServerMessage("Windrot=" + 
            Server.getWeather().getWindRotation() + " power=" + Server.getWeather().getWindPower() + ", impact=" + performer
            .getMovementScheme().getWindImpact() + " speedmod=" + performer
            .getMovementScheme().getSpeedMod());
          comm.sendNormalServerMessage("Vrot=" + performer
          
            .getMovementScheme().getVehicleRotation() + ", speed=" + performer
            
            .getMovementScheme().getMountSpeed() + ", power=" + 
            
            MovementScheme.getWindPower(Server.getWeather().getWindRotation() - 180.0F, performer
            .getMovementScheme().getVehicleRotation()));
        }
        Vehicle vehic = Vehicles.getVehicle(target);
        Creature c;
        Seat[] hitched;
        ...
        if (performer.getPower() > 0) {
          if (vehic != null)
          {
            ...
            if (draggers != null)
            {
              for (e = draggers.iterator(); e.hasNext();)
              {
                c = (Creature)e.next();
                comm.sendNormalServerMessage("Dragged  by " + c.getName());
              }
              hitched = vehic.hitched;
              c = hitched;localCreature1 = c.length;
              for (Creature localCreature2 = 0; localCreature2 < localCreature1; localCreature2++)
              {
                Seat lElement = c[localCreature2];
                comm.sendNormalServerMessage("Hitch seat " + lElement.id + " occupied by " + lElement
                  .getOccupant());
              }
            }
            else
        ...
        {
          String passengers = "";
          hitched = vehic.getSeats();c = hitched.length;
          for (localCreature1 = 0; localCreature1 < c; localCreature1++)
          {
            Seat seat = hitched[localCreature1];
            if (seat.isOccupied())
            {
      ...
      {
        comm.sendNormalServerMessage("Caught by " + target
          .getCreatorName() + " on " + WurmCalendar.getDateFor(target.creationDate));
      }
      else
      {
        s = target.getSignature();
        if ((s != null) && (s.length() > 2) && (!target.isDish())) {
          ...
          if (target.getOwnerId() == performer.getWurmId()) {
            if ((target.getCurrentQualityLevel() >= 20.0F) && (!target.isLiquid()) && (!target.isDish()) && 
              (target.getTemplateId() != 1307))
            {
              target.setCreator(performer.getName());
              comm.sendNormalServerMessage("Since its creator tag has faded, you decide to keep history alive by scratching your name on it. Afterwards you proudly read '" + target
    ...
    {
      if ((action == 6) || (action == 100) || ((action == 925) && 
        (target.getOwnerId() != performer.getWurmId()) && (counter == 1.0F)))
      {
        if (target.isVehicle())
        {
          Vehicle vehicle = Vehicles.getVehicle(target);
          s = vehicle.seats;vm = s.length;
          for (isPvP = false; isPvP < vm; isPvP++)
          {
            Seat seat = s[isPvP];
            if (seat.isOccupied())
            {
        ...
        if ((!target.isNoTake(performer)) || (performer.getPower() > 0)) {
          if (!target.isCrate())
          {
          ...
          try
          {
            ...
            if (vehicle.getTemplateId() == 853)
            {
              if ((target.isBoat()) || (
                ...
                (target.isUnfinished()) && (target.getRealTemplate() != null) && 
                (target.getRealTemplate().isBoat()))) {
                return CargoTransportationMethods.loadShip(performer, target, counter);
              }
              comm.sendNormalServerMessage(
                StringUtil.format("You can't load the %s on to the %s.", new Object[] {
                StringUtil.toLowerCase(target.getName()), 
                StringUtil.toLowerCase(vehicle.getName()) }));
            }
            else if (vehicle.getTemplateId() == 1410)
            {
              if (target.getTemplateId() == 1311) {
      ...
      else
      {
        ...
        if (action == 907)
        {
          ...
          else if (target.getTemplateId() == 1311) {
            if (Features.Feature.TRANSPORTABLE_CREATURES.isEnabled())
            {
              Creature[] folls = performer.getFollowers();
              if (folls.length > 0) {
        ...
        else
        {
          ...
          else
          {
              ...
              if (target.isLockable())
              {
                if ((target.getLockId() == -10L) || (
                  ...
                  try
                  {
                    ...
                    comm.sendSafeServerMessage("The " + target
                      .getName() + " is locked. Please use the key to unlock and open it.");
                  }
                  catch (NoSuchItemException nsi)
                  {
                    comm.sendSafeServerMessage("The " + target
              ...
              if ((target.isRepairable()) || (ttid == 179) || (ttid == 386))
              {
                ...
                if (counter == 1.0F)
                {
                  if (target.getDamage() == 0.0F)
                  {
                    ...
                    {
                      comm.sendNormalServerMessage("The " + target
                        .getName() + " doesn't need repairing.");
                      toReturn = true;
                    }
                  }
                  ...
                  {
                    comm.sendNormalServerMessage("The " + target
                      .getName() + " is too hot to be repaired.");
                    toReturn = true;
                  }
                  else if ((target.isKingdomMarker()) && (
                    (!performer.isFriendlyKingdom(target.getAuxData())) || (performer.getEnemyPresense() > 0) || 
                    (performer.getFightingSkill().getRealKnowledge() < 20.0D) || (!performer.isPaying())))
                  {
                    if (performer.getEnemyPresense() > 0) {
                      comm.sendNormalServerMessage("You are not allowed to repair the " + target
                        .getName() + " while enemies are about.");
                    } else if (performer.getFightingSkill().getRealKnowledge() < 20.0D) {
                      comm.sendNormalServerMessage("You are not allowed to repair the " + target
                        .getName() + " until you have 20 fighting skill.");
                    } else if (!performer.isFriendlyKingdom(target.getAuxData())) {
                      comm.sendNormalServerMessage("You are not allowed to repair the " + target
                        .getName() + " it is not part of your kingdom.");
                    } else if (!performer.isPaying()) {
                      comm.sendNormalServerMessage("You are not allowed to repair the " + target
                        .getName() + " without premium status.");
                    } else {
                      comm.sendNormalServerMessage("You are not allowed to repair the " + target
                        .getName() + ".");
                    }
                  ...
                  else if ((target.getOwnerId() != -10L) || (Methods.isActionAllowed(performer, action, target)))
                  {
                    act.setPower(target.getDamage());
                    time = target.getRepairTime(performer);
                    comm.sendNormalServerMessage("You start repairing the " + target
                      .getName() + ".");
                    Server.getInstance().broadCastAction(performer
                ...
                else
                {
                  ...
                  {
                    comm.sendNormalServerMessage("You can't reach the " + target
                      .getName() + " now.");
                    return true;
                  }
                  if ((!target.isRepairable()) && (ttid != 179) && (ttid != 386))
                  ...
                  if ((counter * 10.0F > time) || (target.getDamage() == 0.0F))
                  {
                    ...
                    Server.getInstance().broadCastAction(performer
                      .getName() + " repairs " + target.getNameWithGenus() + ".", performer, 5);
                    toReturn = true;
                  }
                }
              }
            ...
            else if ((action == 3) && ((ttid == 175) || (ttid == 651) || (ttid == 1097) || (ttid == 1098) || ((ttid == 466) && 
              (target.getAuxData() == 1))))
            {
              if (!performer.isWithinDistanceTo(target.getPosX(), target.getPosY(), target.getPosZ(), 
                (target.isVehicle()) && (!target.isTent()) && (!target.isChair()) ? 
                Math.max(4, target.getSizeZ() / 100) : 4.0F)) {
                return true;
              }
              if (ttid == 175)
              {
                if ((!Servers.localServer.testServer) || (performer.getPower() >= 5)) {
                  try
                  {
                    ...
                    else if (target.getAuxData() == 2)
                    {
                      createdId = 654;
                      qlCreated = 99.0F;
                      Item liquid = ItemFactory.createItem(createdId, qlCreated, null);
                  ...
                  catch (NoSuchTemplateException nst)
                  {
                    logger.log(Level.WARNING, performer
                      .getName() + " Christmas present template gone? " + nst.getMessage(), nst);
                  }
                  catch (NoSuchItemException nsi)
                  {
                  ...
                  {
                    logger.log(Level.WARNING, performer
                      .getName() + " receives no Christmas present: " + fe.getMessage(), fe);
                  }
                }
              ...
              else
              {
                if (target.getOwnerId() != performer.getWurmId())
                {
                  comm.sendSafeServerMessage("You need to carry the " + target
                    .getName() + " in order to open it.");
                  return true;
                }
                try
                {
                  if ((performer.getPower() <= 0) && (!target.getDescription().isEmpty()) && 
                    (!target.getDescription().equalsIgnoreCase(performer.getName()))) {
                    if (!target.getCreatorName().equalsIgnoreCase(performer.getName())) {
                  ...
                  {
                    int itemTemplate = getRandomItemFromPack(ttid);
                    try
                    {
                      byte rarity = 0;
                      if (itemTemplate == 867) {
                      ...
                      Item toInsert = ItemFactory.createItem(itemTemplate, 80.0F + Server.rand.nextFloat() * 20.0F, (byte)(ttid == 1098 ? 34 : 0), rarity, performer.getName());
                  ...
                  else if ((ttid == 466) && (target.getAuxData() == 1))
                  {
                    try
                    {
                      ...
                      {
                        bonusItem = ItemFactory.createItem(getRandomGem(true), 50.0F + Server.rand.nextFloat() * 49.0F, "Easter Bunny");
                      }
                      else
                      {
                        bonusItem = ItemFactory.createItem(1307, 50.0F + Server.rand.nextFloat() * 40.0F, "Easter Bunny");
                        bonusItem.setRealTemplate(getRandomStatueFragment());
            ...
            else if (action == 118)
            {
                  ...
                  if (performer.getWurmId() == target.getOwnerId())
                  {
                    ...
                    if (diff > 0)
                    {
                      ...
                      try
                      {
                        ...
                        Server.getInstance().broadCastAction(performer
                          .getName() + " straightens up as " + performer.getHeSheItString() + " draws power from a gem.", performer, 5);
                        if (received >= 50.0F) {
              ...
              else if (target.isDeathProtection())
              {
                ...
                if (performer.getWurmId() == target.getOwnerId()) {
                  ...
                  else
                  {
                    ...
                    Server.getInstance().broadCastAction(performer
                      .getName() + " shivers for a few seconds as " + performer.getHeSheItString() + " uses " + target
              ...
              else if (ttid == 527)
              {
                if (target.getOwnerId() == performer.getWurmId())
                {
                  ...
                  {
                    comm.sendNormalServerMessage("You fiddle with the " + target
                      .getName() + " but are too stressed to use it.");
                  }
                }
                else {
                  comm.sendNormalServerMessage("You need to carry the " + target
                    .getName() + " in order to use it.");
                }
              }
              else if (ttid == 738)
              {
              ...
              {
                if (target.getOwnerId() == performer.getWurmId()) {
                  comm.sendNormalServerMessage("You can't use the " + target
                    .getName() + " while carrying it.");
                } else {
                  performer.activeFarwalkerAmulet(target);
                }
              }
            ...
            {
              boolean isTop;
              if ((action == 3) && (target.isHollow()) && (!target.isSealedByPlayer()) && (
                (!target.getTemplate().hasViewableSubItems()) || (target.getTemplate().isContainerWithSubItems()) || 
                (performer.getPower() > 0)))
              {
                ...
                if (target.getWurmId() != performer.getVehicle()) {
                  if (!performer.isWithinDistanceTo(target.getPosX(), target.getPosY(), target.getPosZ(), 
                    (target.isVehicle()) && (!target.isTent()) ? 
                    Math.max(6, target.getSizeZ() / 100) : 6.0F)) {
                    return toReturn;
                  }
                }
                isTop = (target.getWurmId() == target.getTopParent()) || ((target.getTopParentOrNull() != null) && (target.getTopParentOrNull().getTemplate().hasViewableSubItems()) && ((!target.getTopParentOrNull().getTemplate().isContainerWithSubItems()) || (target.isPlacedOnParent())));
                if (!isTop)
                {
                  if (target.isLockable())
                  {
                ...
                if (((target.getTemplateId() == 1239) || (target.getTemplateId() == 1175)) && 
                  (target.hasQueen()) && (!WurmCalendar.isSeasonWinter()) && 
                  (performer.getBestBeeSmoker() == null) && (performer.getPower() < 2))
                {
                  performer.getCommunicator().sendSafeServerMessage("The bees get angry and defend the " + target
                    .getName() + " by stinging you.");
                  performer.addWoundOfType(null, (byte)5, 2, true, 1.0F, false, 5000.0F + Server.rand
                    ...
                    (target.getTemplateId() == 850) && (MethodsItems.mayUseInventoryOfVehicle(performer, target))))
                  {
                    if (performer.addItemWatched(target))
                    {
                      ...
                      if (target.getDescription().isEmpty()) {
                        ...
                        comm.sendOpenInventoryWindow(target.getWurmId(), target
                          .getName() + " [" + target.getDescription() + "]");
                      }
                ...
                if (target.isSealedByPlayer())
                {
                  if (target.isCrate())
                  {
                    if ((performer.getWurmId() == target.getLastOwnerId()) || (performer.getPower() > 1)) {
                      ...
                      comm.sendSafeServerMessage("Only the last owner can remove the security seal on the " + target
                        .getName() + ".");
                    }
                  }
                  else {
              ...
              {
                if (target.isSealedByPlayer()) {
                  tasteLiquid(performer, target);
                } else if ((target.isFood()) || (target.isLiquid())) {
                  taste(performer, target);
              ...
              else
              {
                ...
                if (action == 74)
                {
                  ...
                  if (!GeneralUtilities.isOnSameLevel(performer, target))
                  {
                    ...
                    if (theTile != null)
                    {
                      if (theTile.getStructure() != null) {
                        ...
                        comm.sendNormalServerMessage("You need to get closer to the " + target
                          .getName() + ".");
                      }
                      doneMsg = true;
                    }
                  ...
                  if ((target.getTemplateId() == 1125) && (
                    (target.isBusy()) || ((System.currentTimeMillis() - target.lastRammed < 30000L) && 
                    (performer.getWurmId() != target.lastRamUser))))
                  {
                    ok = false;
                  ...
                  {
                    ok = false;
                    comm.sendNormalServerMessage("You need to stop dragging the " + performer
                      .getDraggedItem().getName() + " first.");
                    doneMsg = true;
                  }
                ...
                else
                {
                  ...
                  else if (action == 328)
                  {
                    if (target.isEgg())
                    {
                      comm.sendNormalServerMessage("You suck on the " + target
                        .getName() + " a little. Weird feeling.");
                      Server.getInstance().broadCastAction(performer
                        .getName() + " sucks on " + target.getNameWithGenus() + ". A strange feeling runs through you.", performer, 3);
                    }
                  }
                  else if (action == 330)
                  {
                    toReturn = true;
                    if (target.isEgg()) {
                      if (target.getTemplateId() == 465) {
                        if (target.hatching)
                        {
                          comm.sendNormalServerMessage("The " + target
                            .getName() + " is already hatching.");
                        }
                        else if ((target.getDamage() > 80.0F) || (performer.getPower() >= 5))
                        {
                          comm.sendNormalServerMessage("You make a small hole in the " + target
                            .getName() + ".");
                          Server.getInstance().broadCastAction(performer
                            .getName() + " makes a small hole in " + target.getNameWithGenus() + "!", performer, 20);
                          
                          target.hatching = true;
                        }
                        else
                        {
                          comm.sendNormalServerMessage("The shell of the " + target
                            .getName() + " is too hard still.");
                        }
                      }
                    }
                  }
                  ...
                  else if (action == 183)
                  {
                    ...
                    if ((target.isContainerLiquid()) && (target.getItemCount() == 1)) {
                      for (ok = target.getItems().iterator(); ok.hasNext(); goto 12819)
                      {
                        Item i = (Item)ok.next();
                        if ((!i.isNoEatOrDrink()) && (!i.isUndistilled()) && (i.isDrinkable()))
                        {
                  ...
                  else if (action == 91)
                  {
                    if (target.getTemplateId() == 442) {
                      if (performer.getStatus().canEat())
                      {
                        ...
                        Server.getInstance().broadCastAction(performer
                          .getName() + " returns from the " + target.getName() + " with a loud burp.", performer, 5);
                  ...
                  else if (action == 87)
                  {
                    toReturn = true;
                    if (target.isFullprice()) {
                      comm.sendNormalServerMessage("Price is set to " + 
                        Economy.getEconomy().getChangeFor(target.getValue()).getChangeString() + ".");
                    } else if (target.getPrice() <= 0)
                    {
                      if (target.getValue() <= 1) {
                        comm.sendNormalServerMessage("A trader would deem this pretty worthless.");
                      } else {
                        comm.sendNormalServerMessage("A trader would sell this for about " + 
                        
                          Economy.getEconomy().getChangeFor(target.getValue() / 2).getChangeString() + ".");
                      }
                    }
                    else {
                      comm.sendNormalServerMessage("Price is set to " + 
                        Economy.getEconomy().getChangeFor(target.getPrice()).getChangeString() + ".");
                    }
                    if (MethodsReligion.canBeSacrificed(target))
                    {
                      ...
                      favorMod = MethodsReligion.getFavorModifier(deity, target);
                      deityName = "a deity";
                      if (deity != null) {
                      ...
                      if (favorGain > 1.0F) {
                        comm.sendNormalServerMessage(String.format("You think you can sacrifice this to %s for about %d favor.", new Object[] { deityName, 
                          Integer.valueOf(favorGain) }));
                      } else {
                        comm.sendNormalServerMessage(String.format("You think %s would not provide much favor for sacrificing this.", new Object[] { deityName }));
                      }
                    }
                  }
                  else if (action == 133)
                  ...
                  {
                    toReturn = true;
                    if ((target.isFire()) || (target.isLight()) || (target.isForgeOrOven()) || 
                      ...
                      if (target.isOnFire())
                      {
                        if (target.getTemplateId() == 729)
                        {
                          ...
                          Server.getInstance().broadCastAction(performer
                            .getName() + " blows out " + target.getNameWithGenus() + ".", performer, 5);
                          if (target.isAlwaysLit()) {
                        ...
                        else
                        {
                          ...
                          Server.getInstance().broadCastAction(performer
                            .getName() + " snuffs " + target.getNameWithGenus() + ".", performer, 5);
                          if (target.isAlwaysLit())
                          {
                  ...
                  else if (action == 719)
                  {
                    ...
                    if ((performer.getPower() >= 2) && ((target.getTemplateId() == 176) || 
                      (target.getTemplateId() == 315)))
                    {
                  ...
                  else if (action == 353)
                  {
                    if (Servers.localServer.isChallengeServer()) {
                      ...
                      {
                        toReturn = true;
                        comm.sendNormalServerMessage("The " + 
                        
                          King.getRulerTitle(false, King.getKing((byte)2).gender == 0 ? true : (byte)2) + " is appointed already. The stone is empty.");
                          ...
                          if (WurmCalendar.isChristmas())
                          {
                            if (!performer.hasFlag(62))
                            {
                              if (performer.getKingdomTemplateId() == 3) {
                                comm.sendNormalServerMessage("Seems that you have been a bad person this year, " + performer
                                  .getName() + ". There is a gift for you beneath the tree!");
                              } else if (performer.getReputation() < 0) {
                                comm.sendNormalServerMessage("You have been a bad person this year, " + performer
                                  .getName() + ", but there is a gift for you anyways.");
                              } else {
                                comm.sendNormalServerMessage("You have been a good person this year, " + performer
                                  .getName() + ". Santa left a gift for you beneath the tree!");
                              }
                  ...
                  else if ((action == 285) && (!target.isSealedByPlayer()) && (
                    (target.isFoodMaker()) || (target.getTemplate().isCooker())))
                  {
                    showRecipeInfo(performer, null, target);
                  }
                  else if (action == 79)
                  {
                  ...
                  else if (action == 688)
                  {
                    if ((target.canHavePermissions()) && (target.mayManage(performer)))
                    {
                      ...
                      mp = new ManagePermissions(performer, molt, target, false, -10L, false, null, "");
                  ...
                  {
                    setVolume(performer, target, 12);
                  }
                  else if (action == 726)
                  {
                    setVolume(performer, target, 11);
                  }
                  else if (action == 727)
                  {
                    setVolume(performer, target, 10);
                  }
                  else if (action == 728)
                  {
                    setVolume(performer, target, 9);
                  }
                  else if (action == 729)
                  {
                    setVolume(performer, target, 8);
                  }
                  else if (action == 730)
                  {
                    setVolume(performer, target, 7);
                  }
                  else if (action == 731)
                  {
                    setVolume(performer, target, 6);
                  }
                  else if (action == 732)
                  {
                    setVolume(performer, target, 5);
                  }
                  else if (action == 733)
                  {
                    setVolume(performer, target, 4);
                  }
                  else if (action == 734)
                  {
                    setVolume(performer, target, 3);
                  }
                  else if (action == 735)
                  {
                    setVolume(performer, target, 2);
                  }
                  else if (action == 736)
                  {
                    setVolume(performer, target, 1);
                  }
                  else if (action == 737)
                  {
                    setVolume(performer, target, 0);
                  }
                  else
                  {
                    if (action == 936) {
    ...
    if (action == 909)
    {
      ...
      mp = storedanimal;favorMod = mp.length;
      for (deityName = 0; deityName < favorMod; deityName++)
      {
        Creature cret = mp[deityName];
        if (cret.getWurmId() == target.getData())
        {
          ...
          if (cret.isCaredFor())
          {
            ...
            info = PlayerInfoFactory.getPlayerInfoWithWurmId(careTaker);
            if (info != null) {
    ...
    if (action == 185)
    {
      ...
      if (performer.getPower() >= 0)
      {
        comm.sendNormalServerMessage("It is made from " + 
          MaterialUtilities.getMaterialString(target.getMaterial()) + " (" + target
          .getMaterial() + ") " + ".");
        comm.sendNormalServerMessage("WurmId:" + target
          ...
          .isOnSurface() ? 0 : -1) + " bridgeid=" + target.getBridgeId());
        comm.sendNormalServerMessage("Ql:" + target
          .getQualityLevel() + ", damage=" + target.getDamage() + ", weight=" + target
          .getWeightGrams() + ", temp=" + target.getTemperature());
        comm.sendNormalServerMessage("parentid=" + target
        ...
        comm.sendNormalServerMessage("lastownerid=" + lastOwnerS + ", Model=" + target
          .getModelName());
        if (performer.getPower() >= 5)
        {
          comm.sendNormalServerMessage("Zoneid=" + target
            .getZoneId() + " real zid=" + target.zoneId + " Counter=" + 
            WurmId.getNumber(target.getWurmId()) + " origin=" + WurmId.getOrigin(target.getWurmId()) + " fl=" + target
            .getFloorLevel() + " your fl=" + performer.getFloorLevel() + " bridge=" + target
            .getBridgeId());
          if (target.isVehicle())
          {
            float diffposx = target.getPosX() - performer.getPosX();
            float diffposy = target.getPosY() - performer.getPosY();
            comm.sendNormalServerMessage("Relative: offx=" + diffposx + ", offy=" + diffposy + ", offz=" + performer
              .getPositionZ() + " altOffZ=" + performer
              .getAltOffZ());
          }
        }
        if (target.hasData()) {
          comm.sendNormalServerMessage("data=" + target
            .getData() + ", data1=" + target.getData1() + " data2=" + target
            .getData2());
        }
        ...
        if (target.isLock())
        {
          ...
          knowl = keys;info = knowl.length;
          for (buf = 0; buf < info; buf++)
          {
            long lKey = knowl[buf];
        ...
        if (target.getTemplateId() == 1311) {
          comm.sendNormalServerMessage("Loader / Unloader WurmID = " + target
            .getLastOwnerId() + ", Name = " + lastOwnerS);
        }
      }
    }
    else if (action == 355)
    ...
    {
      if (ttid == 726) {
        if ((performer.getPower() == 0) || (Servers.localServer.testServer)) {
          if ((performer.getKingdomId() == target.getAuxData()) || (Servers.localServer.testServer)) {
              ...
              if (k != null) {
                if (k.hasFailedAllChallenges()) {
                  if (!performer.hasVotedKing())
                  {
                    ...
                    comm.sendNormalServerMessage("You vote to remove " + k
                      .getFullTitle() + ".");
                  ...
                  {
                    comm.sendNormalServerMessage("You have already voted to remove " + k
                      .getFullTitle() + ".");
                  }
                }
              }
            ...
            if ((System.currentTimeMillis() - ((Player)performer).getSaveFile().lastChangedKindom > 7257600000L) || (Servers.localServer.testServer))
            {
              ...
              if (k != null) {
                if (k.mayBeChallenged())
                {
                  ...
                  comm.sendNormalServerMessage("You vote to challenge " + k
                    .getFullTitle() + ".");
                  if ((performer.getPower() <= 0) || (
                  
                    (!alreadyChallenged) && (k.hasBeenChallenged()))) {
                    try
                    {
    ...
    else if (action == 608)
    {
      ...
      if ((performer.getDeity() != null) && (
        ...
        if (target.getTemplateId() == performer.getDeity().getHolyItem())
        {
  ...
  public boolean action(Action act, Creature performer, Item source, Item target, short action, float counter)
  {
    if (target.canBePlanted())
    {
      ...
      if ((Features.Feature.SINGLE_PLAYER_BRIDGES.isEnabled()) && (action == 637) && 
        (source.getTemplateId() == 903) && 
        (target.getTemplateId() == 901)) {
        return MethodsSurveying.planBridge(act, performer, source, null, target, action, counter);
      }
      if ((Features.Feature.SINGLE_PLAYER_BRIDGES.isEnabled()) && (action == 640) && 
        (source.getTemplateId() == 903) && 
        (target.getTemplateId() == 901)) {
        return MethodsSurveying.survey(act, performer, source, null, target, action, counter);
      }
      if ((action == 640) && (
        (source.getTemplateId() == 805) || 
        (source.getTemplateId() == 1009)))
      {
    ...
    if (!target.isTraded())
    {
      if (action > 10000)
      {
        ...
        {
          if ((target.isNoTake(performer)) || (target.isUseOnGroundOnly())) {
            if ((target.getWurmId() != performer.getVehicle()) && (!performer.isWithinDistanceTo(target.getPosX(), target.getPosY(), target.getPosZ(), 4.0F)))
            {
          ...
          {
            int c = WurmColor.createColor(1 + Server.rand
              .nextInt(255), 1 + Server.rand
              .nextInt(255), 1 + Server.rand
              .nextInt(255));
            created.setColor(c);
          }
          if (created.isLock()) {
            try
            {
              ...
              {
                Item key = ItemFactory.createItem(168, created.getQualityLevel(), performer
                  .getName());
            ...
            {
              logger.log(Level.WARNING, performer.getName() + " failed to create key: " + fe.getMessage(), fe);
            }
          }
          if ((created.isDrinkable()) || (created.isFood())) {
          ...
          if ((!created.isLiquid()) && (created.getTemplateId() != 1269)) {
            ...
            {
              performer.getCommunicator().sendNormalServerMessage("You create " + created
                .getNameWithGenus() + ".");
              Server.getInstance().broadCastAction(performer
                .getName() + " creates " + created.getNameWithGenus() + ".", performer, 5);
              ...
              try
              {
                ...
                if (Tiles.decodeHeight(placedTile) < 0)
                {
                  ...
                  else
                  {
                    ...
                    performer.getCommunicator().sendNormalServerMessage("You create " + created
                      .getNameWithGenus() + " in front of you on the ground.");
                    Server.getInstance().broadCastAction(performer
                      .getName() + " creates " + created.getNameWithGenus() + ".", performer, 
                ...
                else
                {
                  ...
                  if ((created.getTemplateId() == 37) && (!created.deleted))
                  {
                    ...
                    Effect effect = EffectFactory.getInstance().createFire(created.getWurmId(), created
                      .getPosX(), created.getPosY(), created.getPosZ(), performer
                      .isOnSurface());
        ...
        catch (FailedException localFailedException1) {}
        if (done) {
      ...
      else if (action == 118)
      {
        if ((target.getTemplateId() == 1271) && (
          (source.getTemplateId() == 748) || (source.getTemplateId() == 1272)))
        {
          postVillageMessage(performer, source, target);
        }
        else if (ttid == 700)
        {
          done = true;
          if (((!source.isLight()) && (!source.isFire())) || ((source.isOnFire()) || (stid == 315) || (stid == 176) || (stid == 143)))
          {
            if (target.getOwnerId() == -10L)
            {
              ...
              Players.getInstance().sendEffect(num, target.getPosX(), target.getPosY(), target
                .getPosZ() + 10.0F + Server.rand.nextInt(30), performer.isOnSurface(), 500.0F);
              target.setQualityLevel(target.getQualityLevel() - 1.0F);
              if (target.getQualityLevel() > 0.0F) {
                performer.getCommunicator().sendNormalServerMessage("The fireworks now has " + 
                  Math.ceil(target.getQualityLevel()) + " charges left.");
              }
      ...
      {
        if ((ttid == 1394) && (
          (source.isWeaponKnife()) || (source.getTemplateId() == 258))) {
      ...
      else
      {
        ...
        if (action == 83)
        {
          ...
          {
            performer.getCommunicator().sendNormalServerMessage("That " + target
              .getName() + " is in a wagoners camp, who does not allow such actions.");
            done = true;
          }
          else if ((target.isRoadMarker()) && (Wagoner.isOnActiveDeliveryRoute(target)))
          {
            performer.getCommunicator().sendNormalServerMessage("That " + target
              .getName() + " is on a wagoners route, you will have to wait till they have done that delivery.");
            done = true;
          }
        ...
        else
        {
          if (action == 185)
          {
            if ((source.getTemplateId() == 176) && (performer.getPower() > 0) && 
              (source.getAuxData() == 1) && (target.isVehicle()))
            {
              Vehicle v = Vehicles.getVehicle(target);
              
              String wPos = StringUtil.format("Vehicle TileX: %d TileY: %d FloorLevel: %d", new Object[] {
                Integer.valueOf(target.getTileX()), 
                Integer.valueOf(target.getTileY()), 
                Integer.valueOf(target.getFloorLevel()) });
              performer.getCommunicator().sendNormalServerMessage(wPos);
              if (v.getDraggers() != null) {
                for (Creature c : v.getDraggers())
                {
                  String s = StringUtil.format("Dragger TileX: %d TileY: %d, id: %d FloorLevel: %d, PosZ: %d, StatusPosZ: %.2f", new Object[] {
                  
                    Integer.valueOf(c.getTileX()), 
                    Integer.valueOf(c.getTileY()), 
                    Long.valueOf(c.getWurmId()), 
                    Integer.valueOf(c.getFloorLevel()), 
                    Integer.valueOf(c.getPosZDirts()), 
                    Float.valueOf(c.getStatus().getPositionZ()) });
              ...
              if (seats != null) {
                for (int i = 0; i < seats.length; i++)
                {
                  ...
                  if (p != null)
                  {
                    String s = StringUtil.format("Name: %s, TileX: %d TileY: %d, ZPos: %.2f, FloorLevel: %d", new Object[] {p
                      .getName(), 
                      Integer.valueOf(p.getTileX()), 
                      Integer.valueOf(p.getTileX()), 
                      Float.valueOf(p.getStatus().getPositionZ()), 
                      Integer.valueOf(p.getFloorLevel(true)) });
                    performer.getCommunicator().sendNormalServerMessage(s);
                  }
                }
              }
            ...
            if (target.isLockable())
            {
              if ((target.getLockId() == -10L) || (
                ...
                try
                {
                  ...
                  performer.getCommunicator().sendSafeServerMessage("The " + target
                    .getName() + " is locked. Please use the key to unlock and open it.");
                }
                catch (NoSuchItemException nsi)
                {
          ...
          else
          {
              ...
              (source.getRarity() == target.getRarity()))
            {
                ...
                (source.getRealTemplateId() != target.getRealTemplateId()))
              {
                ...
                if (freeVol > 0)
                {
                  float newQl = (target.getCurrentQualityLevel() * target.getWeightGrams() + source.getCurrentQualityLevel() * freeVol) / (target.getWeightGrams() + freeVol);
                  ...
                  proteinsTotal = target.getProteinsByWeight() + source.getProteinsByWeight(freeVol);
                  int weight = target.getWeightGrams() + freeVol;
                  short calories = (short)(int)(caloriesTotal * 1000.0F / weight);
                  short carbs = (short)(int)(carbsTotal * 1000.0F / weight);
                  short fats = (short)(int)(fatsTotal * 1000.0F / weight);
                  short proteins = (short)(int)(proteinsTotal * 1000.0F / weight);
              ...
              else
              {
                ...
                {
                  performer.getCommunicator().sendNormalServerMessage(fe.getMessage());
                }
              }
            }
            else if (action == 283)
            ...
            else if (action == 285)
            {
                ...
                if ((source.getTemplateId() == 866) || (target.getTemplateId() == 866)) {
                  try
                  {
                    ...
                    else
                    {
                      ...
                      try
                      {
                        ItemTemplate template = ItemTemplateFactory.getInstance().getTemplate(blood
                          .getPotionTemplateIdForBlood());
                        performer.getCommunicator().sendNormalServerMessage("You would create " + template
                          .getNameWithGenus() + ".");
                      }
              ...
              {
                showRecipeInfo(performer, source, target);
              }
              else
              {
                performer.getCommunicator().sendNormalServerMessage("You cannot mix these.");
            ...
            else
            {
              ...
              else if ((source.isWand()) && (performer.getPower() >= 2) && (target.isLock()) && (action == 28) && 
                (Servers.isThisATestServer()))
              {
              ...
              else
              {
                ...
                {
                  vt = Zones.getTileOrNull(target.getTileX(), target.getTileY(), target.isOnSurface());
                  ...
                  if (target.getLastOwnerId() == performer.getWurmId()) {
                    ...
                    ok = true;
                  } else if ((!target.isInPvPZone()) && (!target.isVehicle()) && (vill != null) && 
                    (vill.isActionAllowed(action, performer))) {
                    ok = true;
                  }
                  if (ok)
                  {
                  ...
                  else
                  {
                    ...
                    performer.getCommunicator().sendNormalServerMessage("Stealing " + target
                      .getTemplate().getPlural() + " is punished with death penalty here. You decide not to.");
                  }
                }
                else if (action == 182)
                {
                ...
                else if (action == 183)
                {
                  ...
                  if ((target.isContainerLiquid()) && (target.getItemCount() == 1))
                  {
                    for (vt = target.getItems().iterator(); vt.hasNext(); goto 5963)
                    {
                      Item i = (Item)vt.next();
                      if ((!i.isNoEatOrDrink()) && (!i.isUndistilled()) && (i.isDrinkable()))
                      {
                ...
                {
                  if (((ttid == 729) || (ttid == 203)) && (
                    (source.isWeaponKnife()) || (stid == 258)))
                  {
                    if (performer.getWurmId() == target.getOwnerId())
                    {
                      ...
                      try
                      {
                        ...
                        performer.getCommunicator().sendNormalServerMessage("You cut the " + target
                          .getName() + " into " + slices + " elegant slices.");
                        Server.getInstance().broadCastAction(performer
                          .getName() + " cuts the " + target.getName() + " into " + slices + " elegant slices.", performer, 5);
                        if (performer.getInventory().getNumItemsNotCoins() < 100 - slices)
                        {
                          ...
                          for (int x = 0; x < slices; x++) {
                            try
                            {
                              Item slice = ItemFactory.createItem(toMake, target
                                .getCurrentQualityLevel(), performer.getName());
                  ...
                  else if ((!target.isBulk()) && (target.isFood()) && (!target.isDrinkable()) && 
                    (!target.isMeat()) && (!target.isFish()) && (target.getTemplateId() != 729))
                  {
                    if (target.getWeightGrams() < 2000)
                    {
                      performer.getCommunicator().sendNormalServerMessage(target
                        .getNameWithGenus() + " is too small.");
                      return true;
                    }
                    if (target.getName().contains("portion of "))
                    {
                      performer.getCommunicator().sendNormalServerMessage("It makes no sense to remove a portion of " + target
                        .getNameWithGenus() + ".");
                      return true;
                    }
                    if (target.getName().contains("slice of "))
                    {
                      performer.getCommunicator().sendNormalServerMessage("It makes no sense to remove a slice of " + target
                        .getNameWithGenus() + ".");
                      return true;
                    }
                    performer.getCommunicator().sendNormalServerMessage("You get a portion of " + target
                      .getNameWithGenus() + ".");
                    Server.getInstance().broadCastAction(performer
                      .getName() + " gets a portion of " + target.getNameWithGenus() + ".", performer, 5);
                  ...
                  if (target.isSealedByPlayer())
                  {
                    if (target.isCrate())
                    {
                      if ((performer.getWurmId() == target.getLastOwnerId()) || (performer.getPower() > 1)) {
                        ...
                        performer.getCommunicator().sendSafeServerMessage("Only the last owner can remove the security seal on the " + target
                          .getName() + ".");
                      }
                    }
                    else {
                ...
                else
                {
                  ...
                  if (action == 510)
                  {
                      ...
                      (stid == 676))
                    {
                      ...
                      {
                        m = new AchievementCreation(performer, "Achievement Management", "Achievement properties", source.getWurmId());
                        m.sendQuestion();
                      }
                      else
                      {
                        performer.getCommunicator().sendNormalServerMessage("The cost for creating an achievement is 10 charges. The " + source
                          .getName() + " contains " + source
                          .getAuxData() + ".");
                      }
                    }
                  }
                  else if (action == 370)
                  {
                    ...
                    if ((stid == 751) && (ttid == 676)) {
                      ...
                      {
                        performer.getCommunicator().sendNormalServerMessage("You can not use the " + source
                          .getName() + " right now.");
                      }
                      else if (target.getAuxData() > 90)
                      {
                        performer.getCommunicator().sendNormalServerMessage("The charges would be lost. Use the " + target
                          .getName() + " a bit more first.");
                      }
                      else
                      {
                        Items.destroyItem(source.getWurmId());
                        target.setAuxData((byte)(target.getAuxData() + 10));
                        performer.getCommunicator().sendNormalServerMessage("You recharge the " + target
                          .getName() + ". The " + source.getName() + " crumbles in the process.");
                      }
                    }
                  }
                  else if (action == 632)
                    ...
                    if (stid == 867)
                    {
                      if (Spell.mayBeEnchanted(target))
                      {
                        if (target.getRarity() < source.getRarity())
                        {
                          ...
                          {
                            if (((target.isCombine()) && (target.getWeightGrams() <= target.getTemplate().getWeightGrams())) || 
                              (!target.isCombine()))
                            {
                              ...
                              Items.destroyItem(source.getWurmId());
                              logger.info(performer.getName() + " using a " + MethodsItems.getRarityDesc(source.getRarity()) + " strange bone (" + source.getWurmId() + ") on a " + target
                                .getName() + " (" + target.getWurmId() + ")");
                            }
                            else
                            {
                  ...
                  else if (action == 54)
                  {
                    ...
                    if ((ttid == 765) && ((stid == 62) || (source.isWeaponCrush())))
                    {
                      performer.getCommunicator().sendNormalServerMessage("You crush the " + target
                        .getName() + ". The " + target.getName() + " crumbles to salt.");
                      try
                      {
                  ...
                  else
                  {
                      ...
                      (performer.getPower() > 0)))
                    {
                        ...
                        (performer.getBestBeeSmoker() == null) && (performer.getPower() < 2))
                      {
                        performer.getCommunicator().sendSafeServerMessage("The bees get angry and defend the " + target
                          .getName() + " by stinging you.");
                        performer.addWoundOfType(null, (byte)5, 2, true, 1.0F, false, 5000.0F + Server.rand
                          .nextFloat() * 7000.0F, 0.0F, 20.0F, false, false);
                        return true;
                      }
                      if (target.getTemplateId() == 1239) {
                        Achievements.triggerAchievement(performer.getWurmId(), 552);
                          ...
                          (target.isLocked()) && (target.mayAccessHold(performer))))
                        {
                          if (performer.addItemWatched(target))
                          {
                            ...
                            if (target.getDescription().isEmpty()) {
                              ...
                              performer.getCommunicator().sendOpenInventoryWindow(target.getWurmId(), target
                                .getName() + " [" + target.getDescription() + "]");
                            }
                            target.addWatcher(target.getWurmId(), performer);
                            target.sendContainedItems(target.getWurmId(), performer);
                    ...
                    else if (action == 180)
                    {
                      ...
                      else
                      {
                        performer.getLogger().log(Level.INFO, performer
                          ...
                          .getName() + " destroyed " + target.toString());
                    ...
                    else if (action == 519)
                    {
                      if ((stid == 788) && (target.isMetal()) && (!target.isLiquid())) {
                        ...
                        {
                          if ((!target.isIndestructible()) && (!target.isArtifact()) && (!target.isUnique()) && (!target.getTemplate().isStatue()) && 
                            (!target.isRoyal()) && (!target.getTemplate().isRune()) && (target.getTemplateId() != 1307) && 
                              ...
                              if (target.getParentId() > -10L)
                              {
                                if ((!target.isHollow()) || (target.isEmpty(false)))
                                {
                                  if ((target.getSpellEffects() == null) || 
                                    (target.getSpellEffects().getEffects().length == 0))
                                  {
                                    if (!MethodsItems.checkIfStealing(target, performer, act))
                                    {
                                      if (target.enchantment == 0)
                                      {
                                        ...
                                        {
                                          CreationEntry e = CreationMatrix.getInstance().getCreationEntry(target
                                            .getTemplateId());
                                          ...
                                          if (e != null)
                                          {
                                            try
                                            {
                                              ItemTemplate src = ItemTemplateFactory.getInstance().getTemplate(e
                                                .getObjectSource());
                                              if (src.getMaterial() == target.getMaterial())
                                              {
                                                ...
                                                logger.log(Level.INFO, "1. Adding weightToReturn " + weightToReturn + " for " + src
                                                  .getTemplateId() + " srcw=" + src
                                                  .getWeightGrams() + " tgw=" + target.getWeightGrams() + " combine=" + isCombine);
                                              }
                                              else if ((e.depleteSource) || (e.depleteEqually))
                                              {
                                                weightToReduce = Math.min(target.getWeightGrams(), src.getWeightGrams());
                                                logger.log(Level.INFO, "2. Adding weightToReduce " + weightToReduce + " for " + src
                                                  .getTemplateId() + " srcw=" + src
                                                  .getWeightGrams() + " tgw=" + target.getWeightGrams());
                                              }
                                            }
                                            ...
                                            try
                                            {
                                              ...
                                              if ((Materials.isMetal(src.getMaterial())) || 
                                                (src.getMaterial() == target.getMaterial()) || ((src.getMaterial() == 0) && (src.isMetal())))
                                              {
                                                if (src.isCombine()) {
                                                  isCombine = true;
                                                }
                                                weightToReturn += Math.min(target.getWeightGrams(), src
                                                  .getWeightGrams());
                                                logger.log(Level.INFO, "3. Adding weightToReturn " + weightToReturn + " for " + src
                                                  .getTemplateId() + " srcw=" + src
                                                  .getWeightGrams() + " tgw=" + target.getWeightGrams() + " combine=" + isCombine);
                                              }
                                              else
                                              {
                                                weightToReduce = Math.min(target.getWeightGrams(), src.getWeightGrams());
                                                logger.log(Level.INFO, "4. Adding weightToReduce " + weightToReduce + " for " + src
                                                  .getTemplateId() + " srcw=" + src
                                                  .getWeightGrams() + " tgw=" + target.getWeightGrams());
                                              }
                                            }
                                            catch (NoSuchTemplateException localNoSuchTemplateException2) {}
                                            if (!isCombine)
                                            {
                                              localNoSuchTemplateException2 = e.getRequirements();fe = localNoSuchTemplateException2.length;
                                              for (proteinsTotal = 0; proteinsTotal < fe; proteinsTotal++)
                                              {
                                                CreationRequirement req = localNoSuchTemplateException2[proteinsTotal];
                                                if (req.willBeConsumed()) {
                                                  ...
                                                  catch (NoSuchTemplateException localNoSuchTemplateException3) {}
                                                }
                                              }
                                            }
                                            else
                                            {
                                              ...
                                              for (proteinsTotal = 0; proteinsTotal < fe; proteinsTotal++)
                                              {
                                                ...
                                                if (req.willBeConsumed()) {
                                                  ...
                                                  catch (NoSuchTemplateException localNoSuchTemplateException4) {}
                                                }
                                              }
                                            }
                                          }
                                          ...
                                          {
                                            logger.log(Level.INFO, "10. Setting weight " + (target
                                              .getWeightGrams() - weightToReduce - weightToReturn / 10));
                                            
                                            target.setWeight(target.getWeightGrams() - weightToReduce - weightToReturn / 10, true);
                                          }
                                          else if (weightToReduce < target.getWeightGrams())
                                          {
                                            target.setWeight(target
                                              .getWeightGrams() - weightToReduce - target
                                              .getWeightGrams() / 10, true);
                                          }
                                          else
                                          {
                                            target.setWeight(weightToReturn - weightToReturn / 10, true);
                                        ...
                                        if (!target.deleted)
                                        {
                                          ...
                                          target.setQualityLevel(Math.min(target.getCurrentQualityLevel() * qlMod, source
                                            .getCurrentQualityLevel()));
                                          target.setCreationState((byte)0);
                                          target.setCreator("");
                                          target.setRealTemplate(-10);
                                          
                                          target.setTemplateId(Materials.getTemplateIdForMaterial(target
                                            .getMaterial()));
                                      ...
                                      else
                                      {
                                        performer.getCommunicator().sendNormalServerMessage("The " + target
                                          .getName() + " resists smelting.");
                                      }
                                    }
                                    else {
                                      performer.getCommunicator().sendNormalServerMessage("You need to steal the " + target
                                        .getName() + " first.");
                                    }
                                  }
                                  else {
                                  ...
                                  performer.getCommunicator().sendNormalServerMessage("You'd want to empty the " + target
                                    .getName() + " first.");
                                }
                              }
                              else {
                                performer.getCommunicator().sendNormalServerMessage("The " + target
                                  .getName() + " needs to be in a container.");
                              }
                            }
                            else {
                              performer.getCommunicator().sendNormalServerMessage("The " + target
                                .getName() + " is not hot enough.");
                            }
                          }
                          else {
                            performer.getCommunicator().sendNormalServerMessage("You can't bring yourself to smelt the " + target
                              .getName() + ". What's up with you today?");
                          }
                        }
                        else {
                          performer.getCommunicator().sendNormalServerMessage("It makes no sense to smelt " + target
                            .getNameWithGenus() + ". There would be no change.");
                        }
                      }
                    }
                    else if (action == 380)
                    {
                      if ((source.isCoin()) && (target.isSpringFilled())) {
                        if (target.getSpellCourierBonus() > 0.0F)
                        {
                      ...
                      if ((ttid == 1076) && (source.isGem())) {
                        if (target.getData1() <= 0)
                        {
                          ...
                          if (counter == 1.0F)
                          {
                            ...
                            Server.getInstance().broadCastAction(performer
                              .getName() + " starts inserting " + source.getNameWithGenus() + " into " + target.getNameWithGenus() + ".", performer, 5);
                          ...
                          if (act.currentSecond() == 5)
                          {
                            ...
                            Server.getInstance().broadCastAction(performer
                              .getName() + " investigates the " + source.getName() + " and the " + target.getName() + ".", performer, 5);
                          }
                          if (act.currentSecond() == 10)
                          {
                            ...
                            try
                            {
                              ...
                              if (jewelry.getKnowledge(0.0D) >= skillRequired) {
                                ok = true;
                              }
                              if (ok)
                              {
                          ...
                          if (act.currentSecond() == 40)
                          {
                            ...
                            {
                              Skill jewelry = performer.getSkills().getSkill(10043);
                              jewelry.skillCheck(skillRequired, source.getQualityLevel(), false, 40.0F);
                            }
                            ...
                            Server.getInstance().broadCastAction(performer
                              .getName() + " rejoices as " + performer.getHeSheItString() + " inserts the " + source.getName() + " into the " + target.getName() + "!", performer, 5);
                    ...
                    else if (action == 922)
                    {
                      ...
                      if ((target.getTemplateId() == 180) || (target.getTemplateId() == 178) || 
                        (target.getTemplateId() == 1023) || (target.getTemplateId() == 1028))
                      {
                        if (source.getTemplateId() == 25)
                        {
                          ...
                          if (counter >= act.getNextTick())
                          {
                            ...
                            catch (FailedException|NoSuchTemplateException|NoSuchSkillException fe)
                            {
                          ...
                          if (act.currentSecond() >= 29)
                          {
                            try
                            {
                              ...
                              int knowledge = (int)fms.getKnowledge(0.0D);
                              fms.skillCheck(knowledge, 0.0D, false, 1.0F);
                              double power = fms.skillCheck(knowledge, 0.0D, false, 1.0F);
                              if (target.getQualityLevel() > power) {
                                power = (float)performer.getSkills().getSkill(1010).getKnowledge();
                              }
                              if (target.getQualityLevel() < power) {
                                power = (float)performer.getSkills().getSkill(1010).getKnowledge();
                              }
                              float min = (float)Math.min(target.getQualityLevel(), power);
                              float max = (float)Math.max(target.getQualityLevel(), power);
                              float ql = Server.rand.nextFloat() * (max - min) + min;
                      ...
                      if ((stid == 654) && (source.getAuxData() == 0))
                      {
                        if ((target.getOwnerId() == performer.getWurmId()) || (target.getOwnerId() == -10L))
                        {
                          ...
                          if (target.isTransmutable())
                          {
                            ...
                            if (target.getTemplateId() == 204) {
                              if (Server.rand.nextInt(performer.getPower() >= 5 ? 5 : 100) == 0) {
                            ...
                            if (counter == 1.0F)
                            {
                              ...
                              Server.getInstance().broadCastAction(performer
                                .getName() + " starts to transmutate " + target.getNameWithGenus() + ".", performer, 5);
                            ...
                            if (act.currentSecond() == 5)
                            {
                              ...
                              {
                                performer.getCommunicator().sendNormalServerMessage("The " + target
                                  .getName() + " contains too little material to be transmutated properly.");
                                
                                return true;
                              }
                              if (nums > source.getWeightGrams())
                              {
                                performer.getCommunicator().sendNormalServerMessage("You understand that your " + source
                                  .getName() + " will not suffice to transmutate all the material.");
                            ...
                            if (act.currentSecond() == 10)
                            {
                              ...
                              Server.getInstance().broadCastAction(performer
                                .getName() + " intensely watches the " + target.getNameWithGenus() + " as it seems to change.", performer, 5);
                            }
                            if (act.currentSecond() == 20)
                            {
                              ...
                              Server.getInstance().broadCastAction(performer
                                .getName() + " rejoices as the " + target.getNameWithGenus() + " changes to something new!", performer, 5);
                              try
                              {
                        ...
                        {
                          performer.getCommunicator().sendNormalServerMessage("You need to be in control of the " + target
                            .getName() + ".");
                        }
                      }
                      else {
                        performer.getCommunicator().sendNormalServerMessage("You do a basic test and conclude that nothing will happen to the " + target
                          .getName() + ".");
                      }
                    }
                    else if (action == 195)
                    ...
                    else if (action == 189)
                    {
                      ...
                      {
                        performer.getCommunicator().sendNormalServerMessage("You must fill the " + source
                          .getName() + " with a burning liquid.");
                      }
                      ...
                      {
                        if (target.isCandleHolder()) {
                          if (target.getAuxData() >= 126)
                          {
                            performer.getCommunicator().sendNormalServerMessage("The " + target
                              .getName() + " can hold no more candles.");
                          }
                          else
                          {
                            boolean nocandle = target.getAuxData() == 0;
                            performer.getCommunicator().sendNormalServerMessage("You put the " + source
                              .getName() + " " + (ttid == 729 ? "on" : "in") + " the " + target
                              .getName() + ".");
  ...
  private static List<ActionEntry> addCreationEntrys(List<ActionEntry> toReturn, Creature performer, Item source, Item target)
  {
    ...
    if (recipe != null)
    {
      ...
      toReturn.add(new ActionEntry(recipe.getMenuId(), recipe
        .getSubMenuName(realTarget) + ": " + chance + "%" + dif, "creating"));
    }
    CreationEntry[] options = CreationMatrix.getInstance().getCreationOptionsFor(source, target);
    Map<String, Map<CreationEntry, Integer>> map;
    String key;
    Iterator<String> it;
    if (options.length > 0)
    {
      map = generateMapfromOptions(performer, source, target, options);
      key = "Miscellaneous";
      if (!map.isEmpty())
      {
        int sz = -map.size();
        ...
        {
          key = (String)it.next();
          map2 = (Map)map.get(key);
          toReturn.add(new ActionEntry((short)-map2.size(), key, "creating " + key));
          for (CreationEntry entry : map2.keySet()) {
            try
            {
              int difficulty = ((Integer)map2.get(entry)).intValue();
              
              ItemTemplate template = ItemTemplateFactory.getInstance().getTemplate(entry
                .getObjectCreated());
              toReturn.add(new ActionEntry((short)(10000 + entry.getObjectCreated()), template.sizeString + template
                .getName() + ": " + difficulty + "%", template.getName(), emptyIntArr));
            }
            catch (NoSuchTemplateException nst)
            {
    ...
    Map<CreationEntry, Integer> map2;
    return toReturn;
  }
    ...
    for (CreationEntry lOption : options) {
      if (lOption.meetsCreatureRestriction(source, target))
      {
        ...
        try
        {
          ...
          if (add)
          {
            Map<CreationEntry, Integer> map2 = (Map)map.get(key);
            if (map2 == null) {
              map2 = new HashMap();
            }
            map2.put(lOption, Integer.valueOf(chance));
            map.put(key, map2);
          }
        }
        catch (NoSuchTemplateException nst)
    ...
    if (t != null) {
      if ((t.getStructure() != null) && (t.getStructure().isTypeHouse()))
      {
        ...
        if (t.getStructure().isOwner(performer))
        {
          ...
          toReturn.add(Actions.actionEntrys['ŭ']);
          toReturn.add(Actions.actionEntrys['Ů']);
          toReturn.add(Actions.actionEntrys['ů']);
          toReturn.add(Actions.actionEntrys['Ŀ']);
          toReturn.add(Actions.actionEntrys['ŀ']);
          toReturn.add(Actions.actionEntrys['Ł']);
          toReturn.add(Actions.actionEntrys['ł']);
          toReturn.add(Actions.actionEntrys['Ń']);
        }
        else if (target.mayUseBed(performer))
        {
          if ((target.mayFreeSleep(performer)) || (target.getRentCost() == 0) || 
            (target.getData() == performer.getWurmId())) {
            toReturn.add(Actions.actionEntrys['Ņ']);
          } else {
            try
            {
              toReturn.add(new ActionEntry((short)324, "Hire for " + 
                Economy.getEconomy().getChangeFor(target.getRentCost()).getChangeString(), "Bops"));
            }
            catch (Exception ex)
            {
              logger.log(Level.WARNING, ex.getMessage(), ex);
  ...
  private static void lightItem(Item target, Item tool, Creature performer)
  {
    ...
    if (target.getTemplateId() == 742) {
      validTool = true;
    } else if ((tool != null) && ((tool.getTemplateId() == 143) || (
      ((tool.getTemplateId() == 176) || (target.getTemplateId() == 315)) && 
      (performer.getPower() >= 2)))) {
      validTool = true;
    }
    if ((target.isLight()) || (target.isFire()) || (target.getTemplateId() == 742))
    {
      ...
      if (!target.isOnFire())
      {
        ...
        if (target.isOilConsuming()) {
          if (target.getAuxData() <= 0)
          {
            performer.getCommunicator().sendNormalServerMessage("The " + target
              .getName() + " contains no oil.");
            return;
          }
        }
        if (target.isCandleHolder()) {
          if (target.getAuxData() <= 0)
          {
            if (target.getTemplateId() == 729) {
              performer.getCommunicator().sendNormalServerMessage("The " + target
                .getName() + " is not a birthday cake.");
            } else {
              performer.getCommunicator().sendNormalServerMessage("The " + target
                .getName() + " contains only candle stumps. Fill with new ones.");
            }
            return;
          }
        }
        ...
        {
          performer.getCommunicator().sendNormalServerMessage("You need to plant the " + target
            .getName() + " first.");
        }
        else
        {
          ...
          Server.getInstance().broadCastAction(performer
            .getName() + " lights " + target.getNameWithGenus() + ".", performer, 5);
        ...
        try
        {
          ...
          if (vtile != null)
          {
            ...
            for (int i = 0; i < items.length; i++) {
              if ((items[i].getTemplateId() == 727) || 
                (items[i].getTemplateId() == 728)) {
                return true;
              }
            }
          }
  ...
  private List<ActionEntry> makeMoveSubMenu(Creature performer, Item target)
  {
    ...
    if ((target.isTurnable(performer)) && ((!target.isRoadMarker()) || (!target.isPlanted())))
    {
      menulist.add(Actions.actionEntrys['±']);
      menulist.add(Actions.actionEntrys['²']);
    }
    if ((target.isMoveable(performer)) && ((!target.isRoadMarker()) || (!target.isPlanted())))
    {
      menulist.add(Actions.actionEntrys[99]);
      menulist.add(Actions.actionEntrys['ʸ']);
      menulist.add(Actions.actionEntrys['͠']);
      menulist.add(Actions.actionEntrys['Ξ']);
      if ((target.getTemplateId() != 931) || (!Servers.localServer.PVPSERVER))
      {
        menulist.add(Actions.actionEntrys['µ']);
        menulist.add(Actions.actionEntrys['ʹ']);
      }
    }
    if (menulist.isEmpty()) {
      return menulist;
  ...
  public static boolean isSignManipulationOk(Item target, Creature performer, short action)
  {
    ...
    if ((Players.getInstance().getKingdomForPlayer(target.getLastOwnerId()) != performer.getKingdomId()) && 
      (performer.isPaying()) && (CargoTransportationMethods.strengthCheck(performer, 21.0D))) {
      return true;
    }
    VolaTile t = Zones.getTileOrNull(target.getTileX(), target.getTileY(), target.isOnSurface());
    if (t != null)
    {
      ...
      {
        if ((!Actions.isActionBuildingPermission(action)) && (village != null) && 
          (village.isActionAllowed(action, performer))) {
          return true;
        }
  ...
  private static boolean examine(Action act, Creature performer, Item target, short action, float counter)
  {
    ...
    if (target.getColor() != -1) {
      if ((!target.isDragonArmour()) || (target.getColor2() == -1))
      {
        sendString.append(" ");
        if (target.isWood())
        {
    ...
    if ((target.isCrate()) && (target.isSealedByPlayer()) && (target.getData() > -1L))
    {
      ...
      if (delivery != null)
      {
        ...
        String appliedBy = " applied by " + wagoner.getName() + ",";
    ...
    if (target.getTemplate().isRune())
    {
      ...
      if (RuneUtilities.isEnchantRune(target)) {
        ...
        (RuneUtilities.getSpellForRune(target) != null) && (RuneUtilities.getSpellForRune(target).isTargetAnyItem()) && 
  ...
  private static boolean handleRecipe(Action act, Creature performer, @Nullable Item source, Item target, short action, float counter, Recipe recipe)
  {
    ...
    Item realSource = swapped != 2 ? null : recipe.hasActiveItem() ? source : target;
    ...
    {
      performer.getCommunicator().sendNormalServerMessage("The " + realTarget.getNameWithGenus() + " contains too little material to create " + recipe
        .getResultNameWithGenus(realTarget) + ".  Try to combine it with a similar object to get a larger amount.");
    ...
    if ((realSource != null) && ((realSource.getTemplateId() == 169) || (realSource.getTemplateId() == 1104))) {
      if (realSource.getTopParent() != performer.getInventory().getWurmId())
      {
        performer.getCommunicator().sendNormalServerMessage("You need to be carrying the " + realSource
          .getName() + " to use it.");
        return true;
      }
    }
    ...
    if (counter == 1.0F)
    {
      ...
      try
      {
        time = Actions.getRecipeCreationTime(150, performer, primSkill, recipe, realSource, realTarget, template
          .isMassProduction());
      }
      catch (NoSuchTemplateException nst)
      {
        if (realSource != null) {
          logger.log(Level.WARNING, "No template when creating with " + realSource
            .getName() + " and " + realTarget.getName() + "." + nst
            .getMessage(), nst);
        } else {
          logger.log(Level.WARNING, "No template when creating " + realTarget
            .getName() + "." + nst
            .getMessage(), nst);
        }
      ...
      act.setTimeLeft(time);
      performer.sendActionControl(Actions.actionEntrys[''].getVerbString() + " " + template.getName(), true, time);
      if (realSource != null)
      {
        performer.getCommunicator().sendNormalServerMessage("You start to work with the " + realSource
          .getName() + " on the " + realTarget.getName() + ".");
        Server.getInstance().broadCastAction(performer
          .getName() + " starts working with the " + realSource.getName() + " on the " + realTarget
          .getName() + ".", performer, 5);
        playToolSound(performer, realSource);
      }
      else
      {
        performer.getCommunicator().sendNormalServerMessage("You start to work on the " + realTarget
          .getName() + ".");
        Server.getInstance().broadCastAction(performer
          .getName() + " starts working on the " + realTarget
          .getName() + ".", performer, 5);
      }
    ...
    if (counter * 10.0F > time)
    {
      ...
      try
      {
        ...
        double ql = Math.min(100.0D, Math.max(1.0D, avgQL + power / 10.0F));
        if (chefMade) {
        ...
        boolean showOwner = primSkill.getKnowledge(0.0D) > 70.0D;
        ...
        newItem = ItemFactory.createItem(template.getTemplateId(), (float)ql, material, noRarity ? 0 : act
          .getRarity(), owner);
        ...
        if (!recipe.useResultTemplateWeight()) {
          if (realTarget.isFoodMaker())
          {
            ...
            for (item : realTarget.getItemsAsArray()) {
              if (item.isLiquid())
              {
                ii = recipe.findMatchingIngredient(item);
                if (ii != null) {
          ...
          else if ((realSource == null) || (!realSource.isCookingTool()) || 
            (!recipe.useResultTemplateWeight()) || (template.isLiquid()))
          {
            if ((realSource == null) || (realSource.getTemplateId() != 202) || 
              (realTarget.getTemplateId() != 1238)) {
              ...
              {
                newWeight = (int)(Math.sqrt((realSource.getWeightGrams() + realTarget.getWeightGrams()) / 1000) * 1000.0D);
                newItem.setWeight(newWeight, true);
              }
              else
              {
        ...
        {
          performer.getCommunicator().sendNormalServerMessage("Not enough of " + realTarget
            .getName() + " to make " + newItem.getName() + ".");
          return true;
        }
        ...
        {
          Item item;
          if ((realSource != null) && (realTarget.getTemplateId() == 768) && (
            (realSource.getTemplateId() == 169) || (realSource.getTemplateId() == 1104)))
          {
            realTarget.closeAll();
            Item[] arrayOfItem2 = realTarget.getItemsAsArray();item = arrayOfItem2.length;
            for (ii = 0; ii < item; ii++)
            {
              item = arrayOfItem2[ii];
            ...
            {
              performer.getCommunicator().sendNormalServerMessage("Not all the " + newItem
                .getName() + " would fit in the " + realTarget.getName() + ".");
              Items.decay(newItem.getWurmId(), newItem.getDbStrings());
              newItem = null;
            }
            realSource.setAuxData((byte)(int)primSkill.getKnowledge(0.0D));
          ...
          else
          {
            ...
            if (!((Item)parent).isContainerLiquid()) {
              parent = ((Item)parent).getParentOrNull();
            }
            if (parent != null)
            {
              if (realTarget.isFoodMaker())
              {
                item = realTarget.getItemsAsArray();ii = item.length;
                for (item = 0; item < ii; item++)
                {
                  Item item = item[item];
              ...
              else
              {
                ...
                {
                  sWeight = recipe.getUsedActiveItemWeightGrams(realSource, realTarget);
                  realSource.setWeight(realSource.getWeightGrams() - sWeight, true);
                }
                Items.destroyItem(realTarget.getWurmId());
              }
              MethodsItems.fillContainer(act, (Item)parent, newItem, performer, true);
              if ((!newItem.deleted) && (newItem.getParentId() == -10L))
              {
                performer.getCommunicator().sendNormalServerMessage("Not all the " + newItem
                  .getName() + " would fit in the " + ((Item)parent).getName() + ".");
                Items.decay(newItem.getWurmId(), newItem.getDbStrings());
                newItem = null;
              }
            }
        ...
        {
          parent = realTarget.getItemsAsArray();sWeight = parent.length;
          for (ii = 0; ii < sWeight; ii++)
          {
            Item item = parent[ii];
          ...
          if (c != null)
          {
            ...
            if ((realTarget.getTemplateId() == 1238) && (newItem.getTemplateId() == 349)) {
              for (int x = 20; x < 100; x += 30)
              {
                ...
                ql = Math.max(1.0D, Math.min(ql, realTarget.getCurrentQualityLevel()));
                if ((act.getRarity() > 0) || (sourceRarity > 0) || (realTarget.getRarity() > 0)) {
                  ql = GeneralUtilities.calcRareQuality(ql, act.getRarity(), sourceRarity, realTarget.getRarity());
                }
                ...
                newItem = ItemFactory.createItem(template.getTemplateId(), (float)ql, material, act
                  .getRarity(), performer.getName());
                createdCount++;
                c.insertItem(newItem);
                
                int skillLevel = (int)primSkill.getKnowledge(0.0D) - x;
        ...
        if (recipe.hasActiveItem()) {
          if ((recipe.getActiveItem().getTemplateId() != 14) && (realSource != null) && (!realSource.isLiquid()) && (!realSource.isCookingTool()) && (!realSource.isRecipeItem())) {
  ...
  {
    if ((source != null) && ((source.isFood()) || (source.isLiquid()))) {
      if ((source.isSalted()) || (source.getTemplateId() == 349)) {
        return true;
      }
    }
    if (target.isFoodMaker()) {
      ...
      if ((target.isSalted()) || (target.getTemplateId() == 349)) {
        return true;
      }
    }
    return false;
  ...
  private void showRecipeInfo(Creature performer, Item source, Item target)
  {
    ...
    else
    {
      ...
      boolean foundHeat = showRecipeInfo(performer, source, target, realTarget, (byte)1);
      boolean foundCreate = showRecipeInfo(performer, source, target, realTarget, (byte)2);
      boolean foundTime = showRecipeInfo(performer, source, target, realTarget, (byte)0);
      if ((!foundHeat) && (!foundCreate) && (!foundTime))
      {
        recipeRandom.setSeed(performer.getWurmId());
        if (recipeRandom.nextBoolean())
        {
          foundHeat = showPartialRecipeInfo(performer, source, target, realTarget, (byte)1);
          if (!foundHeat) {
            foundCreate = showPartialRecipeInfo(performer, source, target, realTarget, (byte)2);
          }
        }
        else
        {
        ...
        if ((!foundHeat) && (!foundCreate)) {
          foundTime = showPartialRecipeInfo(performer, source, target, realTarget, (byte)0);
        }
        if ((!foundHeat) && (!foundCreate) && (!foundTime)) {
  ...
  private boolean showRecipeInfo(Creature performer, @Nullable Item source, Item target, Item realTarget, byte wantedType)
  {
    ...
    if (eRecipe != null)
    {
      if (RecipesByPlayer.isKnownRecipe(performer.getWurmId(), eRecipe.getRecipeId()))
      {
        if (wantedType == 1)
        {
          ...
          performer.getCommunicator().sendNormalServerMessage("The ingredients in the " + target.getName() + " would make " + eRecipe
            .getResultNameWithGenus(realTarget) + needs);
        }
        else if (wantedType == 0)
        {
          performer.getCommunicator().sendNormalServerMessage("The ingredients in the " + target.getName() + " would make " + eRecipe
            .getResultNameWithGenus(realTarget) + " given time.");
        }
        else
        {
          performer.getCommunicator().sendNormalServerMessage("The ingredients in the " + target.getName() + " could make " + eRecipe
            .getResultNameWithGenus(realTarget) + (
            (eRecipe.hasActiveItem()) && (eRecipe.getActiveItem().getTemplateId() != 14) ? " if you used " + 
            StringUtilities.addGenus(eRecipe.getActiveItemName()) + "." : "."));
        }
      }
      ...
      {
        performer.getCommunicator().sendNormalServerMessage("You think this may well work" + (
          (eRecipe.hasActiveItem()) && (eRecipe.getActiveItem().getTemplateId() != 14) ? " if you used " + 
          StringUtilities.addGenus(eRecipe.getActiveItemName()) + "." : "."));
      }
    ...
    if (lRecipe != null)
    {
      ...
      if (!liquidResult.isSuccess())
      {
        ...
        {
          if (wantedType == 1) {
            performer.getCommunicator().sendNormalServerMessage("The ingredients in the " + target.getName() + " would make " + lRecipe
              .getResultNameWithGenus(realTarget) + " when cooked, but...");
          } else if (wantedType == 0) {
            performer.getCommunicator().sendNormalServerMessage("The ingredients in the " + target.getName() + " would make " + lRecipe
              .getResultNameWithGenus(realTarget) + " given time, but...");
          } else {
            performer.getCommunicator().sendNormalServerMessage("The ingredients in the " + target.getName() + " would make " + lRecipe
              .getResultNameWithGenus(realTarget) + (
              (lRecipe.hasActiveItem()) && (lRecipe.getActiveItem().getTemplateId() != 14) ? " if you used " + 
              StringUtilities.addGenus(lRecipe.getActiveItemName()) : "") + ", but...");
          }
        }
        else if (wantedType == 1) {
  ...
  private boolean showPartialRecipeInfo(Creature performer, @Nullable Item source, Item target, Item realTarget, byte wantedType)
  {
    if (target.isFoodMaker())
    {
      ...
      if (recipes.length > 0)
      {
        ...
        {
          Recipe recipe = (Recipe)recipesUnknown.get(recipeRandom.nextInt(recipesUnknown.size()));
          if (pickRandomIngredient(performer, recipe)) {
            return true;
          }
        }
        if (recipesUnNamed.size() > 0)
        {
          Recipe recipe = (Recipe)recipesUnNamed.get(recipeRandom.nextInt(recipesUnNamed.size()));
          if (pickRandomIngredient(performer, recipe)) {
            return true;
          }
        }
        ...
        {
          Recipe recipe = (Recipe)recipesKnown.get(recipeRandom.nextInt(recipesKnown.size()));
          if (pickRandomIngredient(performer, recipe)) {
            return true;
          }
        }
        ...
        {
          Recipe recipe = (Recipe)recipesNamed.get(recipeRandom.nextInt(recipesNamed.size()));
          if (pickRandomIngredient(performer, recipe)) {
            return true;
          }
        }
  ...
  private boolean pickRandomIngredient(Creature performer, Recipe recipe)
  {
    ...
    if (ingredients.length > 0)
    {
      ...
      performer.getCommunicator().sendNormalServerMessage(buf.toString() + "?" + (
        (performer.getPower() > 1) || (performer.hasFlag(51)) ? " (Could make recipe:" + recipe.getRecipeId() + ")" : ""));
      return true;
    }
    return false;
  }
  ...
  private void setVolume(Creature performer, Item target, int auxbyte)
  {
    if (target.getTemplateId() == 1172) {
      ...
      else
      {
        ...
        String vm = newVolume + "g";
        performer.getCommunicator().sendNormalServerMessage("You carefully adjust the " + target
          .getName() + " volume by utilising a small wheel on the bottom and set it to " + vm + ".");
      }
    }
  }
  ...
  private void taste(Creature performer, Item target)
  {
    ...
    if (skill != null) {
      performer.getCommunicator().sendNormalServerMessage("You think the " + target.getName() + " might give you more of an insight about " + skill
        .getName().toLowerCase() + "!");
    }
  }
  ...
  private void tasteLiquid(Creature performer, Item target)
  {
    ...
    if (knowledge > 75.0D)
    {
      rb = "it has a quality of " + String.format("%.2f", new Object[] { Float.valueOf(liquid.getCurrentQualityLevel()) }) + ".";
    }
    ...
    if ((source.canHaveInscription()) && (source.getAuxData() == 0))
    {
      ...
      else
      {
        performer.getCommunicator().sendNormalServerMessage("The " + source
          .getName() + " needs to be inscribed before adding to the " + target.getName() + ".");
      }
    }
  }
  ...
  private static boolean useRuneOnItem(Action act, Creature performer, Item source, Item target, short action, float counter)
  {
    ...
    if (((RuneUtilities.isEnchantRune(source)) || (RuneUtilities.getModifier(RuneUtilities.getEnchantForRune(source), RuneUtilities.ModifierEffect.SINGLE_COLOR) > 0.0F)) && 
        ...
        else if (RuneUtilities.getModifier(RuneUtilities.getEnchantForRune(source), RuneUtilities.ModifierEffect.SINGLE_COLOR) > 0.0F)
        {
          if (RuneUtilities.canApplyRuneTo(source, target))
          {
            ...
            if (source.getColor() == -1) {
              c = WurmColor.createColor(1 + Server.rand
                .nextInt(255), 1 + Server.rand
                .nextInt(255), 1 + Server.rand
                .nextInt(255));
            } else {
  ...
  private static boolean combineFragment(Action act, Creature performer, Item source, Item target, short action, float counter)
  {
    ...
    {
      if ((source.getMaterial() == 0) && (source.getRealTemplate().isMetal()) && 
        (!source.getRealTemplate().isOre) && (!source.getRealTemplate().isMetalLump()))
      {
        source.setMaterial((byte)93);
        source.sendUpdate();
      }
      else if ((target.getMaterial() == 0) && (target.getRealTemplate().isMetal()) && 
        (!source.getRealTemplate().isOre) && (!source.getRealTemplate().isMetalLump()))
      {
        target.setMaterial((byte)93);
        target.sendUpdate();
    ...
    if (counter == 1.0F)
    {
      ...
      time = Actions.getStandardActionTime(performer, performer.getSkills().getSkillOrLearn(10095), null, 0.0D);
      act.setTimeLeft(time);
      performer.sendActionControl(act.getActionString(), true, act.getTimeLeft());
    ...
    if (counter * 10.0F > time)
    {
      ...
      if ((performer.hasFlag(55)) && (annGift == true))
      {
      ...
      if ((!performer.isPaying()) && (annGift == true))
      {
      ...
      if ((!WurmCalendar.isAnniversary()) && (annGift == true))
      {
      ...
      double difficulty = Math.min(90.0D, FragmentUtilities.getDifficultyForItem(source.getRealTemplateId(), source.getMaterial()) * (
        (source.getAuxData() + target.getAuxData()) / totalNeeded));
      double power = restoration.skillCheck(difficulty, 0.0D, false, (float)difficulty);
      if (power >= 0.0D)
      {
        if (newTotal >= totalNeeded)
        {
          try
          {
            ...
            if (annGift == true)
            {
              createdItem = ItemFactory.createItem(FragmentUtilities.getRandomAnniversaryGift(), 80.0F, act
                .getRarity(), performer.getName());
            ...
            else
            {
              ...
              newQl += (100.0D - newQl) * (finalData2 / 500.0F);
              createdItem = ItemFactory.createItem(combinedTemplate.getTemplateId(), (float)Math.max(1.0D, Math.min(100.0D, newQl)), act
                .getRarity(), performer.getName());
              if (source.getRarity() > createdItem.getRarity()) {
                createdItem.setRarity(source.getRarity());
              }
              ...
              if (finalData2 >= 50)
              {
                ...
                {
                  float enchPower = Math.max(1.0F, Math.min(104.0F, (finalData2 - 50) * 2.0F - i * 10.0F));
            ...
            Server.getInstance().broadCastAction(performer.getName() + " looks pleased as they hold up a completed " + createdItem
              .getName() + ".", performer, 5);
            ...
            if (newTotal > totalNeeded)
            {
              ...
              target.setAuxData((byte)(int)(newTotal - totalNeeded));
        ...
        else
        {
          ...
          source.setQualityLevel(
            (source.getCurrentQualityLevel() * source.getAuxData() + target.getCurrentQualityLevel() * target.getAuxData()) / newTotal);
          ...
          if ((act.getRarity() > source.getRarity()) && 
            (Server.rand.nextInt(source.getAuxData()) == 0)) {
      ...
      else
      {
        ...
        source.setDamage((float)(source.getDamage() + -power * 0.10000000149011612D));
        target.setDamage((float)(target.getDamage() + -power * 0.10000000149011612D));
      }
      return true;
    }
    return false;
  ...
  private static boolean identifyFragment(Action act, Creature performer, Item source, Item target, short action, float counter)
  {
    ...
    if (counter == 1.0F)
    {
      ...
      time = Actions.getStandardActionTime(performer, performer.getSkills().getSkillOrLearn(10095), source, 0.0D);
      act.setTimeLeft(time);
      performer.sendActionControl(act.getActionString(), true, act.getTimeLeft());
      performer.getStatus().modifyStamina(-1000.0F);
    }
    ...
    if (counter * 10.0F > time)
    {
      ...
      boolean correctTool = source.getTemplateId() == 97;
      Skill restoration = performer.getSkills().getSkillOrLearn(10095);
      ...
      try
      {
        performer.getSkills().getSkillOrLearn(source.getPrimarySkill()).skillCheck(difficulty, 0.0D, false, correctTool ? counter : counter / 2.0F);
      }
      ...
      if (power >= 0.0F)
      {
        ...
        int newTotal = (int)Math.min(127.0D, target.getAuxData() + bonus);
        ...
        else
        {
          ...
          target.setData2((int)((target.getData2() + power) / 2.0F));
          int newWeight = (int)(target.getTemplate().getWeightGrams() - newTotal / 127.0F * (target.getTemplate().getWeightGrams() - finalFragmentWeight));
  ...
  private static boolean makeBait(Action act, Creature performer, Item tool, Item target, short action, float counter)
  {
    ...
    if ((tool.getTemplateId() != 258) && (tool.getTemplateId() != 93) && 
      (tool.getTemplateId() != 8))
    {
    ...
    if (counter == 1.0F)
    {
      ...
      time = Actions.getStandardActionTime(performer, performer.getSkills().getSkillOrLearn(10033), tool, 0.0D);
      act.setTimeLeft(time);
      performer.sendActionControl(act.getActionString(), true, act.getTimeLeft());
      performer.getStatus().modifyStamina(-1000.0F);
    }
    ...
    if (counter * 10.0F > time)
    {
      ...
      try
      {
        performer.getSkills().getSkillOrLearn(tool.getPrimarySkill()).skillCheck(difficulty, 0.0D, false, counter / 2.0F);
      }
      catch (NoSuchSkillException localNoSuchSkillException) {}
      if (act.getRarity() != 0) {
        performer.playPersonalSound("sound.fx.drumroll");
      ...
      try
      {
        ...
        int knowledge = (int)fishing.getKnowledge(0.0D);
        if (knowledge < ql) {
        ...
        {
          float power = (float)fishing.skillCheck(difficulty, tool, 0.0D, false, counter / 10.0F);
        ...
        performer.getCommunicator().sendNormalServerMessage("You make " + count + " " + "fish bits" + " from the " + target
          .getName() + ".");
        Server.getInstance().broadCastAction(performer
          .getName() + " makes some " + "fish bits" + " from a " + target.getName() + ".", performer, 5);
  ...
  private static boolean makeBait(Action act, Creature performer, Item target, short action, float counter)
  {
    ...
    if (counter == 1.0F)
    {
      performer.getCommunicator().sendNormalServerMessage("You start making bait from the " + target.getName() + ".");
      Server.getInstance().broadCastAction(performer.getName() + " starts making bait from " + target.getName() + ".", performer, 5);
      time = Actions.getStandardActionTime(performer, performer.getSkills().getSkillOrLearn(10033), null, 0.0D);
      act.setTimeLeft(time);
      performer.sendActionControl(act.getActionString(), true, act.getTimeLeft());
      performer.getStatus().modifyStamina(-1000.0F);
    }
    ...
    if (counter * 10.0F > time)
    {
      ...
      try
      {
        ...
        int tempId = getBaitTemplateId(target);
        float extraLoss = getBaitExtraLossMultiplier(target);
        while ((count < 10) && (newWeight > 0) && (performer.getInventory().mayCreatureInsertItem()))
        {
          count++;
          float power = (float)fishing.skillCheck(difficulty, null, 0.0D, false, counter / 100.0F);
          float newql = Math.max(Math.min(ql + power / 50.0F, 100.0F), 1.0F);
          byte rarity = (byte)Math.max(act.getRarity(), target.getRarity());
          Item bait = ItemFactory.createItem(tempId, newql, rarity, null);
          performer.getInventory().insertItem(bait);
          ...
          newWeight = (int)(newWeight - bait.getWeightGrams() * extraLoss);
        }
        target.setWeight(newWeight, true);
        performer.getCommunicator().sendNormalServerMessage("You make " + count + " " + baitName + " from a " + target
          .getName() + ".");
        Server.getInstance().broadCastAction(performer
          .getName() + " makes some " + baitName + " from a " + target.getName() + ".", performer, 5);
      }
      catch (NoSuchTemplateException nst)
      {
        logger.log(Level.WARNING, "No template for 1364", nst);
    ...
    if (counter * 10.0F > time)
    {
      ...
      try
      {
        ...
        while ((count < 10) && (newWeight > 0) && (performer.getInventory().mayCreatureInsertItem()))
        {
          ...
          float newql = Math.max(Math.min(ql + power / 50.0F, 100.0F), 1.0F);
          byte rarity = (byte)Math.max(act.getRarity(), target.getRarity());
          Item moss = ItemFactory.createItem(1354, newql, rarity, null);
        ...
        target.setWeight(newWeight, true);
        performer.getCommunicator().sendNormalServerMessage("You make " + count + " " + "small piece of moss" + " from the " + target
          .getName() + ".");
        Server.getInstance().broadCastAction(performer
          .getName() + " makes some " + "small piece of moss" + " from a " + target.getName() + ".", performer, 5);
      }
      catch (NoSuchTemplateException nst)
      {
  ...
  private static boolean convertFishingEquipment(Creature performer, Item target)
  {
    ...
    {
    case 94: 
      return convertFishingEquipment(performer, target, 1344, new int[] { 1347, 1357 });
    case 152: 
      return convertFishingEquipment(performer, target, 1344, new int[] { 1347, 1356 });
    case 780: 
    ...
    case 150: 
      return convertFishingEquipment(performer, target, 1347, new int[] { 1357 });
    case 96: 
      return convertFishingEquipment(performer, target, 1356, new int[0]);
    case 151: 
      return convertFishingEquipment(performer, target, 1347, new int[] { 1356 });
    }
    return true;
  }
  ...
  private static boolean convertFishingEquipment(Creature performer, Item target, int newId, int... makeIds)
  {
    ...
    {
      logger.warning(String.format("Error: Could not find template ID for converted fishing equipment: %s", new Object[] { Integer.valueOf(newId) }));
    }
    ...
    try
    {
      for (int id : makeIds)
      {
        Item newItem = ItemFactory.createItem(id, target.getQualityLevel(), (byte)0, (byte)0, target
          .getCreatorName());
  ...
  private static boolean openClam(Action act, Creature performer, Item tool, Item target, short action, float counter)
  {
    ...
    if (counter == 1.0F)
    {
      ...
      time = Actions.getVariableActionTime(performer, performer.getSkills().getSkillOrLearn(10059), tool, 0.0D, 60, 20, 2500);
  ...
  private static void getClamItem(Creature performer, Item target, Action act)
  {
    ...
    float knowledge = (float)butchering.getKnowledge(0.0D);
    ...
    case 1307: 
      ...
      if (frag == null)
      {
        performer.getCommunicator().sendNormalServerMessage("You fail to find anything in the " + target.getName() + "."); return;
      }
      break;
    }
    ...
    try
    {
      ...
      performer.getCommunicator().sendNormalServerMessage("You found " + foundItem
        .getNameWithGenus() + " in the " + target.getName() + ".");
      Server.getInstance().broadCastAction(performer
        .getName() + " found something in a " + target.getName() + ".", performer, 5);
    }
    catch (FailedException e)
    {
      logger.log(Level.WARNING, e.getMessage(), e);
  ...
  private static boolean moveBulkItemAsAction(Action act, Creature performer, Item source, Item target, float counter)
  {
    ...
    if (target.isLocked())
    {
      ...
      {
        performer.getCommunicator().sendNormalServerMessage("You're not allowed to put things into this " + target
          .getName() + ".");
        return true;
      }
    }
    ...
    if ((MethodsItems.checkIfStealing(source, performer, act)) || 
      (MethodsItems.checkIfStealing(moveTargetContainer, performer, act)))
    {
    ...
    if (!done)
    {
      ...
      int maxMayFit = moveTargetContainer.isCrate() ? moveTargetContainer.getRemainingCrateSpace() : moveTargetContainer.getFreeVolume() / sourceTemplate.getVolume();
      int remainingItems = (int)Math.ceil(source.getBulkNumsFloat(false));
      ...
      else
      {
        ...
        {
          int amountToTransfer;
          if ((maxMayFit < amountMayCarry) && (maxMayFit <= playerAmountToTransfer))
          {
            amountToTransfer = maxMayFit;
          }
          else
          {
            ...
            {
              int amountToTransfer;
              if (playerAmountToTransfer < amountMayCarry) {
                amountToTransfer = playerAmountToTransfer;
              } else {
        ...
        (!moveTargetContainer.isCrate()) && (moveTargetContainer.getFreeVolume() < sourceTemplate.getWeightGrams())))
      {
        if (Servers.localServer.testServer)
        {
          ...
          {
            String s1 = String.format("%,d", new Object[] { Integer.valueOf(source.getWeightGrams()) });
            String m1 = String.format("%,d", new Object[] { Integer.valueOf(moveTargetContainer.getFreeVolume()) });
      ...
      if (act.justTickedSecond())
      {
          ...
          (moveTargetContainer.isBulkContainer()) && (moveTargetContainer.getFreeVolume() >= totalVolume)))
        {
          if (moveTargetItem != null)
          {
            ...
            float targetQL = moveTargetItem.getQualityLevel();
            float targetAmountItems = moveTargetItem.getBulkNumsFloat(false);
              ...
              try
              {
                if (amountToTransfer == 1)
                {
                  ...
                  if (source.usesFoodState())
                  {
                    ...
                    if (imd != null) {
                      ItemMealData.save(source.getWurmId(), imd.getRecipeId(), imd.getCalories(), imd.getCarbs(), imd.getFats(), imd
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\behaviours\ItemBehaviour.class
