  ...
  implements MiscConstants
{
  static List<ActionEntry> getBehavioursFor(Creature performer)
  {
    ...
    if (Features.Feature.WAGONER.isEnabled()) {
      alist.add(Actions.actionEntrys['Δ']);
    }
    alist.add(Actions.actionEntrys['ʕ']);
    alist.add(new ActionEntry((short)667, "Gates", "managing"));
    alist.add(new ActionEntry((short)364, "MineDoors", "managing"));
    alist.add(Actions.actionEntrys['ȶ']);
    alist.add(Actions.actionEntrys['ʲ']);
    ...
    if ((Features.Feature.WAGONER.isEnabled()) && (Creatures.getManagedWagonersFor((Player)performer, -1).length > 0)) {
      alist.add(Actions.actionEntrys['͟']);
    }
  ...
  static boolean action(Action act, Creature performer, short action, float counter)
  {
    ...
    if ((village != null) && (action == 67))
    {
      if (village.isActionAllowed((short)67, performer)) {
        ...
        performer.getCommunicator().sendNormalServerMessage("You may not manage guards for " + village
          .getName() + ".");
      }
      return true;
    }
    if ((village != null) && (action == 68))
    {
      if (village.isActionAllowed((short)68, performer)) {
        ...
        performer.getCommunicator().sendNormalServerMessage("You may not manage settings for " + village
          .getName() + ".");
      }
      return true;
    }
    if ((village != null) && (action == 540))
    {
      if (village.isActionAllowed((short)540, performer)) {
        ...
        performer.getCommunicator().sendNormalServerMessage("You may not manage roles for " + village
          .getName() + ".");
      }
      return true;
    }
    if ((village != null) && (action == 66))
    {
      if (village.isActionAllowed((short)66, performer)) {
        ...
        performer.getCommunicator().sendNormalServerMessage("You may not manage citizens for " + village
          .getName() + ".");
      }
      return true;
    }
    if ((village != null) && (action == 69))
    {
      ...
      if (village.isActionAllowed((short)69, performer)) {
        ...
        performer.getCommunicator().sendNormalServerMessage("You may not manage reputations for " + village
          .getName() + ".");
      }
      return true;
    }
    if ((village != null) && (action == 70))
    {
      ...
      if (village.isActionAllowed((short)70, performer)) {
        ...
        performer.getCommunicator().sendNormalServerMessage("You may not manage gates for " + village
          .getName() + ".");
      }
      return true;
    }
    if ((village != null) && (action == 76))
    {
      if (village.isActionAllowed((short)76, performer)) {
        ...
        performer.getCommunicator().sendNormalServerMessage("You may not resize the settlement " + village
          .getName() + ".");
      }
      return true;
    }
    if ((village != null) && (action == 481))
    {
      ...
      if (village.isActionAllowed((short)481, performer)) {
        ...
        performer.getCommunicator().sendNormalServerMessage("You may not configure twitter for " + village
          .getName() + ".");
      }
      return true;
    }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\behaviours\ManageMenu.class
