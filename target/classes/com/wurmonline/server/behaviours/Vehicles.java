  ...
  implements ProtoConstants, CreatureTemplateIds
{
  ...
  public static Vehicle getVehicle(Item item)
  {
    ...
    {
      toReturn = (Vehicle)vehicles.get(Long.valueOf(item.getWurmId()));
      if (toReturn == null) {
  ...
  public static Vehicle getVehicle(Creature creature)
  {
    ...
    {
      toReturn = (Vehicle)vehicles.get(Long.valueOf(creature.getWurmId()));
      if (toReturn == null) {
  ...
  {
    return (Vehicle)vehicles.get(Long.valueOf(id));
  }
  ...
  public static Vehicle createVehicle(Item item)
  {
    ...
    vehicles.put(Long.valueOf(item.getWurmId()), vehic);
    return vehic;
  }
  ...
  public static Vehicle createVehicle(Creature creature)
  {
    ...
    vehicles.put(Long.valueOf(creature.getWurmId()), vehic);
    return vehic;
  }
  ...
  static void setSettingsForVehicle(Item item, Vehicle vehicle)
  {
    ...
    else if (item.getTemplateId() == 850)
    {
      ...
      hitches[0] = new Seat(2);
      hitches[1] = new Seat(2);
      hitches[2] = new Seat(2);
      hitches[3] = new Seat(2);
      hitches[0].offx = -2.0F;
      hitches[0].offy = -1.0F;
      hitches[1].offx = -2.0F;
      hitches[1].offy = 1.0F;
    ...
    else if ((item.getTemplateId() == 263) || 
      (item.getTemplateId() == 265))
    {
      vehicle.createOnlyPassengerSeats(1);
    ...
    else if ((item.getTemplateId() == 404) || 
      (item.getTemplateId() == 891) || 
      (item.getTemplateId() == 924))
    {
      ...
      (item.getTemplateId() == 913) || 
      (item.getTemplateId() == 914) || 
      (item.getTemplateId() == 915))
    {
      vehicle.createOnlyPassengerSeats(1);
      vehicle.setChair(true);
    ...
    else if ((item.getTemplateId() == 1313) || 
      (item.getTemplateId() == 484) || 
      (item.getTemplateId() == 890))
    {
      vehicle.createOnlyPassengerSeats(1);
      vehicle.setBed(true);
  ...
  {
    Vehicle vehicle = (Vehicle)vehicles.get(Long.valueOf(id));
    if (vehicle != null)
    {
      vehicle.kickAll();
    ...
    vehicles.remove(Long.valueOf(id));
  ...
  {
    for (Vehicle draggedVehicle : (Vehicle[])vehicles.values().toArray(new Vehicle[vehicles.size()])) {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\behaviours\Vehicles.class
