  ...
  implements MiscConstants
{
  ...
  public static boolean showFishTable(Creature performer, Item source, int tileX, int tileY, float counter, Action act)
  {
    ...
    {
      MethodsFishing.FishRow localFishRow1;
      MethodsFishing.FishRow fishChance;
      if ((act.justTickedSecond()) && (act.getSecond() == 15))
      {
        ...
        MethodsFishing.FishRow[] arrayOfFishRow1 = fishChances;int i = arrayOfFishRow1.length;
      ...
      else if ((act.justTickedSecond()) && (act.getSecond() == 25))
      {
        ...
        MethodsFishing.FishRow[] arrayOfFishRow2 = fishChances;localFishRow1 = arrayOfFishRow2.length;
        for (fishChance = 0; fishChance < localFishRow1; fishChance++)
        {
          MethodsFishing.FishRow fishChance = arrayOfFishRow2[fishChance];
          if (!FishEnums.FishData.fromName(fishChance.getName()).isSpecialFish())
          {
            float chance = fishChance.getChance();
            if (chance > 0.0F)
        ...
        else
        {
          ...
          for (int i = 0; i < ((ArrayList)otherChances).size(); i++)
          {
            ...
            allOthers = allOthers + ((MethodsFishing.FishRow)((ArrayList)otherChances).get(i)).getName();
          }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\behaviours\MethodsFishing.class
