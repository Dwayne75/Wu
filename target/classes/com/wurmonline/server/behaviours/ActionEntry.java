  ...
  implements ActionTypes, MiscConstants, Comparable<ActionEntry>
{
  ...
  {
    if ((this.usesNewSkillSystem) && ((this.isVerifiedNewSystem) || (Features.Feature.NEW_SKILL_SYSTEM.isEnabled()))) {
      return true;
    }
    return false;
  }
  ...
  public boolean isAllowed(Creature creature)
  {
    if (creature.getDeity() != null)
    {
      ...
      {
        if ((creature.isOnSurface()) && (isAllowVynoraOnSurface())) {
          return true;
        }
        if (isAllowVynora()) {
          return true;
      ...
      {
        if ((!creature.isOnSurface()) && (isAllowMagranonInCave())) {
          return true;
        }
        if (isAllowMagranon()) {
          return true;
      ...
      {
        if ((creature.isOnSurface()) && (isAllowFoOnSurface())) {
          return true;
        }
        if (isAllowFo()) {
          return true;
      ...
      {
        if ((!creature.isOnSurface()) && (isAllowLibilaInCave())) {
          return true;
        }
        if (isAllowLibila()) {
          return true;
  ...
  {
    return getActionString().compareTo(aActionEntry.getActionString());
  }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\behaviours\ActionEntry.class
