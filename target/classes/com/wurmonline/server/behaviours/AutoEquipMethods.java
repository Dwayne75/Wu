...
public final class AutoEquipMethods
{
  ...
  public static final boolean autoEquip(Item item, Creature player, short action, Action act, boolean performGuardCheck)
  {
    ...
    switch (AutoEquipMethods.1.$SwitchMap$com$wurmonline$server$behaviours$TakeResultEnum[result.ordinal()])
    {
    case 1: 
    case 2: 
    case 3: 
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\behaviours\AutoEquipMethods.class
