  ...
  extends TileBehaviour
{
  ...
  public List<ActionEntry> getBehavioursFor(Creature performer, Item source, boolean onSurface, Floor floor)
  {
    ...
    {
      switch (FloorBehaviour.1.$SwitchMap$com$wurmonline$shared$constants$StructureConstants$FloorState[floor.getFloorState().ordinal()])
      {
      case 1: 
  ...
  {
    switch (FloorBehaviour.1.$SwitchMap$com$wurmonline$shared$constants$StructureConstants$FloorMaterial[material.ordinal()])
    {
    case 1: 
      return 1005;
    case 2: 
  ...
  {
    switch (FloorBehaviour.1.$SwitchMap$com$wurmonline$shared$constants$StructureConstants$FloorMaterial[floorMaterial.ordinal()])
    {
    case 1: 
    case 14: 
      return 5.0F;
  ...
  private static final String getMaterialDescription(Floor floor)
  {
    if (floor.getType() == StructureConstants.FloorType.ROOF)
    {
      switch (FloorBehaviour.1.$SwitchMap$com$wurmonline$shared$constants$StructureConstants$FloorMaterial[floor.getMaterial().ordinal()])
      {
      case 2: 
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\behaviours\FloorBehaviour.class
