  ...
  implements MiscConstants
{
  ...
  {
    if (num == 1) {
      return action(action, performer, planetId, num, counter);
    }
    if (num == 118)
    {
      boolean done = false;
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\behaviours\PlanetBehaviour.class
