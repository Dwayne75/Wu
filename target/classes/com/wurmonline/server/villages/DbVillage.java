  ...
  extends Village
{
  ...
  DbVillage(int aStartX, int aEndX, int aStartY, int aEndY, String aName, Creature aFounder, long aDeedid, boolean aSurfaced, boolean aDemocracy, String aDevise, boolean aPermanent, byte aSpawnKingdom, int initialPerimeter)
  ...
  void loadVillageRecruitees()
  {
    ...
    try
    {
      ...
      while (rs.next())
      {
        ...
        addVillageRecruitee(new VillageRecruitee(getId(), pid, sName));
      }
    }
    catch (SQLException sqx)
    {
      logger.log(Level.WARNING, "Problem loading all village recruitees for village: " + getId() + " - " + sqx.getMessage(), sqx);
    }
    finally
    {
      DbUtilities.closeDatabaseObjects(ps, rs);
  ...
  void deleteRecruitee(VillageRecruitee vr)
  {
    ...
    {
      logger.log(Level.WARNING, "Problem deleting from recruitees: " + getId() + " - " + sqx.getMessage(), sqx);
    }
    finally
    {
  ...
  void loadVillageMapAnnotations()
  {
    ...
    try
    {
      ...
      while (rs.next())
      {
        ...
        addVillageMapAnnotation(new MapAnnotation(wid, sName, type, position, ownerId, server, icon), false);
      }
    }
    catch (SQLException sqx)
    {
      logger.log(Level.WARNING, "Problem loading all village POI's for village: " + getId() + " - " + sqx.getMessage(), sqx);
    }
    finally
    {
      DbUtilities.closeDatabaseObjects(ps, rs);
      ...
      while (rs.next())
      {
        ...
        if (WurmId.getType(wurmid) == 0) {
          try
          {
            ...
            citizen = new DbCitizen(wurmid, n, getRole(roleid), votedate, votedfor);
          }
          ...
          try
          {
            ...
            citizen = new DbCitizen(wurmid, c.getName(), getRole(roleid), votedate, votedfor);
  ...
  public void setMayor(String aName)
    throws IOException
  {
    if (!this.mayorName.equals(aName))
    {
      ...
      {
        logger.log(Level.WARNING, getName() + " this village doesn't have the correct roles: " + nsr.getMessage(), nsr);
      }
    }
  }
  
  public void setMotto(String devise)
    throws IOException
  {
  ...
  public void setVillageRep(int newRep)
  {
    if ((Servers.localServer.HOMESERVER) && (Servers.localServer.EPIC)) {
      if ((newRep != this.villageReputation) && (newRep <= 150))
      {
        ...
        this.group.sendMessage(getRepMessage(toSend));
        if (twitChat()) {
          twit(toSend);
        }
      }
  ...
  public void setDemocracy(boolean aDemocracy)
    throws IOException
  {
  ...
  void loadRoles()
  {
    ...
    try
    {
      ...
      while (rs.next())
      {
        ...
        if (insert) {
          this.roles.put(Integer.valueOf(roleid), role);
        }
      }
      try
      {
  ...
  public void setDisbander(long disb)
    throws IOException
  {
  ...
  public void setAcceptsMerchants(boolean accepts)
    throws IOException
  {
  ...
  public void setAllowsAggroCreatures(boolean allows)
    throws IOException
  {
  ...
  public void setUnlimitedCitizens(boolean accepts)
    throws IOException
  {
  ...
  public void setKingdom(byte newkingdom)
    throws IOException
  {
    setKingdom(newkingdom, true);
  }
  
  public void setKingdom(byte newkingdom, boolean updateTimeStamp)
    throws IOException
  {
    if (this.kingdom != newkingdom)
    {
      ...
      convertOfflineCitizensToKingdom(newkingdom, updateTimeStamp);
      Connection dbcon = null;
      PreparedStatement ps = null;
      try
      {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\villages\DbVillage.class
