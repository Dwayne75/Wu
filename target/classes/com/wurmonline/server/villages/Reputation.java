  ...
  implements MiscConstants, Comparable<Reputation>
{
  ...
  public int compareTo(Reputation otherReputation)
  {
    try
    {
      return getNameFor().compareTo(otherReputation.getNameFor());
    }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\villages\Reputation.class
