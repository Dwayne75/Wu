...
public final class CoordUtils
{
  ...
  {
    return new Vector2f(TileToWorldTileCenter(tilePos.x), 
      TileToWorldTileCenter(tilePos.y));
  }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\utils\CoordUtils.class
