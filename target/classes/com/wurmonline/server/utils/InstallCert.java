...
public final class InstallCert
{
    ...
    throws Exception
  {
    ...
    catch (SSLException e)
    {
      ...
      X509Certificate[] chain = InstallCert.SavingTrustManager.access$000(tm);
      if (chain == null)
      {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\utils\InstallCert.class
