  ...
  implements MiscConstants, ProtoConstants, TimeConstants
{
  ...
  {
    this(aQuestionId, aQuestionTitle, aQuestionText, aOption1Text, aOption2Text, aOption3Text, aOption4Text, aAllowMultiple, aPremOnly, aJK, aMR, aHoTs, aFreedom, voteStart, voteEnd, (byte)1, (short)0, false, (short)0, (short)0, (short)0, (short)0, "", (byte)0, new ArrayList(), false);
  }
  ...
  {
    this(aQuestionId, aQuestionTitle, aQuestionText, aOption1Text, aOption2Text, aOption3Text, aOption4Text, aAllowMultiple, aPremOnly, aJK, aMR, aHoTs, aFreedom, voteStart, voteEnd, aSent, aVoteCount, aHasSummary, aOption1Count, aOption2Count, aOption3Count, aOption4Count, aTrelloCardId, theArchiveState, new ArrayList(), true);
  }
  ...
  public boolean canVote(Player player)
  {
    ...
    if ((this.freedom) && (player.getKingdomTemplateId() == 4)) {
      return true;
    }
    return false;
  }
  ...
  public boolean isActive()
  {
    ...
    return (this.start < System.currentTimeMillis()) && 
      (this.end > System.currentTimeMillis()) && (this.sent == 2);
  }
  ...
  public String toString()
  {
    return 
      ...
      "VoteQuestion [id=" + this.questionId + ", title=\"" + this.questionTitle + ", text=\"" + this.questionText + "\", opt1=\"" + this.option1Text + "\", opt2=\"" + this.option2Text + "\"" + (this.option3Text.length() > 0 ? ", opt3=\"" + this.option3Text + "\"" : "") + (this.option4Text.length() > 0 ? ", opt4=\"" + this.option4Text + "\"" : "") + "]";
  }
}


/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\support\VoteQuestion.class
