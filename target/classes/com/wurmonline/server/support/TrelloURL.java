...
public final class TrelloURL
{
  ...
  public String build()
  {
    ...
    return 
      ...
      createUrlWithPathParams() + createAuthQueryString() + createFilterQuery();
  }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\support\TrelloURL.class
