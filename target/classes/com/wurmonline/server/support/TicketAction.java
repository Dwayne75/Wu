  ...
  implements MiscConstants
{
  ...
  {
    return (this.generalFlags & 0x1) != 0;
  }
  
  public boolean wasGeneralNoUnderstand()
  {
    return (this.generalFlags & 0x2) != 0;
  }
  
  public boolean wasGeneralUnclear()
  {
    return (this.generalFlags & 0x4) != 0;
  }
  
  public boolean wasGeneralNoSolve()
  {
    return (this.generalFlags & 0x8) != 0;
  }
  ...
  {
    return (this.qualitiesFlags & 0x1) != 0;
  }
  
  public boolean wasQualityEnthusiastic()
  {
    return (this.qualitiesFlags & 0x2) != 0;
  }
  
  public boolean wasQualityListened()
  {
    return (this.qualitiesFlags & 0x4) != 0;
  }
  
  public boolean wasQualityFriendly()
  {
    return (this.qualitiesFlags & 0x8) != 0;
  }
  ...
  {
    return (this.irkedFlags & 0x1) != 0;
  }
  
  public boolean wasIrkedEnthusiastic()
  {
    return (this.irkedFlags & 0x2) != 0;
  }
  
  public boolean wasIrkedListened()
  {
    return (this.irkedFlags & 0x4) != 0;
  }
  
  public boolean wasIrkedFriendly()
  {
    return (this.irkedFlags & 0x8) != 0;
  }
  ...
  {
    return Tickets.convertTime(this.date) + " " + getActionAsString(player);
  }
  ...
  public boolean isActionShownTo(Player player)
  {
    ...
    {
      if ((this.action != 0) || (this.visibilityLevel == 1) || (this.visibilityLevel == 0)) {
        return true;
      }
      return false;
    }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\support\TicketAction.class
