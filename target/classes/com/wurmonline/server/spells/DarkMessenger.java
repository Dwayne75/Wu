  ...
  extends ReligiousSpell
{
  ...
  void doEffect(Skill castSkill, double power, Creature performer, Item target)
  {
    ...
    if (eff == null)
    {
      performer.getCommunicator().sendNormalServerMessage("You summon some small demoniacs into the " + target
        .getName() + ".", (byte)2);
      ...
      Server.getInstance().broadCastAction(performer
        .getName() + " looks pleased as " + performer.getHeSheItString() + " summons small demoniacs that disappear into the " + target
        .getName() + ".", performer, 5);
    ...
    {
      performer.getCommunicator().sendNormalServerMessage("You frown as you fail to summon more demoniacs into the " + target
        .getName() + ".", (byte)3);
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\spells\DarkMessenger.class
