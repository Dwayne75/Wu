            ...
            if (ring == null)
            {
              ...
              for (Creature lCret : crets)
              {
                if ((!lCret.isInvulnerable()) && (lCret.getAttitude(performer) == 2))
                {
                  ...
                  double damage = calculateDamage(lCret, power, 6000.0D, 40.0D);
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\spells\PainRain.class
