  ...
  extends KarmaSpell
{
  ...
  void doEffect(Skill castSkill, double power, Creature performer, int tilex, int tiley, int layer, int heightOffset, Tiles.TileBorderDirection dir)
  {
    ...
    try
    {
      ...
      Fence fence = new DbFence(StructureConstantsEnum.FENCE_MAGIC_FIRE, tilex, tiley, heightOffset, (float)(1.0D + power / 5.0D), dir, zone.getId(), layer);
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\spells\WallOfFire.class
