  ...
  extends KarmaEnchantment
{
  ...
  void doEffect(Skill castSkill, double power, Creature performer, Creature target)
  {
    ...
    int duration = (int)(900.0D + 1800.0D * (power / 100.0D));
    if (eff == null)
    {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\spells\Continuum.class
