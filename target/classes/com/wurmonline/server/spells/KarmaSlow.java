  ...
  extends KarmaEnchantment
{
  ...
  void doEffect(Skill castSkill, double power, Creature performer, Creature target)
  {
    ...
    int duration = (int)(30.0D + 270.0D * (power / 100.0D));
    if (eff == null)
    {
      if (target != performer) {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\spells\KarmaSlow.class
