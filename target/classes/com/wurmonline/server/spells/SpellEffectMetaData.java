  ...
  implements MiscConstants, CounterTypes
{
  ...
  public SpellEffectMetaData(long aWurmid, long aOwner, byte aType, float aPower, int aTimeleft, boolean aAddToTables)
  {
    ...
    this.id = aWurmid;
    if (aAddToTables) {
      if ((WurmId.getType(aOwner) == 2) || (WurmId.getType(aOwner) == 19) || 
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\spells\SpellEffectMetaData.class
