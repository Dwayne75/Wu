  ...
  extends ReligiousSpell
{
  ...
  void doEffect(Skill castSkill, double power, Creature performer, Wound target)
  {
    ...
    double toHeal = 3275.0D;
    toHeal += 9825.0D * (power / 100.0D);
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\spells\FocusedWill.class
