  ...
  extends ReligiousSpell
{
  ...
  void doEffect(Skill castSkill, double power, Creature performer, Wound target)
  {
    ...
    else if ((tCret.isPlayer()) && (tCret != performer))
    {
    ...
    if (doeff)
    {
      ...
      double toHeal = 19650.0D;
      toHeal += 19650.0D * (power / 300.0D);
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\spells\CureMedium.class
