  ...
  implements MiscConstants
{
  ...
  {
    return (Set)batchTransfers.get(Long.valueOf(id));
  }
  ...
  public boolean poll()
  {
    ...
    if ((this.client != null) && (!this.done))
    {
      ...
      if ((this.client.loggedIn) && (!this.done)) {
        if (!this.sentTransfer) {
          try
          {
          ...
          {
            logger2.log(Level.WARNING, "Problem calling IntraClient.executeMoneyUpdate() for " + this + " due to " + iox
              .getMessage(), iox);
            this.done = true;
          }
        }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\intra\MoneyTransfer.class
