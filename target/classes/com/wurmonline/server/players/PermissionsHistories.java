...
public class PermissionsHistories
{
  ...
  {
    Long id = Long.valueOf(fromId);
    if (objectHistories.containsKey(id))
    {
      PermissionsHistory oldHistories = (PermissionsHistory)objectHistories.get(id);
  ...
  public static PermissionsHistory getPermissionsHistoryFor(long objectId)
  {
    ...
    if (objectHistories.containsKey(id)) {
      return (PermissionsHistory)objectHistories.get(id);
    }
  ...
  public String[] getHistory(long objectId, int numevents)
  {
    ...
    if (objectHistories.containsKey(id))
    {
      PermissionsHistory ph = (PermissionsHistory)objectHistories.get(id);
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\players\PermissionsHistories.class
