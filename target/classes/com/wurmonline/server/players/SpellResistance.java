  ...
  public final boolean tickSecond(Communicator comm)
  {
    if (this.currentSecond++ == 7)
    {
      ...
      if (this.currentResistance <= 0.0F)
      {
        ...
        sendUpdateToClient(comm, (byte)0);
        return true;
      }
      sendUpdateToClient(comm, (byte)2);
    }
    return false;
  }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\players\SpellResistance.class
