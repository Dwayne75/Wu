  ...
  implements TimeConstants
{
  ...
  void addKill(long time, String victimname, boolean loading)
  {
    this.timesKilled += 1;
    if (!loading) {
      this.timesKilledSinceRestart += 1;
    }
  ...
  void kill(long killerId, String victimname)
  {
    ...
    addKill(System.currentTimeMillis(), victimname, false);
    if (isOverkilling())
    {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\players\PlayerKill.class
