...
public final class MapAnnotation
{
  ...
  public static final MapAnnotation createNew(long id, String _name, byte _type, long _position, long _ownerId, String _server, byte _icon)
    throws IOException
  {
  ...
  public static final MapAnnotation createNew(String _name, byte _type, long _position, long _ownerId, String _server, byte _icon)
    throws IOException
  {
    ...
    throws IOException
  {
    ...
    {
      logger.log(Level.WARNING, "Failed to delete POI: " + id + " :" + sqx
        .getMessage(), sqx);
      throw new IOException(sqx);
    }
    finally
  ...
  public static void deletePrivateAnnotationsForOwner(long ownerId)
    throws IOException
  {
    Connection dbcon = null;
    PreparedStatement ps = null;
    ...
    {
      logger.log(Level.WARNING, "Failed to delete POI's for owner: " + ownerId + " :" + sqx
        .getMessage(), sqx);
      throw new IOException(sqx);
    }
    finally
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\players\MapAnnotation.class
