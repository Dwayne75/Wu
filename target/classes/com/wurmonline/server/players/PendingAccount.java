...
public class PendingAccount
{
  ...
  public static void loadAllPendingAccounts()
    throws IOException
  {
  ...
  public static void poll()
  {
    ...
    {
      dbcon = DbConnector.getLoginDbCon();
      PendingAccount[] paddarr = (PendingAccount[])accounts.values().toArray(new PendingAccount[accounts.size()]);
  ...
  public static String[] getAccountsForEmail(String email)
  {
    ...
    for (Iterator<PendingAccount> it = accounts.values().iterator(); it.hasNext();)
    {
      PendingAccount info = (PendingAccount)it.next();
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\players\PendingAccount.class
