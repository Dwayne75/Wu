    ...
    throws IOException
  {
    ...
    try
    {
      ...
      if (this.titleArr.length > 0) {
        ...
        {
          t = Titles.Title.getTitle(this.titleArr[x]);
          if (t != null)
          {
      ...
      {
        cd = Cooldowns.getCooldownsFor(this.wurmid, true);
        for (Map.Entry<Integer, Long> ent : this.cooldowns.entrySet()) {
          cd.addCooldown(((Integer)ent.getKey()).intValue(), ((Long)ent.getValue()).longValue(), false);
        }
      }
    }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\players\PlayerMetaData.class
