  ...
  implements MonetaryConstants
{
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      if (rs.next())
      {
        ...
        if ((Servers.localServer.id == this.currentServer) || (Servers.localServer.LOGINSERVER)) {
          if (this.paymentExpireDate > 0L) {
    ...
    try
    {
      ...
      if (exists(dbcon))
      {
        ...
        else
        {
          ...
          ps.setLong(4, now);
          ps.executeUpdate();
          this.historyIPStart.put(address, Long.valueOf(now));
        }
        this.historyIPLast.put(address, Long.valueOf(now));
        if (this.historyIPStart.size() > 10)
        {
          long oldest = -1L;
          String ipAddress = "";
          for (Map.Entry<String, Long> entry : this.historyIPStart.entrySet()) {
            if ((oldest == -1L) || (((Long)entry.getValue()).longValue() < oldest))
            {
              ipAddress = (String)entry.getKey();
              oldest = ((Long)entry.getValue()).longValue();
            }
          }
          DbUtilities.closeDatabaseObjects(ps, null);
  ...
  public void setSteamId(SteamId aSteamId)
    throws IOException
  {
    Connection dbcon = null;
    PreparedStatement ps = null;
  ...
  public void setPassRetrieval(String pwQ, String pwA)
    throws IOException
  {
    Connection dbcon = null;
    PreparedStatement ps = null;
  ...
  public void setReimbursed(boolean reimb)
    throws IOException
  {
  ...
  public void setBanned(boolean ban, String reason, long expiry)
    throws IOException
  {
    this.banned = ban;
    ...
    if (this.banned)
    {
      ...
      if (v != null) {
        if (v.getMayor().wurmId == this.wurmId) {
          v.setDemocracy(true);
        }
      }
      setRank(1000);
  ...
  public void setPaymentExpire(long paymentExpire)
    throws IOException
  {
    setPaymentExpire(paymentExpire, true);
  }
  
  public void setPaymentExpire(long paymentExpire, boolean silverReturn)
    throws IOException
  {
    int numsPaying = PlayerInfoFactory.getNumberOfPayingPlayers();
    if ((getPaymentExpire() <= 0L) && (paymentExpire > System.currentTimeMillis()))
    {
      if (this.awards == null) {
    ...
    else if (Features.Feature.RETURNER_PACK_REGISTRATION.isEnabled())
    {
      ...
      if (System.currentTimeMillis() > getPaymentExpire()) {
        if (!isFlagSet(47)) {
          if (!isFlagSet(46)) {
            if (Servers.localServer.id == this.currentServer) {
              if ((getPaymentExpire() > 0L) && (getDaysPlayTime() > 14L))
              {
    ...
    if (isFlagSet(8)) {
      if (paymentExpire > this.paymentExpireDate) {
        setFlag(8, false);
      }
    }
    ...
    throws IOException
  {
    if (this.rank != Math.max(1000, r))
    {
      if ((this.realdeath > 0) && (r > this.rank)) {
        setChampionPoints((short)(getChampionPoints() + (Math.max(1000, r) - this.rank)));
      }
      if (Servers.localServer.isChallengeServer()) {
        if (Math.max(1000, r) - this.rank != 0)
        {
          ChallengeSummary.addToScore(this, ChallengePointEnum.ChallengePoint.BATTLEPOINTS.getEnumtype(), 
            Math.max(1000, r) - this.rank);
          ChallengeSummary.addToScore(this, ChallengePointEnum.ChallengePoint.OVERALL.getEnumtype(), 
            Math.max(1000, r) - this.rank);
        }
      }
  ...
  public void setFaith(float aNewFaith)
    throws IOException
  {
    ...
    if (this.faith != lFaith)
    {
      ...
      try
      {
        ...
        if (exists(dbcon))
        {
          ...
          ps.executeUpdate();
          DbUtilities.closeDatabaseObjects(ps, null);
          sendReligionStatus(2147483645, this.faith);
        }
      }
      catch (SQLException sqex)
      {
  ...
  public void setFavor(float fav)
    throws IOException
  {
    ...
    if (this.favor != lFav)
    {
      ...
      try
      {
        ...
        if (exists(dbcon))
        {
          ...
          ps.executeUpdate();
          DbUtilities.closeDatabaseObjects(ps, null);
          sendReligionStatus(2147483644, this.favor);
        }
      }
      catch (SQLException sqex)
      {
  ...
  public void setDeity(@Nullable Deity d)
    throws IOException
  {
    if (this.deity != d)
    {
  ...
  public void transferDeity(@Nullable Deity d)
    throws IOException
  {
      ...
      if (d.isHateGod() != this.deity.isHateGod())
      {
        ...
        try
        {
          ...
          if (exists(dbcon))
          {
            ...
            ps.executeUpdate();
            DbUtilities.closeDatabaseObjects(ps, null);
            sendReligionStatus(2147483642, this.alignment);
          }
        }
        catch (SQLException sqex)
        {
    ...
    throws IOException
  {
    ...
    if (this.alignment != lAlign)
    {
      ...
      if (((this.alignment == -100.0F) && (this.deity != null) && (this.deity.isHateGod())) || ((this.alignment == 100.0F) && (this.deity != null) && 
        (!this.deity.isHateGod()))) {
        try
        {
  ...
  public void setSessionKey(String key, long expiration)
    throws IOException
  {
    this.sessionKey = key;
  ...
  public void setRealDeath(byte rdcounter)
    throws IOException
  {
  ...
  public void updateFriend(long wurmid, long friend, byte catId, String note)
    throws IOException
  {
    Connection dbcon = null;
    PreparedStatement ps = null;
  ...
  public void saveFriend(long wurmid, long friend, byte catId, String note)
    throws IOException
  {
    Connection dbcon = null;
    PreparedStatement ps = null;
  ...
  public void deleteFriend(long wurmid, long friend)
    throws IOException
  {
    Connection dbcon = null;
    PreparedStatement ps = null;
  ...
  public void saveEnemy(long wurmid, long enemy)
    throws IOException
  {
    Connection dbcon = null;
    PreparedStatement ps = null;
  ...
  public void deleteEnemy(long wurmid, long enemy)
    throws IOException
  {
    Connection dbcon = null;
    PreparedStatement ps = null;
  ...
  public void loadFriends(long wurmid)
  {
    ...
    try
    {
      ...
      rs = ps.executeQuery();
      while (rs.next()) {
        addFriend(rs.getLong("FRIEND"), rs.getByte("CATEGORY"), rs.getString("NOTE"), true);
      }
    }
    catch (SQLException ex)
    {
  ...
  public void saveIgnored(long wurmid, long ignored)
    throws IOException
  {
    Connection dbcon = null;
    PreparedStatement ps = null;
  ...
  public void deleteIgnored(long wurmid, long ignored)
    throws IOException
  {
    Connection dbcon = null;
    PreparedStatement ps = null;
  ...
  public void loadIgnored(long wurmid)
  {
    ...
    try
    {
      ...
      rs = ps.executeQuery();
      while (rs.next()) {
        addIgnored(rs.getLong("IGNOREE"), true);
      }
    }
    catch (SQLException ex)
    {
  ...
  public void setNumFaith(byte aNumFaith, long aLastFaith)
    throws IOException
  {
    Connection dbcon = null;
    PreparedStatement ps = null;
    ...
    if (lNewalcohol != this.alcoholAddiction)
    {
      ...
      try
      {
        ...
        if (this.alcoholAddiction >= 10000L) {
          titleAdded = addTitle(Titles.Title.Alcoholic);
        }
        dbcon = DbConnector.getPlayerDbCon();
  ...
  public void setChangedKingdom(byte changed, boolean setTimeStamp)
    throws IOException
  {
  ...
  public void setFace(long _face)
    throws IOException
  {
    if (this.face != _face)
    {
  ...
  public void setReputation(int rep)
  {
    ...
    lNewReputation = Math.max(lNewReputation, 65236);
  ...
  public void loadHistorySteamIds(long wurmid)
  {
    ...
    try
    {
      ...
      ps = db.prepareStatement("SELECT PLAYER_ID,STEAM_ID,FIRST_USED,LAST_USED FROM STEAM_IDS WHERE PLAYER_ID=?");
      ps.setLong(1, wurmid);
      rs = ps.executeQuery();
      while (rs.next())
      {
  ...
  public void loadHistoryIPs(long wurmid)
  {
    ...
    try
    {
      ...
      while (rs.next())
      {
        this.historyIPStart.put(rs.getString("IPADDRESS"), Long.valueOf(rs.getLong("FIRSTUSED")));
        this.historyIPLast.put(rs.getString("IPADDRESS"), Long.valueOf(rs.getLong("LASTUSED")));
      }
    }
    catch (SQLException ex)
    {
  ...
  public void loadHistoryEmails(long wurmid)
  {
    ...
    try
    {
      ...
      rs = ps.executeQuery();
      while (rs.next()) {
        this.historyEmail.put(rs.getString("EMAIL_ADDRESS"), Long.valueOf(rs.getLong("DATED")));
      }
      if (this.historyEmail.isEmpty())
      {
        ...
        ps.setLong(3, now);
        ps.executeUpdate();
        this.historyEmail.put(this.emailAddress, Long.valueOf(now));
      }
    }
    catch (SQLException ex)
    {
  ...
  {
    setSleep(_sleep, true);
  }
  
  public void setSleep(int _sleep, boolean cap5h)
  {
    int lSleep = (int)Math.min(Math.max(this.sleep, cap5h ? 3600L * (isFlagSet(77) ? 6 : 5) : 36000L), _sleep);
  ...
  public boolean setChampionPoints(short points)
  {
    ...
    if ((this.championPoints != points) || ((this.realdeath > 0) && (points == 0)))
    {
      ...
      logger.log(Level.INFO, "Set CHAMPION points of " + getName() + " to " + this.championPoints);
      Connection dbcon = null;
      PreparedStatement ps = null;
      try
      {
  ...
  public static final Awards loadAward(long wurmId)
  {
    ...
    try
    {
      ...
      rs = ps.executeQuery();
      if (rs.next()) {
        return new Awards(rs.getLong("WURMID"), rs.getInt("DAYSPREM"), rs.getInt("MONTHSEVER"), rs
          .getInt("CONSECMONTHS"), rs.getInt("MONTHSPREM"), rs.getInt("SILVERSPURCHASED"), rs
          .getLong("LASTTICKEDPREM"), rs.getInt("CURRENTLOYALTY"), rs.getInt("TOTALLOYALTY"), false);
      }
    }
    catch (SQLException sqex)
    {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\players\DbPlayerInfo.class
