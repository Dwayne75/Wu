  ...
  implements MiscConstants
{
  ...
  private static void addAppointment(Appointment app)
  {
    ...
    if ((app.kingdom == 1) || (k.getTemplate() == 1)) {
      jennapps.put(Integer.valueOf(app.id), app);
    } else if ((app.kingdom == 3) || (k.getTemplate() == 3)) {
      hotsapps.put(Integer.valueOf(app.id), app);
    } else if ((app.kingdom == 2) || (k.getTemplate() == 2)) {
      molrapps.put(Integer.valueOf(app.id), app);
    } else {
      nonerapps.put(Integer.valueOf(app.id), app);
    }
  }
  ...
  public static final Appointment getAppointment(int id, byte kingdom)
  {
    ...
    if ((kingdom == 1) || (k.getTemplate() == 1)) {
      return (Appointment)jennapps.get(Integer.valueOf(id));
    }
    if ((kingdom == 3) || (k.getTemplate() == 3)) {
      return (Appointment)hotsapps.get(Integer.valueOf(id));
    }
    if ((kingdom == 2) || (k.getTemplate() == 2)) {
      return (Appointment)molrapps.get(Integer.valueOf(id));
    }
    return (Appointment)nonerapps.get(Integer.valueOf(id));
  }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\kingdom\Appointment.class
