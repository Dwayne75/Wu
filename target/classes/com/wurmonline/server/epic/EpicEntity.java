  ...
  implements MiscConstants, TimeConstants
{
  ...
  public final void createAndSaveSkills()
  {
    ...
    try
    {
      ...
      for (localIterator = this.skills.keySet().iterator(); localIterator.hasNext();)
      {
        ...
        ps.setLong(1, this.identifier);
        ps.setInt(2, skillId);
        ps.setFloat(3, ((EpicEntity.SkillVal)this.skills.get(Integer.valueOf(skillId))).getDefaultVal());
        ps.setFloat(4, ((EpicEntity.SkillVal)this.skills.get(Integer.valueOf(skillId))).getCurrentVal());
        ps.executeUpdate();
      }
    }
    catch (SQLException sqx)
  ...
  public final void updateSkills()
  {
    ...
    try
    {
      ...
      for (localIterator = this.skills.keySet().iterator(); localIterator.hasNext();)
      {
        ...
        ps.setFloat(1, ((EpicEntity.SkillVal)this.skills.get(Integer.valueOf(skillId))).getDefaultVal());
        ps.setFloat(2, ((EpicEntity.SkillVal)this.skills.get(Integer.valueOf(skillId))).getCurrentVal());
  ...
  public boolean setSkill(int skillId, float newCurrentVal)
  {
    ...
    {
      ((EpicEntity.SkillVal)this.skills.get(Integer.valueOf(skillId))).setCurrentVal(newCurrentVal);
      updateSkills();
      return true;
    }
    return false;
  ...
  public void setSkill(int skillId, float defaultVal, float currentVal)
  {
    if (!this.skills.containsKey(Integer.valueOf(skillId)))
    {
      this.skills.put(Integer.valueOf(skillId), new EpicEntity.SkillVal(this, defaultVal, currentVal));
    }
    else
    {
      EpicEntity.SkillVal existing = (EpicEntity.SkillVal)this.skills.get(Integer.valueOf(skillId));
  ...
  {
    return (EpicEntity.SkillVal)this.skills.get(Integer.valueOf(skillId));
  }
  ...
  public float getCurrentSkill(int skillId)
  {
    ...
    if (this.skills.get(Integer.valueOf(skillId)) != null) {
      return ((EpicEntity.SkillVal)this.skills.get(Integer.valueOf(skillId))).getCurrentVal();
    }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\epic\EpicEntity.class
