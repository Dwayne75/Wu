...
public class SynchedEpicEffect
{
  ...
  protected void run()
  {
    if (this.type == 1) {
      ...
      Effectuator.setEffectController(getEffectNumber(), getDeityNumber());
    }
    if (isResetKarma())
    {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\epic\SynchedEpicEffect.class
