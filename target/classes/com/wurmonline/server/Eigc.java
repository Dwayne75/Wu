  ...
  implements MiscConstants
{
  ...
  {
    HttpsURLConnection.setDefaultHostnameVerifier(new Eigc.1());
  }
  ...
  public static final void provisionAccounts(int numberToProvision, boolean overRide)
  {
    if ((Constants.isEigcEnabled) || (overRide)) {
      ...
      {
        isProvisioning = true;
        new Eigc.4(numberToProvision, overRide)
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\Eigc.class
