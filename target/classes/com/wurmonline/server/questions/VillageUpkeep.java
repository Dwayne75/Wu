    ...
    try
    {
      ...
      } else if (plan != null)
      {
        if ((village.isCitizen(getResponder())) || (getResponder().getPower() >= 2))
        {
          ...
          if ((village.isMayor(getResponder())) && (Servers.localServer.isFreeDeeds()) && (Servers.localServer.isUpkeep()) && 
      ...
      if ((money > 0L) && ((!village.isPermanent) || (getResponder().getPower() >= 2)) && 
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\questions\VillageUpkeep.class
