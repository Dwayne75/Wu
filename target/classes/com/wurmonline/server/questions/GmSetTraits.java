  ...
  extends Question
{
      ...
      if (getResponder().getPower() >= 4)
      {
        ...
        for (int x = 0; x < 64; x++)
        {
          ...
          if (is != was)
          {
            ...
            logger.log(Level.INFO, getResponder().getName() + " setting trait " + x + " " + this.creature
              .getName() + ", " + this.creature.getWurmId());
            getResponder().getLogger().log(Level.INFO, " setting trait " + x + " " + this.creature
              .getName() + ", " + this.creature.getWurmId());
        ...
        if (somethingChanged)
        {
          ...
          GmSetTraits gt = new GmSetTraits(getResponder(), this.creature);
          gt.sendQuestion();
        }
      }
    }
  ...
  public void sendQuestion()
  {
    ...
    if (getResponder().getPower() >= 4)
    {
      ...
      getResponder().getCommunicator().sendBml(250, 500, true, true, buf.toString(), 200, 200, 200, this.title);
    }
  }
}


/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\questions\GmSetTraits.class
