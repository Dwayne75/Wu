...
import com.wurmonline.server.Features.State;
  ...
  public void answer(Properties aAnswer)
  {
    ...
    if (this.type == 102) {
      if (getResponder().getPower() >= 4)
      {
        ...
        {
          FeatureManagement fm = new FeatureManagement(getResponder(), this.target);
          fm.sendQuestion();
        }
      }
    }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\questions\FeatureManagement.class
