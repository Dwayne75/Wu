  ...
  extends Question
{
  ...
  public void answer(Properties answers)
  {
    ...
    if (this.type == 149)
    {
      ...
      boolean dismiss = getBooleanProp("dismiss");
      if (dismiss) {
  ...
  public void sendQuestion()
  {
    ...
    try
    {
      ...
      buf.append("label{text=\"\"}");
      buf.append("harray{button{text=\"Dismiss\";id=\"dismiss\";hover=\"This will dismiss " + this.wagoner
      
        .getName() + "\";confirm=\"You are about to dismiss " + this.wagoner
        .getName() + ".\";question=\"Do you really want to do that?\"}label{text=\" \"};button{text=\"Close\";id=\"close\";}");
    }
    catch (NoSuchVillageException e)
    {
    ...
    getResponder().getCommunicator().sendBml(560, 460, true, true, buf.toString(), 200, 200, 200, this.title);
  }
}


/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\questions\WagonerDismissQuestion.class
