  ...
  extends Question
{
  ...
  private static final boolean sendAchievementNeeded(Creature responder, StringBuilder buf, Item conch)
  {
    ...
    if ((conch.getAuxData() == 12) || (ach.getAchievement(52) == null)) {
      return sendSeventhBml(responder, buf, 52, conch);
    }
    return false;
  }
  ...
  public void answer(Properties answers)
  {
    ...
    if (Boolean.parseBoolean(val))
    {
      ...
      ConchQuestion newq = new ConchQuestion(getResponder(), this.conch.getWurmId());
  ...
  public void sendQuestion()
  {
    ...
    {
      addBml(getResponder(), this.conch, buf);
  ...
  public void sendQuestionAfter()
  {
    ...
    } else if (this.conch != null)
    {
      if (this.conch.getAuxData() == 1) {
        sendAfterFirstBml(getResponder(), buf, this.conch);
      } else if (this.conch.getAuxData() == 3) {
        sendAfterSecondBml(getResponder(), buf, this.conch);
      } else if (this.conch.getAuxData() == 5) {
        sendAfterThirdBml(getResponder(), buf, this.conch);
      } else if (this.conch.getAuxData() == 7) {
        sendAfterFourthBml(getResponder(), buf, this.conch);
      } else if (this.conch.getAuxData() == 9) {
        sendAfterFifthBml(getResponder(), buf, this.conch);
      } else if (this.conch.getAuxData() == 11) {
        sendAfterSixthBml(getResponder(), buf, this.conch);
      } else if (this.conch.getAuxData() == 13) {
        sendAfterSeventhBml(getResponder(), buf, this.conch);
      } else if (this.conch.getAuxData() == 15) {
        addFinalBml(getResponder(), buf, this.conch);
      } else {
  ...
  {
    if (!sendItemNeeded(responder, buf, conch)) {
      if (!sendAchievementNeeded(responder, buf, conch))
      {
        Achievements ach = Achievements.getAchievementObject(responder.getWurmId());
  ...
  public final void sendAfterFirstBml(Creature responder, StringBuilder buf, Item conch)
  {
    ...
    Item item = getItemToSend(conch.getData1());
    if (item == null)
    {
  ...
  public final void sendSignalToItemTemplate(Item item)
  {
    ...
    {
      Player presp = (Player)getResponder();
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\questions\ConchQuestion.class
