  ...
  public void sendQuestion()
  {
    ...
    if ((this.type == 2) && (this.liquid != null))
    {
      ...
      if (this.liquid.getTemplateId() == 753) {
        ...
        buf.append("color=\"" + WurmColor.getColorRed(this.liquid.color) + "," + 
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\questions\TextInputQuestion.class
