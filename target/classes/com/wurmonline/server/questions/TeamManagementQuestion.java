  ...
  public void sendQuestion()
  {
    ...
    if (this.sendToResponder)
    {
      if (this.managing)
      {
        ...
        Arrays.sort(members, new TeamManagementQuestion.1(this));
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\questions\TeamManagementQuestion.class
