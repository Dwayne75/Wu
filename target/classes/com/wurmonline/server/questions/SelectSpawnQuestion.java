    ...
    try
    {
      ...
      if (Servers.localServer.HOMESERVER) {
        ...
        try
        {
          ...
          Kingdom k = (Kingdom)getAvailKingdoms().get(index);
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\questions\SelectSpawnQuestion.class
