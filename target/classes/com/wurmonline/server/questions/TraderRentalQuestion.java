  ...
  extends Question
{
  ...
  {
    boolean citiz = false;
    Village v = getResponder().getCurrentTile().getVillage();
    if (v != null) {
      citiz = true;
    }
    ...
    getResponder().getCommunicator().sendBml(500, 660, true, true, buf.toString(), 200, 200, 200, this.title);
  }
}


/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\questions\TraderRentalQuestion.class
