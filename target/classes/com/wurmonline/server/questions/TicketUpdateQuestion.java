  ...
  extends Question
{
  ...
  public void answer(Properties aAnswer)
  {
    ...
    if (this.type == 108)
    {
      ...
      {
      case 588: 
        ticket.addNewTicketAction((byte)1, getResponder().getName(), note, level);
        break;
      case 596: 
        ticket.addNewTicketAction((byte)13, getResponder().getName(), note, level);
        break;
      case 591: 
        ticket.addNewTicketAction((byte)6, getResponder().getName(), note, level);
        break;
      case 592: 
        ticket.addNewTicketAction((byte)7, getResponder().getName(), note, level);
        break;
      case 593: 
        ticket.addNewTicketAction((byte)8, getResponder().getName(), note, level);
        break;
      case 594: 
        ticket.addNewTicketAction((byte)10, getResponder().getName(), note, level);
        break;
      case 590: 
        ticket.addNewTicketAction((byte)9, getResponder().getName(), note, level);
        break;
      case 599: 
        ticket.addNewTicketAction((byte)15, getResponder().getName(), note, level);
        break;
      case 587: 
        if (note.length() > 0) {
          ticket.addNewTicketAction((byte)0, getResponder().getName(), note, level);
        }
        break;
      case 597: 
        if (!ticket.hasFeedback())
        {
          ...
          ticket.addNewTicketAction((byte)14, getResponder().getName(), note, level, service, courteous, knowledgeable, general, quality, irked);
        }
        break;
      }
    }
  ...
  public void sendQuestion()
  {
    ...
    if ((player.getWurmId() == ticket.getPlayerId()) && (this.action != 591))
    {
      ...
      else if (this.action == 597)
      {
        ...
        if (ticket.hasFeedback())
        {
          showReadOnlyFeedback(ticket, buf);
        }
        else
        {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\questions\TicketUpdateQuestion.class
