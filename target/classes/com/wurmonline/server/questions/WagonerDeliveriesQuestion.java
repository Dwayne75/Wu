  ...
  extends Question
{
  ...
  public void sendQuestion()
  {
    ...
    {
    case 7: 
      Arrays.sort(deliveries, new WagonerDeliveriesQuestion.1(this, upDown));
      
      break;
    case 2: 
      Arrays.sort(deliveries, new WagonerDeliveriesQuestion.2(this, upDown));
      
      break;
    case 3: 
      Arrays.sort(deliveries, new WagonerDeliveriesQuestion.3(this, upDown));
      
      break;
    case 4: 
      Arrays.sort(deliveries, new WagonerDeliveriesQuestion.4(this, upDown));
      
      break;
    case 5: 
      Arrays.sort(deliveries, new WagonerDeliveriesQuestion.5(this, upDown));
      
      break;
    case 6: 
      Arrays.sort(deliveries, new WagonerDeliveriesQuestion.6(this, upDown));
      
      break;
    case 1: 
      Arrays.sort(deliveries, new WagonerDeliveriesQuestion.7(this, upDown));
    }
      ...
      for (Creature creature : creatureSet)
      {
        ...
        if (wagoner != null)
        {
          ...
          if (dist != 99999.0F)
          {
            ...
            wagonerSet.add(new WagonerDeliveriesQuestion.Distanced(this, wagoner, isPublic, villName, dist));
          }
        }
      }
    }
    WagonerDeliveriesQuestion.Distanced[] wagonerArr = (WagonerDeliveriesQuestion.Distanced[])wagonerSet.toArray(new WagonerDeliveriesQuestion.Distanced[wagonerSet.size()]);
    int absSortBy = Math.abs(this.sortBy);
    int upDown = Integer.signum(this.sortBy);
    switch (absSortBy)
    {
    case 1: 
      Arrays.sort(wagonerArr, new WagonerDeliveriesQuestion.8(this, upDown));
      
      break;
    case 2: 
      Arrays.sort(wagonerArr, new WagonerDeliveriesQuestion.9(this, upDown));
      
      break;
    case 3: 
      Arrays.sort(wagonerArr, new WagonerDeliveriesQuestion.10(this, upDown));
      
      break;
    case 4: 
      Arrays.sort(wagonerArr, new WagonerDeliveriesQuestion.11(this, upDown));
      
      break;
    case 5: 
      Arrays.sort(wagonerArr, new WagonerDeliveriesQuestion.12(this, upDown));
      
      break;
    case 6: 
      Arrays.sort(wagonerArr, new WagonerDeliveriesQuestion.13(this, upDown));
    }
    int height = 300;
    StringBuilder buf = new StringBuilder();
    buf.append(getBmlHeader());
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\questions\WagonerDeliveriesQuestion.class
