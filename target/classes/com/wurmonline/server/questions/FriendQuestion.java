  ...
  extends Question
{
  ...
  public void sendQuestion()
  {
    try
    {
      ...
      buf.append("text{text='This will mean " + sender.getHeSheItString() + " will see you log on and off, and be able to allow you into structures " + sender
        .getHeSheItString() + " controls.'}");
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\questions\FriendQuestion.class
