  ...
  extends Question
{
  ...
  public void answer(Properties answers)
  {
    ...
    if ((time1 == null) || (time1.length() == 0)) {
      ...
      {
        getResponder().getCommunicator().sendAlertServerMessage(time1 + " is not a number.");
      }
    }
    ...
    if ((time2 == null) || (time2.length() == 0)) {
      ...
      {
        getResponder().getCommunicator().sendAlertServerMessage(time2 + " is not a number.");
      }
    }
    ...
    if ((time3 == null) || (time3.length() == 0)) {
      ...
      {
        getResponder().getCommunicator().sendAlertServerMessage(time3 + " is not a number.");
      }
    }
    ...
    if ((time4 == null) || (time4.length() == 0)) {
      ...
      {
        getResponder().getCommunicator().sendAlertServerMessage(time4 + " is not a number.");
      }
    }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\questions\AlertServerMessageQuestion.class
