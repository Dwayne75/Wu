        ...
        try
        {
          ...
          if (ok)
          {
            ...
            if (hex != null)
            {
              ...
              new EntityMoveQuestion.1(this, getResponder().getName() + "-guides-" + deity.getName() + "-Thread", hexnum, deity)
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\questions\EntityMoveQuestion.class
