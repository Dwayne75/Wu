  ...
  implements MonetaryConstants
{
  ...
  public void sendQuestion()
  {
    ...
    for (Creature creature : creatureSet)
    {
      ...
      if (wagoner != null)
      {
        ...
        if (dist != 99999.0F)
        {
          ...
          wagonerSet.add(new WagonerSetupDeliveryQuestion.Distanced(this, wagoner, isPublic, villName, dist));
        }
      }
    }
    WagonerSetupDeliveryQuestion.Distanced[] wagonerArr = (WagonerSetupDeliveryQuestion.Distanced[])wagonerSet.toArray(new WagonerSetupDeliveryQuestion.Distanced[wagonerSet.size()]);
    int absSortBy = Math.abs(this.sortBy);
    int upDown = Integer.signum(this.sortBy);
    switch (absSortBy)
    {
    case 1: 
      Arrays.sort(wagonerArr, new WagonerSetupDeliveryQuestion.1(this, upDown));
      
      break;
    case 2: 
      Arrays.sort(wagonerArr, new WagonerSetupDeliveryQuestion.2(this, upDown));
      
      break;
    case 3: 
      Arrays.sort(wagonerArr, new WagonerSetupDeliveryQuestion.3(this, upDown));
      
      break;
    case 4: 
      Arrays.sort(wagonerArr, new WagonerSetupDeliveryQuestion.4(this, upDown));
      
      break;
    case 5: 
      Arrays.sort(wagonerArr, new WagonerSetupDeliveryQuestion.5(this, upDown));
      
      break;
    case 6: 
      Arrays.sort(wagonerArr, new WagonerSetupDeliveryQuestion.6(this, upDown));
    }
    ...
    vill = crates;WagonerSetupDeliveryQuestion.Distanced distanced = vill.length;
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\questions\WagonerSetupDeliveryQuestion.class
