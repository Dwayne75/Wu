  ...
  implements CreatureTemplateIds
{
  ...
  public void sendQuestion()
  {
    ...
    for (int x = 0; x < templates.length; x++) {
      if ((!templates[x].isUnique()) || 
        (getResponder().getPower() >= 3) || (Servers.isThisATestServer()))
      {
  ...
  {
    return (CreatureTemplate)this.cretemplates.get(aTemplateId);
  }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\questions\CreatureCreationQuestion.class
