  ...
  extends Skill
{
  ...
  DbSkill(long aId, Skills aParent)
    throws IOException
  {
    super(aId, aParent);
  }
  ...
  public void setJoat(boolean _joat)
    throws IOException
  {
    if (_joat != this.joat)
    {
  ...
  private boolean exists(Connection aDbcon, long aId)
    throws SQLException
  {
    PreparedStatement ps = null;
    ResultSet rs = null;
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\skills\DbSkill.class
