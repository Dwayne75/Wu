  ...
  implements Comparable<Mission>
{
  ...
  public String getOwnerName()
  {
    ...
    return PlayerInfoFactory.getPlayerName(getOwnerId());
  }
  
  public String getLastModifiedString()
  {
    return getLastModifierName() + ", " + getLastModifiedDate();
  }
  ...
  public final boolean hasTargetOf(long currentTargetId, Creature performer)
  {
    ...
    if ((getCreatorType() != 2) || (performer.getPower() >= 5)) {
      if ((performer.getPower() > 0) || (getMissionCreatorName().equals(performer.getName()))) {
  ...
  {
    return getName().compareTo(aMission.getName());
  }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\tutorial\Mission.class
