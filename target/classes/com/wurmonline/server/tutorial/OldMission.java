  ...
  implements MiscConstants
{
  ...
  {
    if (kingdom == 3) {
      return (OldMission)blmissions.get(Integer.valueOf(num));
    }
    return (OldMission)wlmissions.get(Integer.valueOf(num));
  }
  ...
  private static void createMissions()
  {
    ...
    logger.info("Finished creating " + wlmissions.size() + " WL and " + blmissions.size() + " BL Tutorial Missions, that took " + (
      System.currentTimeMillis() - start) + " ms");
  }
}


/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\tutorial\OldMission.class
