  ...
  implements CounterTypes
{
  ...
  {
    return effects.remove(Integer.valueOf(id)) != null;
  }
  
  public static TriggerEffect getTriggerEffect(int id)
  {
    return (TriggerEffect)effects.get(Integer.valueOf(id));
  }
  ...
  public static void destroyEffectsForTrigger(int triggerId)
  {
    ...
    for (TriggerEffect mt : tes)
    {
      ...
      if (trig != null) {
        if (((mt.destroysTarget()) || (WurmId.getType(trig.getTarget()) == 1)) && 
          (mt.getCreatorType() != 3)) {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\tutorial\TriggerEffects.class
