  ...
  implements Comparable<WaterGenerator>
{
  ...
  {
    return (WaterGenerator)waterPointsX.get(Integer.valueOf(aX));
  }
  
  public final WaterGenerator getY(int aY)
  {
    return (WaterGenerator)this.waterPointsY.get(Integer.valueOf(aY));
  }
  
  public static final void addXGeneral(WaterGenerator wg)
  {
    waterPointsX.put(Integer.valueOf(wg.x), wg);
    wg.generateXMap();
  }
  ...
  {
    this.waterPointsY.put(Integer.valueOf(wg.y), wg);
  }
    ...
    if (this.changed) {
      ...
      else if ((this.height == 0) && (!this.spring))
      {
        ...
        if (this.waterPointsY != null)
        {
          ...
          {
            WaterGenerator[] gens = (WaterGenerator[])this.waterPointsY.values().toArray(new WaterGenerator[this.waterPointsY.size()]);
            addXGeneral(gens[0]);
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\zones\WaterGenerator.class
