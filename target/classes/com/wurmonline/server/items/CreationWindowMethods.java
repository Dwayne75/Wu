  ...
  implements ProtoConstants, MiscConstants
{
  ...
  private static final boolean sendCreationListCategories(SocketConnection connection, CreationWindowMethods.RecipesListParameter params, short numberOfEntries)
  {
    ByteBuffer buffer = connection.getBuffer();
  ...
  private static final short addGenericRecipesToList(Map<String, List<Short>> list, CreationWindowMethods.RecipesListParameter param, short[] toAdd, String categoryToAdd)
  {
    short numberOfEntries = 0;
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\items\CreationWindowMethods.class
