  ...
  implements CounterTypes
{
  ...
  public Possessions(Creature aOwner)
    throws NoSuchTemplateException, FailedException, NoSuchPlayerException, NoSuchCreatureException
  {
    this.owner = aOwner;
  ...
  public Possessions(Creature aOwner, long aInventoryId)
    throws Exception
  {
    this.owner = aOwner;
    if (!this.owner.isPlayer())
  ...
  public void sleep(boolean epicServer)
    throws IOException
  {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\items\Possessions.class
