...
public abstract class LootTableUtilities
{
  ...
  public static long getRandomLoot(@NonNull ArrayList<Pair<Short, Long>> lootTable, long maxValue, long minValueCap, long maxValueCap, int minRerolls, int maxRerolls, float chanceToReroll, float rrChanceDecreasePerRoll, long aimRollsTowardsValue)
  {
    ...
    if ((chanceToReroll > 1.0D) || (chanceToReroll < 0.0D))
    {
    ...
    } while ((timesRerolled < minRerolls) || (
      (Server.rand.nextFloat() < currentChanceToReroll - rrChanceDecreasePerRoll) && (timesRerolled < maxRerolls)));
    long rolledValue;
    long rolledValue;
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\items\LootTableUtilities.class
