...
public final class CreationEntryCreator
{
  ...
  public static void createCreationEntries()
  {
    ...
    createSimpleEntry(10015, 185, 47, 838, false, true, 0.0F, false, false, 20, 30.0D, CreationCategories.CONSTRUCTION_MATERIAL);
    ...
    createSimpleEntry(10016, 213, 23, 999, true, true, 0.0F, false, false, 10, 35.0D, CreationCategories.FLAGS);
    ...
    if (Features.Feature.METALLIC_ITEMS.isEnabled()) {
      for (sourceTemplateId : ItemFactory.metalLumpList) {
        try
        {
    ...
    createSimpleEntry(10043, 185, 47, 839, false, true, 0.0F, false, false, 20, 30.0D, CreationCategories.CONSTRUCTION_MATERIAL);
    
    createSimpleEntry(10043, 185, 44, 840, false, true, 0.0F, false, false, 20, 30.0D, CreationCategories.CONSTRUCTION_MATERIAL);
    ...
    if (Features.Feature.METALLIC_ITEMS.isEnabled())
    {
      ...
      createMetallicEntries(10034, 64, 46, 463, false, true, 0.0F, false, false, 0, 25.0D, CreationCategories.TOOLS);
    ...
    else
    {
      ...
      createSimpleEntry(10034, 64, 46, 463, false, true, 0.0F, false, false, 0, 25.0D, CreationCategories.TOOLS);
      
      createSimpleEntry(10034, 64, 205, 463, false, true, 0.0F, false, false, 0, 25.0D, CreationCategories.TOOLS);
      
      createSimpleEntry(10034, 64, 694, 463, false, true, 0.0F, false, false, 0, 25.0D, CreationCategories.TOOLS);
      
      createSimpleEntry(10034, 64, 837, 463, false, true, 0.0F, false, false, 0, 25.0D, CreationCategories.TOOLS);
      
      createSimpleEntry(10034, 64, 698, 463, false, true, 0.0F, false, false, 0, 25.0D, CreationCategories.TOOLS);
      
      createSimpleEntry(10034, 64, 47, 463, false, true, 0.0F, false, false, 0, 25.0D, CreationCategories.TOOLS);
    ...
    createSimpleEntry(10017, 926, 847, 959, true, true, 0.0F, false, false, CreationCategories.ARMOUR)
      .setFinalMaterial((byte)16);
    ...
    createSimpleEntry(10016, 226, 214, 908, false, true, 0.0F, false, false, 0, 20.0D, CreationCategories.RUGS)
    
      .setDepleteFromTarget(3000);
    
    createSimpleEntry(10016, 226, 214, 909, false, true, 0.0F, false, false, 0, 30.0D, CreationCategories.RUGS)
    
      .setDepleteFromTarget(4000);
    
    createSimpleEntry(10016, 226, 214, 910, false, true, 0.0F, false, false, 0, 40.0D, CreationCategories.RUGS)
    
      .setDepleteFromTarget(5000);
    ...
    int[] metalTypes = { 221, 223, 220, 694, 698, 44, 45, 205, 47, 46, 49, 48, 837 };
    
    int[] runeTypes = { 1290, 1293, 1292, 1289, 1291 };
    int[] arrayOfInt2 = metalTypes;int sourceTemplateId = arrayOfInt2.length;
    for (localNoSuchTemplateException = 0; localNoSuchTemplateException < sourceTemplateId; localNoSuchTemplateException++)
    {
      int metal = arrayOfInt2[localNoSuchTemplateException];
      for (int rune : runeTypes)
      {
        ...
        createSimpleEntry(10043, 1103, metal, rune, true, true, 0.0F, false, false, CreationCategories.MAGIC)
        
          .setDepleteFromTarget(200);
        createSimpleEntry(10044, 1104, metal, rune, true, true, 0.0F, false, false, CreationCategories.MAGIC)
        
          .setDepleteFromTarget(200);
      }
    }
    createSimpleEntry(10074, 1102, 1411, 1290, true, true, 0.0F, false, false, CreationCategories.MAGIC).setDepleteFromTarget(200);
    createSimpleEntry(10043, 1103, 1411, 1290, true, true, 0.0F, false, false, CreationCategories.MAGIC)
    
      .setDepleteFromTarget(200);
    createSimpleEntry(10044, 1104, 1411, 1290, true, true, 0.0F, false, false, CreationCategories.MAGIC)
    ...
    CreationEntry brownBearRug = createSimpleEntry(10017, 302, 349, 847, true, true, 0.0F, false, false, 0, 30.0D, CreationCategories.RUGS);
    
    brownBearRug.setDepleteFromSource(3000);
    brownBearRug.setDepleteFromTarget(1);
    
    CreationEntry blackBearRug = createSimpleEntry(10017, 302, 349, 846, true, true, 0.0F, false, false, 0, 30.0D, CreationCategories.RUGS);
    
    blackBearRug.setDepleteFromSource(3000);
    blackBearRug.setDepleteFromTarget(1);
    
    CreationEntry mountainLionRug = createSimpleEntry(10017, 313, 349, 848, true, true, 0.0F, false, false, 0, 30.0D, CreationCategories.RUGS);
    
    mountainLionRug.setDepleteFromSource(300);
    mountainLionRug.setDepleteFromTarget(1);
    
    CreationEntry blackWolfRug = createSimpleEntry(10017, 302, 349, 849, true, true, 0.0F, false, false, 0, 30.0D, CreationCategories.RUGS);
    ...
    AdvancedCreationEntry copperBrazier = createAdvancedEntry(10015, 838, 839, 841, false, false, 0.0F, true, true, 20, 30.0D, CreationCategories.LIGHTS_AND_LAMPS);
    
    copperBrazier.addRequirement(new CreationRequirement(1, 838, 2, true));
    
    AdvancedCreationEntry marbleBrazierPillar = createAdvancedEntry(1013, 786, 492, 842, false, false, 0.0F, true, true, 20, 30.0D, CreationCategories.LIGHTS_AND_LAMPS);
    ...
    AdvancedCreationEntry wagon = createAdvancedEntry(10044, 22, 191, 850, false, false, 0.0F, true, true, 0, 40.0D, CreationCategories.CARTS);
    ...
    AdvancedCreationEntry smallCrate = createAdvancedEntry(1005, 22, 217, 851, false, false, 0.0F, true, true, 0, 10.0D, CreationCategories.STORAGE);
    
    smallCrate.addRequirement(new CreationRequirement(1, 22, 10, true));
    
    AdvancedCreationEntry largeCrate = createAdvancedEntry(1005, 22, 217, 852, false, false, 0.0F, true, true, 0, 60.0D, CreationCategories.STORAGE);
    
    largeCrate.addRequirement(new CreationRequirement(1, 22, 15, true));
    
    AdvancedCreationEntry shipCarrier = createAdvancedEntry(10044, 22, 191, 853, false, false, 0.0F, true, true, 0, 15.0D, CreationCategories.CARTS);
    ...
    AdvancedCreationEntry creatureCarrier = createAdvancedEntry(10044, 22, 191, 1410, false, false, 0.0F, true, true, 0, 25.0D, CreationCategories.CARTS);
    ...
    AdvancedCreationEntry bedsideTable = createAdvancedEntry(10044, 23, 22, 885, false, false, 0.0F, true, true, 0, 25.0D, CreationCategories.FURNITURE);
    ...
    AdvancedCreationEntry openFireplace = createAdvancedEntry(1013, 492, 132, 889, false, false, 0.0F, true, true, 0, 35.0D, CreationCategories.FIRE);
    ...
    AdvancedCreationEntry canopyBed = createAdvancedEntry(10044, 482, 483, 890, false, false, 0.0F, true, true, 0, 65.0D, CreationCategories.FURNITURE);
    ...
    AdvancedCreationEntry woodenBench = createAdvancedEntry(10044, 218, 22, 891, false, false, 0.0F, true, true, 0, 35.0D, CreationCategories.FURNITURE);
    ...
    AdvancedCreationEntry wardrobe = createAdvancedEntry(10044, 217, 22, 892, false, false, 0.0F, true, true, 0, 55.0D, CreationCategories.FURNITURE);
    ...
    AdvancedCreationEntry woodenCoffer = createAdvancedEntry(10044, 218, 22, 893, false, false, 0.0F, true, true, 0, 24.0D, CreationCategories.FURNITURE);
    ...
    AdvancedCreationEntry royalThrone = createAdvancedEntry(10044, 217, 22, 894, false, false, 0.0F, true, true, 0, 70.0D, CreationCategories.FURNITURE);
    ...
    AdvancedCreationEntry washingBowl = createAdvancedEntry(10015, 64, 221, 895, false, true, 0.0F, false, true, 0, 30.0D, CreationCategories.FURNITURE);
    ...
    AdvancedCreationEntry tripodTableSmall = createAdvancedEntry(10044, 22, 23, 896, false, false, 0.0F, true, true, 0, 30.0D, CreationCategories.FURNITURE);
    ...
    AdvancedCreationEntry highBookshelf = createAdvancedEntry(10044, 217, 22, 911, false, false, 0.0F, true, true, 0, 35.0D, CreationCategories.FURNITURE);
    ...
    AdvancedCreationEntry lowBookshelf = createAdvancedEntry(10044, 217, 22, 912, false, false, 0.0F, true, true, 0, 25.0D, CreationCategories.FURNITURE);
    ...
    AdvancedCreationEntry emptyHighBookshelf = createAdvancedEntry(10044, 217, 22, 1401, false, false, 0.0F, true, true, 0, 35.0D, CreationCategories.FURNITURE);
    ...
    AdvancedCreationEntry emptyLowBookshelf = createAdvancedEntry(10044, 217, 22, 1400, false, false, 0.0F, true, true, 0, 25.0D, CreationCategories.FURNITURE);
    ...
    AdvancedCreationEntry barTable = createAdvancedEntry(10044, 218, 22, 1402, false, false, 0.0F, true, true, 0, 25.0D, CreationCategories.FURNITURE);
    ...
    AdvancedCreationEntry fineHighChair = createAdvancedEntry(10044, 218, 22, 913, false, false, 0.0F, true, true, 0, 60.0D, CreationCategories.FURNITURE);
    ...
    AdvancedCreationEntry highChair = createAdvancedEntry(10044, 218, 22, 914, false, false, 0.0F, true, true, 0, 50.0D, CreationCategories.FURNITURE);
    ...
    AdvancedCreationEntry pauperHighChair = createAdvancedEntry(10044, 218, 22, 915, false, false, 0.0F, true, true, 0, 40.0D, CreationCategories.FURNITURE);
    ...
    AdvancedCreationEntry smelter = createAdvancedEntry(1013, 132, 132, 1028, false, false, 0.0F, true, true, 0, 50.0D, CreationCategories.FIRE);
    ...
    AdvancedCreationEntry pewpewdie = createAdvancedEntry(10044, 217, 22, 934, false, false, 0.0F, true, true, 0, 40.0D, CreationCategories.WARMACHINES);
    ...
    AdvancedCreationEntry siegeShield = createAdvancedEntry(1005, 217, 22, 931, false, false, 0.0F, true, true, 0, 10.0D, CreationCategories.WARMACHINES);
    ...
    AdvancedCreationEntry ballistaMount = createAdvancedEntry(10044, 217, 9, 933, false, false, 0.0F, true, true, 0, 60.0D, CreationCategories.WARMACHINES);
    
    ballistaMount.addRequirement(new CreationRequirement(1, 22, 8, true));
    
    AdvancedCreationEntry barrier = createAdvancedEntry(1005, 217, 9, 938, false, false, 0.0F, true, true, 0, 5.0D, CreationCategories.WARMACHINES);
    ...
    AdvancedCreationEntry ballista = createAdvancedEntry(10044, 933, 22, 936, false, false, 0.0F, true, true, 0, 60.0D, CreationCategories.WARMACHINES);
    ...
    AdvancedCreationEntry trebuchet = createAdvancedEntry(10044, 9, 9, 937, false, false, 0.0F, true, true, 0, 80.0D, CreationCategories.WARMACHINES);
    ...
    AdvancedCreationEntry archeryTower = createAdvancedEntry(10044, 217, 22, 939, false, false, 0.0F, true, true, 0, 40.0D, CreationCategories.WARMACHINES);
    ...
    AdvancedCreationEntry spinningWheel = createAdvancedEntry(10044, 187, 23, 922, false, false, 0.0F, true, true, 0, 30.0D, CreationCategories.TOOLS);
    ...
    AdvancedCreationEntry loungeChair = createAdvancedEntry(10044, 22, 23, 923, false, false, 0.0F, true, true, 0, 40.0D, CreationCategories.FURNITURE);
    ...
    AdvancedCreationEntry royalLoungeChaise = createAdvancedEntry(10044, 22, 23, 924, false, false, 0.0F, true, true, 0, 70.0D, CreationCategories.FURNITURE);
    ...
    AdvancedCreationEntry woodCupboard = createAdvancedEntry(10044, 218, 22, 927, false, false, 0.0F, true, true, 0, 40.0D, CreationCategories.FURNITURE);
    ...
    AdvancedCreationEntry alchemyCupboard = createAdvancedEntry(10044, 218, 22, 1117, false, false, 0.0F, true, true, 0, 20.0D, CreationCategories.FURNITURE);
    ...
    AdvancedCreationEntry storageUnit = createAdvancedEntry(1005, 217, 22, 1119, false, false, 0.0F, true, true, 0, 30.0D, CreationCategories.STORAGE);
    ...
    AdvancedCreationEntry roundMarbleTable = createAdvancedEntry(10074, 787, 130, 928, false, false, 0.0F, true, true, 0, 60.0D, CreationCategories.FURNITURE);
    ...
    AdvancedCreationEntry rectagularMarbleTable = createAdvancedEntry(10074, 787, 130, 929, false, false, 0.0F, true, true, 0, 50.0D, CreationCategories.FURNITURE);
    ...
    AdvancedCreationEntry yellowWoolCap = createAdvancedEntry(10016, 128, 943, 944, true, false, 0.0F, true, false, 0, 20.0D, CreationCategories.CLOTHES);
    ...
    AdvancedCreationEntry greenWoolCap = createAdvancedEntry(10016, 128, 943, 945, true, false, 0.0F, true, false, 0, 20.0D, CreationCategories.CLOTHES);
    ...
    AdvancedCreationEntry redWoolCap = createAdvancedEntry(10016, 128, 943, 946, true, false, 0.0F, true, false, 0, 20.0D, CreationCategories.CLOTHES);
    ...
    AdvancedCreationEntry blueWoolCap = createAdvancedEntry(10016, 128, 943, 947, true, false, 0.0F, true, false, 0, 20.0D, CreationCategories.CLOTHES);
    ...
    AdvancedCreationEntry NIcoomonWoolHat = createAdvancedEntry(10016, 215, 926, 948, true, false, 5.0F, false, false, 0, 5.0D, CreationCategories.CLOTHES);
    ...
    AdvancedCreationEntry CIcoomonWoolHat = createAdvancedEntry(10016, 216, 926, 948, true, false, 5.0F, false, false, 0, 5.0D, CreationCategories.CLOTHES);
    ...
    AdvancedCreationEntry coomonWoolHatDark = createAdvancedEntry(10016, 128, 948, 949, true, false, 0.0F, true, false, 0, 20.0D, CreationCategories.CLOTHES);
    ...
    AdvancedCreationEntry coomonWoolHatBrown = createAdvancedEntry(10016, 128, 948, 950, true, false, 0.0F, true, false, 0, 20.0D, CreationCategories.CLOTHES);
    ...
    AdvancedCreationEntry coomonWoolHatGreen = createAdvancedEntry(10016, 128, 948, 951, true, false, 0.0F, true, false, 0, 20.0D, CreationCategories.CLOTHES);
    ...
    AdvancedCreationEntry coomonWoolHatRed = createAdvancedEntry(10016, 128, 948, 952, true, false, 0.0F, true, false, 0, 20.0D, CreationCategories.CLOTHES);
    ...
    AdvancedCreationEntry coomonWoolHatBlue = createAdvancedEntry(10016, 128, 948, 953, true, false, 0.0F, true, false, 0, 20.0D, CreationCategories.CLOTHES);
    ...
    AdvancedCreationEntry foresterWoolHatGreen = createAdvancedEntry(10016, 128, 954, 955, true, false, 0.0F, true, false, 0, 10.0D, CreationCategories.CLOTHES);
    ...
    AdvancedCreationEntry foresterWoolHatDark = createAdvancedEntry(10016, 128, 954, 956, true, false, 0.0F, true, false, 0, 10.0D, CreationCategories.CLOTHES);
    ...
    AdvancedCreationEntry foresterWoolHatBlue = createAdvancedEntry(10016, 128, 954, 957, true, false, 0.0F, true, false, 0, 10.0D, CreationCategories.CLOTHES);
    ...
    AdvancedCreationEntry foresterWoolHatRed = createAdvancedEntry(10016, 128, 954, 958, true, false, 0.0F, true, false, 0, 10.0D, CreationCategories.CLOTHES);
    ...
    AdvancedCreationEntry squireWoolCapGreen = createAdvancedEntry(10016, 128, 961, 962, true, false, 0.0F, true, false, 0, 25.0D, CreationCategories.CLOTHES);
    ...
    AdvancedCreationEntry squireWoolCapBlue = createAdvancedEntry(10016, 128, 961, 963, true, false, 0.0F, true, false, 0, 25.0D, CreationCategories.CLOTHES);
    ...
    AdvancedCreationEntry squireWoolCapBlack = createAdvancedEntry(10016, 128, 961, 964, true, false, 0.0F, true, false, 0, 25.0D, CreationCategories.CLOTHES);
    ...
    AdvancedCreationEntry squireWoolCapRed = createAdvancedEntry(10016, 128, 961, 965, true, false, 0.0F, true, false, 0, 25.0D, CreationCategories.CLOTHES);
    ...
    AdvancedCreationEntry squireWoolCapYellow = createAdvancedEntry(10016, 128, 961, 966, true, false, 0.0F, true, false, 0, 25.0D, CreationCategories.CLOTHES);
    ...
    AdvancedCreationEntry grapeTrellis1 = createAdvancedEntry(10045, 266, 23, 920, false, false, 0.0F, true, true, 0, 10.0D, CreationCategories.DECORATION);
    ...
    AdvancedCreationEntry roseTrellis1 = createAdvancedEntry(10045, 266, 23, 1018, false, false, 0.0F, true, true, 0, 10.0D, CreationCategories.DECORATION);
    ...
    AdvancedCreationEntry hopsTrellis = createAdvancedEntry(10045, 1275, 23, 1274, false, false, 0.0F, true, true, 0, 10.0D, CreationCategories.DECORATION);
    ...
    createNewClothing(1067, 110, 128, new int[] { 47, 439, 102 });
    createNewClothing(1068, 110, 128, new int[] { 46, 437, 102 });
    createNewClothing(1069, 110, 128, new int[] { 439, 100, 102 });
    createNewClothing(1070, 1107, 128, new int[] { 439, 47, 440 });
    createNewClothing(1072, 1107, 128, new int[] { 46, 437 });
    createNewClothing(1073, 1107, 128, new int[] { 47 });
    createNewClothing(1074, 1106, 128, new int[] { 47, 439, 100 });
    createNewClothing(1105, 1106, 128, new int[] { 46, 437, 100 });
    createNewClothing(1075, 1106, 128, new int[] { 439, 100 });
    createNewClothing(779, 1425, 128, new int[] { 440 });
    createNewClothing(111, 1426, 128, new int[] { 439 });
    createNewClothing(112, 1427, 128, new int[] { 439 });
    
    AdvancedCreationEntry beeSmoker = createAdvancedEntry(10015, 188, 46, 1243, false, false, 0.0F, true, false, 0, 30.0D, CreationCategories.TOOLS);
    ...
    AdvancedCreationEntry hive = createAdvancedEntry(10044, 23, 22, 1175, false, false, 0.0F, true, true, 0, 25.0D, CreationCategories.TOOLS);
    ...
    AdvancedCreationEntry waxkit = createAdvancedEntry(10091, 213, 1254, 1255, false, false, 0.0F, true, false, 0, 21.0D, CreationCategories.COOKING_UTENSILS);
    
    waxkit.addRequirement(new CreationRequirement(1, 1269, 1, true));
    waxkit.addRequirement(new CreationRequirement(2, 214, 1, true));
    
    AdvancedCreationEntry skullMug = createAdvancedEntry(1012, 390, 1250, 1253, false, true, 0.0F, false, false, 0, 25.0D, CreationCategories.COOKING_UTENSILS);
    ...
    if (Features.Feature.HIGHWAYS.isEnabled())
    {
      ...
      AdvancedCreationEntry waystone = createAdvancedEntry(10031, 97, 146, 1112, false, false, 10.0F, false, false, 0, 21.0D, CreationCategories.HIGHWAY);
    ...
    AdvancedCreationEntry bcu = createAdvancedEntry(10044, 217, 860, 1316, false, false, 0.0F, true, true, 35, 50.0D, CreationCategories.CONTAINER);
    ...
    {
      AdvancedCreationEntry creatureCrate = createAdvancedEntry(1005, 22, 217, 1311, false, false, 0.0F, true, true, 0, 60.0D, CreationCategories.STORAGE);
    ...
    createAdvancedMetalicEntry(10015, 64, 220, 1341, false, true, 0.0F, false, false, CreationCategories.TOOLS, new CreationRequirement[] { new CreationRequirement(1, 790, 3, true), new CreationRequirement(2, 100, 1, true) });
    ...
    {
      AdvancedCreationEntry chickenCoop = createAdvancedEntry(10044, 22, 217, 1432, false, false, 0.0F, true, true, 0, 50.0D, CreationCategories.STORAGE);
  ...
  {
    AdvancedCreationEntry article = createAdvancedEntry(10016, aSource, aTarget, aArticle, false, false, 0.0F, true, false, 0, 10.0D, CreationCategories.CLOTHES);
  ...
  {
    CreationEntry entry = new SimpleCreationEntry(aPrimarySkill, aObjectSource, aObjectTarget, aObjectCreated, depleteSource, depleteTarget, aPercentageLost, depleteEqually, aCreateOnGround, aCategory);
  ...
  {
    CreationEntry defaultEntry = createSimpleEntry(aPrimarySkill, aObjectSource, aObjectTarget, aObjectCreated, depleteSource, depleteTarget, aPercentageLost, depleteEqually, aCreateOnGround, aCategory);
  ...
  {
    CreationEntry entry = new SimpleCreationEntry(aPrimarySkill, aObjectSource, aObjectTarget, aObjectCreated, depleteSource, depleteTarget, aPercentageLost, depleteEqually, aCreateOnGround, aCustomCreationCutOff, aMinimumSkill, aCategory);
  ...
  {
    CreationEntry defaultEntry = createSimpleEntry(aPrimarySkill, aObjectSource, aObjectTarget, aObjectCreated, depleteSource, depleteTarget, aPercentageLost, depleteEqually, aCreateOnGround, aCustomCreationCutOff, aMinimumSkill, aCategory);
    if (ItemFactory.isMetalLump(aObjectTarget)) {
      for (int targetTemplateId : ItemFactory.metalLumpList) {
        if (targetTemplateId != aObjectTarget) {
  ...
  {
    AdvancedCreationEntry defaultEntry = createAdvancedEntry(primarySkill, objectSource, objectTarget, objectCreated, depleteSource, depleteTarget, percentageLost, destroyBoth, createOnGround, category);
    ...
    if (ItemFactory.isMetalLump(objectTarget)) {
      for (int targetTemplateId : ItemFactory.metalLumpList) {
        ...
        {
          AdvancedCreationEntry metalEntry = createAdvancedEntry(primarySkill, objectSource, targetTemplateId, objectCreated, depleteSource, depleteTarget, percentageLost, destroyBoth, createOnGround, category);
          for (CreationRequirement extra : extras) {
      ...
      for (int sourceTemplateId : ItemFactory.metalLumpList) {
        ...
        {
          AdvancedCreationEntry metalEntry = createAdvancedEntry(primarySkill, sourceTemplateId, objectTarget, objectCreated, depleteSource, depleteTarget, percentageLost, destroyBoth, createOnGround, category);
          for (CreationRequirement extra : extras) {
            metalEntry.addRequirement(extra);
          }
        }
  ...
  {
    AdvancedCreationEntry defaultEntry = createAdvancedEntry(primarySkill, objectSource, objectTarget, objectCreated, destroyTarget, useCapacity, percentageLost, destroyBoth, createOnGround, customCutOffChance, aMinimumSkill, category);
    for (CreationRequirement extra : extras) {
      defaultEntry.addRequirement(extra);
    }
    if (ItemFactory.isMetalLump(objectTarget)) {
      for (int targetTemplateId : ItemFactory.metalLumpList) {
        if (targetTemplateId != objectTarget)
        {
          AdvancedCreationEntry metalEntry = createAdvancedEntry(primarySkill, objectSource, objectTarget, objectCreated, destroyTarget, useCapacity, percentageLost, destroyBoth, createOnGround, customCutOffChance, aMinimumSkill, category);
          for (CreationRequirement extra : extras) {
            metalEntry.addRequirement(extra);
          }
        }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\items\CreationEntryCreator.class
