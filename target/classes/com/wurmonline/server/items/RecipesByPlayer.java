  ...
  implements MiscConstants
{
  ...
  {
    return (Recipe)this.knownRecipes.get(Short.valueOf(recipeId));
  }
  
  public boolean isKnownRecipe(short recipeId)
  {
    return this.knownRecipes.containsKey(Short.valueOf(recipeId));
  }
  
  public void removeRecipe(short recipeId)
  {
    this.knownRecipes.remove(Short.valueOf(recipeId));
  }
  
  boolean setFavourite(short recipeId, boolean isFavourite)
  {
    Boolean wasFavourite = (Boolean)this.playerFavourites.put(Short.valueOf(recipeId), Boolean.valueOf(isFavourite));
    if (!this.playerNotes.containsKey(Short.valueOf(recipeId))) {
      this.playerNotes.put(Short.valueOf(recipeId), "");
    }
    return (wasFavourite == null) || (wasFavourite.booleanValue() != isFavourite);
  }
  
  boolean setNotes(short recipeId, String notes)
  {
    String newNotes = notes.substring(0, Math.min(notes.length(), 200));
    String oldNotes = (String)this.playerNotes.put(Short.valueOf(recipeId), newNotes);
    if (!this.playerFavourites.containsKey(Short.valueOf(recipeId))) {
      this.playerFavourites.put(Short.valueOf(recipeId), Boolean.valueOf(false));
    }
  ...
  {
    Boolean isFavourite = (Boolean)this.playerFavourites.get(Short.valueOf(recipeId));
    return (isFavourite != null) && (isFavourite.booleanValue());
  }
  
  String getNotes(short recipeId)
  {
    String notes = (String)this.playerNotes.get(Short.valueOf(recipeId));
    if (notes != null) {
        ...
        if (rbp != null)
        {
          try
          {
            ...
            if (recipe != null)
            {
              ...
              Ingredient ingredient = makeIngredient(templateId, cstate, pstate, material, refingredient
                .hasRealTemplate(), realTemplateId, groupId);
              if (ingredient != null)
              {
  ...
  {
    RecipesByPlayer rbp = (RecipesByPlayer)playerRecipes.get(Long.valueOf(playerId));
    if ((rbp == null) && (autoCreate))
    {
      rbp = new RecipesByPlayer(playerId);
      playerRecipes.put(Long.valueOf(playerId), rbp);
    }
    return rbp;
  }
  ...
  public static boolean isKnownRecipe(long playerId, short recipeId)
  {
    ...
    RecipesByPlayer rbp = (RecipesByPlayer)playerRecipes.get(Long.valueOf(playerId));
    return (rbp != null) && (rbp.knownRecipes.containsKey(Short.valueOf(recipeId)));
  }
  ...
  public static Recipe getPlayerKnownRecipeOrNull(long playerId, short recipeId)
  {
    RecipesByPlayer rbp = (RecipesByPlayer)playerRecipes.get(Long.valueOf(playerId));
    if (rbp != null) {
      return (Recipe)rbp.knownRecipes.get(Short.valueOf(recipeId));
    }
    return null;
  }
  ...
  public static final Recipe[] getTargetActionRecipesFor(long playerId)
  {
    ...
    return (Recipe[])knownRecipes.toArray(new Recipe[knownRecipes.size()]);
  }
  ...
  public static final ItemTemplate[] getKnownCookersFor(long playerId)
  {
    ...
    return (ItemTemplate[])knownCookers.toArray(new ItemTemplate[knownCookers.size()]);
  }
  ...
  public static final ItemTemplate[] getKnownContainersFor(long playerId)
  {
    ...
    return (ItemTemplate[])knownContainers.toArray(new ItemTemplate[knownContainers.size()]);
  }
  ...
  public static final ItemTemplate[] getKnownToolsFor(long playerId)
  {
    ...
    return (ItemTemplate[])knownTools.toArray(new ItemTemplate[knownTools.size()]);
  }
  ...
  public static final Ingredient[] getKnownIngredientsFor(long playerId)
  {
    ...
    return (Ingredient[])knownIngredients.values().toArray(new Ingredient[knownIngredients.size()]);
  }
  ...
  public static final Recipe[] getIngredientRecipesFor(long playerId, Ingredient ingredient)
  {
    Set<Recipe> recipes = getKnownRecipesSetFor(playerId);
    Set<Recipe> knownRecipes = new HashSet();
    for (Iterator localIterator1 = recipes.iterator(); localIterator1.hasNext();)
    {
      recipe = (Recipe)localIterator1.next();
  ...
  public static void packRecipes(DataOutputStream dos, long playerId)
    throws IOException
  {
    ...
    for (Iterator localIterator = recipes.iterator(); localIterator.hasNext();)
    {
      recipe = (Recipe)localIterator.next();
    ...
    if (rbp != null)
    {
      ...
      for (Map.Entry<Short, Boolean> entry : rbp.playerFavourites.entrySet()) {
      ...
      dos.writeShort(count);
      for (Map.Entry<Short, String> entry : rbp.playerNotes.entrySet()) {
  ...
  public static void unPackRecipes(DataInputStream dis, long playerId)
    throws IOException
  {
  ...
  public static boolean saveRecipe(@Nullable Creature performer, Recipe templateRecipe, long playerId, @Nullable Item source, Item target)
  {
    ...
    if (playerRecipe != null)
    {
      if (templateRecipe.hasCooker())
      {
        ...
        if (cooker != null) {
          if (!playerRecipe.hasCooker(cooker.getTemplateId()))
          {
      ...
      if (templateRecipe.hasContainer()) {
        if (target != null) {
          if (!playerRecipe.hasContainer(target.getTemplateId()))
          {
      ...
      if ((((source != null ? 1 : 0) & (templateRecipe.getActiveItem() != null ? 1 : 0)) != 0) && (playerRecipe.getActiveItem() != null)) {
        if ((templateRecipe.getActiveItem().isFoodGroup()) && (!playerRecipe.getActiveItem().isFoodGroup()) && 
      ...
      Ingredient pi;
      if ((templateRecipe.getTargetItem() != null) && (playerRecipe.getTargetItem() != null)) {
        if ((templateRecipe.getTargetItem().isFoodGroup()) && (!playerRecipe.getTargetItem().isFoodGroup()) && 
          (playerRecipe.getTargetItem().getTemplateId() != target.getTemplateId()))
        {
          pi = playerRecipe.getIngredientById(templateRecipe.getTargetItem().getIngredientId());
    ...
    {
      pi = new Ingredient(target.getTemplate(), false, (byte)-1);
  ...
  public static void deleteRecipesByNumber(short recipeId)
  {
    ...
    {
      Recipe recipe = ((RecipesByPlayer)entry.getValue()).getRecipe(recipeId);
      if (recipe != null)
      {
        RecipesByPlayer rbp = (RecipesByPlayer)entry.getValue();
        long playerId = ((Long)entry.getKey()).longValue();
        dbRemovePlayerRecipe(playerId, recipeId);
        rbp.removeRecipe(recipeId);
        try
        {
  ...
  public static void deleteRecipesForPlayer(long playerId)
  {
    ...
    playerRecipes.remove(Long.valueOf(playerId));
  }
  ...
  private static void dbSaveRecipeIngredient(boolean update, long playerId, short recipeId, Ingredient ingredient)
  {
    ...
    {
      logger.log(Level.WARNING, "Failed to save player recipe ingredient: " + sqex.getMessage(), sqex);
    }
    finally
    {
      DbUtilities.closeDatabaseObjects(ps, null);
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\items\RecipesByPlayer.class
