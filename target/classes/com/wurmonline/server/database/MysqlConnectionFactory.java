  ...
  extends ConnectionFactory
{
    ...
    throws SQLException
  {
    ...
    Connection con = driver.connect(getUrl(), connectionInfo);
    if (logger.isLoggable(Level.FINE)) {
      logger.fine("JDBC Driver Class: " + driver.getClass() + ", version: " + driver.getMajorVersion() + '.' + driver
        .getMinorVersion());
    }
    return con;
  }
  
  public boolean isValid(@Nullable Connection con)
    throws SQLException
  {
    return (con != null) && (con.isValid(0));
  }
  
  public boolean isStale(long lastUsed, @Nullable Connection connection)
    throws SQLException
  {
    return (System.currentTimeMillis() - lastUsed > 3600000L) || ((connection != null) && 
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\database\MysqlConnectionFactory.class
