  ...
  implements MiscConstants
{
  ...
  public void execute()
  {
    ...
    try
    {
      ...
      if ((this.groupId != -1) && (this.msg.length() > 0)) {
        if (Servers.isThisLoginServer())
        {
          ...
          for (ServerEntry se : Servers.getAllServers()) {
            if ((se.getCAHelpGroup() == this.groupId) && (se.getId() != Servers.getLocalServerId()) && 
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\target\classes\com\wurmonline\server\webinterface\WcCAHelpGroupMessage.class
