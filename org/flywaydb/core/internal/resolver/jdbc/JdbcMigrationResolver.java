  ...
  implements MigrationResolver
{
  ...
  public List<ResolvedMigration> resolveMigrations()
  {
    ...
    try
    {
      Class<?>[] classes = this.scanner.scanForClasses(this.location, JdbcMigration.class);
      for (Class<?> clazz : classes)
      {
        JdbcMigration jdbcMigration = (JdbcMigration)ClassUtils.instantiate(clazz.getName(), this.scanner.getClassLoader());
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\org\flywaydb\core\internal\resolver\jdbc\JdbcMigrationResolver.class
