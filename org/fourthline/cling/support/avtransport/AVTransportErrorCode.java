...
public enum AVTransportErrorCode
{
  ...
  private AVTransportErrorCode(int code, String description)
  {
    this.code = code;
  ...
  {
    for (AVTransportErrorCode errorCode : ) {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\org\fourthline\cling\support\avtransport\AVTransportErrorCode.class
