...
public class PositionInfo
{
  ...
  {
    this(
      ((UnsignedIntegerFourBytes)((ActionArgumentValue)args.get("Track")).getValue()).getValue().longValue(), 
      (String)((ActionArgumentValue)args.get("TrackDuration")).getValue(), 
      (String)((ActionArgumentValue)args.get("TrackMetaData")).getValue(), 
      (String)((ActionArgumentValue)args.get("TrackURI")).getValue(), 
      (String)((ActionArgumentValue)args.get("RelTime")).getValue(), 
      (String)((ActionArgumentValue)args.get("AbsTime")).getValue(), 
      ((Integer)((ActionArgumentValue)args.get("RelCount")).getValue()).intValue(), 
      ((Integer)((ActionArgumentValue)args.get("AbsCount")).getValue()).intValue());
  }
  ...
  {
    return getTrackDuration() == null ? 0L : ModelUtil.fromTimeString(getTrackDuration());
  }
  
  public long getTrackElapsedSeconds()
  {
    return (getRelTime() == null) || (getRelTime().equals("NOT_IMPLEMENTED")) ? 0L : ModelUtil.fromTimeString(getRelTime());
  }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\org\fourthline\cling\support\model\PositionInfo.class
