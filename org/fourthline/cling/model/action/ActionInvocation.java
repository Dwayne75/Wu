...
public class ActionInvocation<S extends Service>
{
  ...
  {
    return (ActionArgumentValue)this.input.get(argument.getName());
  }
  ...
  {
    return (ActionArgumentValue)this.output.get(argument.getName());
  }
  ...
  public void setOutput(String argumentName, Object value)
    throws InvalidValueException
  {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\org\fourthline\cling\model\action\ActionInvocation.class
