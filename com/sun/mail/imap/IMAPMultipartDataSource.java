  ...
  implements MultipartDataSource
{
  ...
  protected IMAPMultipartDataSource(MimePart part, BODYSTRUCTURE[] bs, String sectionId, IMAPMessage msg)
  {
    ...
    for (int i = 0; i < bs.length; i++) {
      this.parts.addElement(new IMAPBodyPart(bs[i], sectionId + "." + Integer.toString(i + 1), msg));
    }
  }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\sun\mail\imap\IMAPMultipartDataSource.class
