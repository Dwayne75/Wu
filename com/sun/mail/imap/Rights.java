  ...
  implements Cloneable
{
  ...
  {
    for (int i = 0; i < rights.rights.length; i++) {
      if ((rights.rights[i] != 0) && (this.rights[i] == 0)) {
        return false;
      }
    }
    return true;
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\sun\mail\imap\Rights.class
