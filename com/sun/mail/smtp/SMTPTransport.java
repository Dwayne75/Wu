  ...
  extends Transport
{
  ...
  protected SMTPTransport(Session session, URLName urlname, String name, boolean isSSL)
  {
    ...
    Authenticator[] a = { new LoginAuthenticator(), new PlainAuthenticator(), new DigestMD5Authenticator(), new NtlmAuthenticator() };
    ...
    throws MessagingException
  {
    if (this.saslAuthenticator == null) {
      try
      {
        ...
        this.saslAuthenticator = ((SaslAuthenticator)c.newInstance(new Object[] { this, this.name, this.session.getProperties(), this.logger, this.host }));
      }
      catch (Exception ex)
      {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\sun\mail\smtp\SMTPTransport.class
