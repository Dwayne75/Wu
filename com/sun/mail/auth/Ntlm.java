...
public class Ntlm
{
  ...
  private void init0()
  {
    this.type1 = new byte['Ā'];
    this.type3 = new byte['Ā'];
  ...
  public String generateType1Msg(int flags)
  {
    ...
    if (dlen == 0)
    {
      byte[] tmp72_67 = this.type1;tmp72_67[13] = ((byte)(tmp72_67[13] & 0xFFFFFFEF));
    }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\sun\mail\auth\Ntlm.class
