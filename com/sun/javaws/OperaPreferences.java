...
public class OperaPreferences
{
    ...
    throws IOException
  {
    ...
    String str1 = "";
    for (String str2 = localBufferedReader.readLine(); str2 != null;)
    {
      if (str2.length() > 0) {
        if (str2.charAt(0) == '[')
        {
  ...
  public String toString()
  {
    ...
    for (ListIterator localListIterator = this.sections.listIterator(); localListIterator.hasNext();)
    {
  ...
  private int indexOf(String paramString)
  {
    int i = 0;
    int j = -1;
    for (ListIterator localListIterator = this.sections.listIterator(); localListIterator.hasNext(); i++)
    {
      PreferenceSection localPreferenceSection = (PreferenceSection)localListIterator.next();
  ...
  private class PreferenceSection
  {
    ...
    public PreferenceSection(String paramString)
    {
    ...
    private class PreferenceEntry
    {
      ...
      public PreferenceEntry(String paramString1, String paramString2)
      {
      ...
      implements Iterator
    {
      ...
      public PreferenceEntryIterator(OperaPreferences.PreferenceSection.PreferenceEntry paramPreferenceEntry)
      {
        this.next = paramPreferenceEntry;
        this.current = null;
        this.expectedModified = OperaPreferences.PreferenceSection.this.modified;
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\sun\javaws\OperaPreferences.class
