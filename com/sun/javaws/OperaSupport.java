...
public abstract class OperaSupport
{
    ...
    throws IOException
  {
    ...
    if (paramOperaPreferences != null)
    {
      ...
      if (f >= 5.0F) {
        if (!paramOperaPreferences.containsKey("File Types Extension", "application/x-java-jnlp-file")) {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\sun\javaws\OperaSupport.class
