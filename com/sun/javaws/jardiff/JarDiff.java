  ...
  implements JarDiffConstants
{
  ...
  private static byte[] newBytes = new byte['ࠀ'];
  private static byte[] oldBytes = new byte['ࠀ'];
    ...
    throws IOException
  {
    ...
    int i = paramInputStream.read(newBytes);
    while (i != -1)
    {
      paramJarOutputStream.write(newBytes, 0, i);
      i = paramInputStream.read(newBytes);
    }
  ...
  private static class JarFile2
  {
      ...
      throws IOException
    {
      ...
      boolean bool = differs(localInputStream1, localInputStream2);
      ...
      else
      {
        ...
        if (i != 0) {
          ...
          catch (IOException localIOException1)
          {
            try
            {
              System.out.println(getResources().getString("jardiff.error.create") + " " + localIOException1);
            }
          ...
          catch (IOException localIOException2)
          {
            try
            {
              System.out.println(getResources().getString("jardiff.error.apply") + " " + localIOException2);
            }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\sun\javaws\jardiff\JarDiff.class
