  ...
  implements JarDiffConstants, Patcher
{
  ...
  private void updateDelegate(Patcher.PatchDelegate paramPatchDelegate, double paramDouble1, double paramDouble2)
  {
    if (paramPatchDelegate != null) {
      paramPatchDelegate.patching((int)(paramDouble1 / paramDouble2));
    }
  }
    ...
    throws IOException
  {
    try
    {
      throw new IOException(getResources().getString(paramString1) + " " + paramString2);
    }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\sun\javaws\jardiff\JarDiffPatcher.class
