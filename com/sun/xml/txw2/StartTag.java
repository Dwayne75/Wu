  ...
  implements NamespaceResolver
{
  ...
  {
    checkWritable();
    for (Attribute a = this.firstAtt; (a != null) && 
          (!a.hasName(nsUri, localName)); a = a.next) {}
    if (a == null)
    {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\sun\xml\txw2\StartTag.class
