  ...
  extends NGCCHandler
{
  ...
  private void action0()
    throws SAXException
  {
    this.result = new ParticleImpl(this.$runtime.document, null, this.wcBody, this.wloc, this.occurs.max, this.occurs.min);
  }
  ...
  private void action2()
    throws SAXException
  {
    this.result = new ParticleImpl(this.$runtime.document, null, this.anonymousElementDecl, this.loc, this.occurs.max, this.occurs.min);
  }
  ...
  private void action7()
    throws SAXException
  {
    this.result = new ParticleImpl(this.$runtime.document, null, this.term, this.loc, this.occurs.max, this.occurs.min);
  }
    ...
    throws SAXException
  {
    ...
    case 26: 
      ...
      {
        NGCCHandler h = new occurs(this, this._source, this.$runtime, 599);
    ...
    case 4: 
      ...
      {
        NGCCHandler h = new occurs(this, this._source, this.$runtime, 574);
        spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
      }
      else
      {
    ...
    case 16: 
      ...
      {
        NGCCHandler h = new occurs(this, this._source, this.$runtime, 588);
        spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
      }
      else
      {
    ...
    case 21: 
      ...
      {
        NGCCHandler h = new annotation(this, this._source, this.$runtime, 594, null, AnnotationContext.PARTICLE);
        spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
      }
      else
      {
    ...
    case 29: 
      ...
      {
        NGCCHandler h = new modelGroupBody(this, this._source, this.$runtime, 603, this.loc, this.compositorName);
        spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
      }
      else
      {
    ...
    case 8: 
      ...
      {
        NGCCHandler h = new elementDeclBody(this, this._source, this.$runtime, 579, this.loc, false);
        spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
      }
      else
      {
    ...
    case 3: 
      ...
      {
        NGCCHandler h = new wildcardBody(this, this._source, this.$runtime, 573, this.wloc);
        spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
      }
      else
      {
    ...
    case 11: 
      if (($__uri.equals("http://www.w3.org/2001/XMLSchema")) && ($__local.equals("annotation")))
      {
        NGCCHandler h = new annotation(this, this._source, this.$runtime, 582, null, AnnotationContext.PARTICLE);
        spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
      }
      else
      {
    ...
    throws SAXException
  {
    ...
    case 0: 
      ...
      break;
    case 3: 
      if ((($__uri.equals("http://www.w3.org/2001/XMLSchema")) && ($__local.equals("any"))) || ((($ai = this.$runtime.getAttributeIndex("", "processContents")) >= 0) && ($__uri.equals("http://www.w3.org/2001/XMLSchema")) && ($__local.equals("any"))) || ((($ai = this.$runtime.getAttributeIndex("", "namespace")) >= 0) && ($__uri.equals("http://www.w3.org/2001/XMLSchema")) && ($__local.equals("any"))))
      {
        NGCCHandler h = new wildcardBody(this, this._source, this.$runtime, 573, this.wloc);
        spawnChildFromLeaveElement(h, $__uri, $__local, $__qname);
      }
    ...
    throws SAXException
  {
    ...
    case 8: 
      ...
      else if ((($__uri.equals("")) && ($__local.equals("default"))) || (($__uri.equals("")) && ($__local.equals("block"))) || (($__uri.equals("")) && ($__local.equals("fixed"))) || (($__uri.equals("")) && ($__local.equals("form"))) || (($__uri.equals("")) && ($__local.equals("final"))) || (($__uri.equals("")) && ($__local.equals("abstract"))) || (($__uri.equals("")) && ($__local.equals("name"))))
      {
        NGCCHandler h = new elementDeclBody(this, this._source, this.$runtime, 579, this.loc, false);
        spawnChildFromEnterAttribute(h, $__uri, $__local, $__qname);
      }
    ...
    throws SAXException
  {
    ...
    case 26: 
      ...
      else if (($ai = this.$runtime.getAttributeIndex("", "maxOccurs")) >= 0)
      {
        NGCCHandler h = new occurs(this, this._source, this.$runtime, 599);
        spawnChildFromText(h, $value);
      }
    ...
    case 10: 
      ...
      break;
    case 14: 
      NGCCHandler h = new qname(this, this._source, this.$runtime, 585);
      spawnChildFromText(h, $value);
    ...
    case 3: 
      ...
      break;
    case 24: 
      NGCCHandler h = new qname(this, this._source, this.$runtime, 597);
      spawnChildFromText(h, $value);
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\sun\xml\xsom\impl\parser\state\particle.class
