  ...
  extends NGCCHandler
{
    ...
    throws SAXException
  {
    ...
    case 2: 
      ...
      {
        NGCCHandler h = new annotation(this, this._source, this.$runtime, 3, null, AnnotationContext.SCHEMA);
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\sun\xml\xsom\impl\parser\state\importDecl.class
