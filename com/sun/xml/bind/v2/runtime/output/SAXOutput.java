  ...
  extends XmlOutputAbstractImpl
{
  ...
  public void text(String value, boolean needsSP)
  ...
  public void text(Pcdata value, boolean needsSP)
    throws IOException, SAXException, XMLStreamException
  {
    int vlen = value.length();
    if (this.buf.length <= vlen) {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\sun\xml\bind\v2\runtime\output\SAXOutput.class
