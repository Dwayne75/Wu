  ...
  extends InternalBridge<T>
{
  ...
  public void marshal(Marshaller _m, T t, XMLStreamWriter output)
  ...
  public void marshal(Marshaller _m, T t, OutputStream output, NamespaceContext nsContext)
    throws JAXBException
  {
    MarshallerImpl m = (MarshallerImpl)_m;
  ...
  public void marshal(Marshaller _m, T t, Node output)
    throws JAXBException
  {
    MarshallerImpl m = (MarshallerImpl)_m;
  ...
  public void marshal(Marshaller _m, T t, ContentHandler contentHandler)
    throws JAXBException
  {
    MarshallerImpl m = (MarshallerImpl)_m;
  ...
  public void marshal(Marshaller _m, T t, Result result)
    throws JAXBException
  {
    MarshallerImpl m = (MarshallerImpl)_m;
  ...
  @NotNull
  public T unmarshal(Unmarshaller _u, XMLStreamReader in)
    throws JAXBException
  {
  ...
  @NotNull
  public T unmarshal(Unmarshaller _u, Source in)
    throws JAXBException
  {
    UnmarshallerImpl u = (UnmarshallerImpl)_u;
    return (T)((JAXBElement)u.unmarshal0(in, this.bi)).getValue();
  ...
  @NotNull
  public T unmarshal(Unmarshaller _u, InputStream in)
    throws JAXBException
  {
    UnmarshallerImpl u = (UnmarshallerImpl)_u;
    return (T)((JAXBElement)u.unmarshal0(in, this.bi)).getValue();
  ...
  @NotNull
  public T unmarshal(Unmarshaller _u, Node n)
    throws JAXBException
  {
    UnmarshallerImpl u = (UnmarshallerImpl)_u;
  ...
  public void marshal(T value, XMLSerializer out)
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\sun\xml\bind\v2\runtime\BridgeImpl.class
