...
public class MailcapFile
{
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      parse(new BufferedReader(reader)); return;
    }
    finally
    {
      if (reader != null) {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\sun\activation\registries\MailcapFile.class
