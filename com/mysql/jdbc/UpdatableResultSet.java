  ...
  extends ResultSetImpl
{
    ...
    throws SQLException
  {
    ...
    else
    {
      for (int i = 0; i < numKeys; i++)
      {
        byte[] currentVal = (byte[])this.thisRow.getColumnValue(((Integer)this.primaryKeyIndicies.get(i)).intValue());
        if (currentVal != null) {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\mysql\jdbc\UpdatableResultSet.class
