...
public abstract class Equivalence<T>
{
    ...
    implements Serializable
  {
    ...
    {
      String str1 = String.valueOf(String.valueOf(this.equivalence));String str2 = String.valueOf(String.valueOf(this.reference));return 7 + str1.length() + str2.length() + str1 + ".wrap(" + str2 + ")";
    }
  }
    ...
    implements Predicate<T>, Serializable
  {
    ...
    public String toString()
    {
      String str1 = String.valueOf(String.valueOf(this.equivalence));String str2 = String.valueOf(String.valueOf(this.target));return 15 + str1.length() + str2.length() + str1 + ".equivalentTo(" + str2 + ")";
    }
  }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\google\common\base\Equivalence.class
