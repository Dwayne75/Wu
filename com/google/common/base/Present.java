  ...
  extends Optional<T>
{
  ...
  {
    String str = String.valueOf(String.valueOf(this.reference));return 13 + str.length() + "Optional.of(" + str + ")";
  }
}


/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\google\common\base\Present.class
