  ...
  implements Closeable
{
    ...
    implements FinalizableReferenceQueue.FinalizerLoader
  {
      ...
      throws java.io.IOException
    {
      ...
      //   2: bipush 46
      //   4: bipush 47
      //   6: invokevirtual 11	java/lang/String:replace	(CC)Ljava/lang/String;
      //   9: invokestatic 12	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
      //   12: ldc 13
      //   14: invokevirtual 14	java/lang/String:concat	(Ljava/lang/String;)Ljava/lang/String;
      //   17: astore_1
      //   18: aload_0
      //   19: invokevirtual 15	java/lang/Object:getClass	()Ljava/lang/Class;
      //   22: invokevirtual 16	java/lang/Class:getClassLoader	()Ljava/lang/ClassLoader;
      //   25: aload_1
      //   26: invokevirtual 17	java/lang/ClassLoader:getResource	(Ljava/lang/String;)Ljava/net/URL;
      //   29: astore_2
      //   30: aload_2
      //   31: ifnonnull +12 -> 43
      //   34: new 18	java/io/FileNotFoundException
      //   37: dup
      //   38: aload_1
      //   39: invokespecial 19	java/io/FileNotFoundException:<init>	(Ljava/lang/String;)V
      //   42: athrow
      //   43: aload_2
      //   44: invokevirtual 20	java/net/URL:toString	()Ljava/lang/String;
      //   47: astore_3
      //   48: aload_3
      //   49: aload_1
      //   50: invokevirtual 21	java/lang/String:endsWith	(Ljava/lang/String;)Z
      //   53: ifne +39 -> 92
      //   56: new 22	java/io/IOException
      //   59: dup
      //   60: ldc 23
      //   62: aload_3
      //   63: invokestatic 12	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
      //   66: dup
      //   67: invokevirtual 24	java/lang/String:length	()I
      //   70: ifeq +9 -> 79
      //   73: invokevirtual 14	java/lang/String:concat	(Ljava/lang/String;)Ljava/lang/String;
      //   76: goto +12 -> 88
      //   79: pop
      //   80: new 25	java/lang/String
      //   83: dup_x1
      //   84: swap
      //   85: invokespecial 26	java/lang/String:<init>	(Ljava/lang/String;)V
      //   88: invokespecial 27	java/io/IOException:<init>	(Ljava/lang/String;)V
      //   91: athrow
      //   92: aload_3
      //   93: iconst_0
      //   94: aload_3
      //   95: invokevirtual 24	java/lang/String:length	()I
      //   98: aload_1
      //   99: invokevirtual 24	java/lang/String:length	()I
      //   102: isub
      //   103: invokevirtual 28	java/lang/String:substring	(II)Ljava/lang/String;
      //   106: astore_3
      //   107: new 29	java/net/URL
      //   110: dup
      //   111: aload_2
      //   112: aload_3
      //   113: invokespecial 30	java/net/URL:<init>	(Ljava/net/URL;Ljava/lang/String;)V
      //   116: areturn
      // Line number table:
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\google\common\base\FinalizableReferenceQueue.class
