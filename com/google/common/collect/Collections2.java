...
public final class Collections2
{
    ...
    extends AbstractCollection<List<E>>
  {
    ...
    {
      String str = String.valueOf(String.valueOf(this.inputList));return 30 + str.length() + "orderedPermutationCollection(" + str + ")";
    }
  }
    ...
    extends AbstractCollection<List<E>>
  {
    ...
    public String toString()
    {
      String str = String.valueOf(String.valueOf(this.inputList));return 14 + str.length() + "permutations(" + str + ")";
    }
  }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\google\common\collect\Collections2.class
