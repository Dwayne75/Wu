...
public final class Maps
{
    ...
    implements MapDifference.ValueDifference<V>
  {
    ...
    public String toString()
    {
      String str1 = String.valueOf(String.valueOf(this.left));String str2 = String.valueOf(String.valueOf(this.right));return 4 + str1.length() + str2.length() + "(" + str1 + ", " + str2 + ")";
    }
  }
    ...
    implements Serializable
  {
    ...
    public String toString()
    {
      String str = String.valueOf(String.valueOf(this.bimap));return 18 + str.length() + "Maps.asConverter(" + str + ")";
    }
  }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\google\common\collect\Maps.class
