  ...
  implements Comparable<Cut<C>>, Serializable
{
    ...
    extends Cut<C>
  {
    ...
    public String toString()
    {
      String str = String.valueOf(String.valueOf(this.endpoint));return 2 + str.length() + "\\" + str + "/";
    }
  }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\google\common\collect\Cut.class
