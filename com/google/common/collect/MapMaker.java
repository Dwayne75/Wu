  ...
  extends GenericMapMaker<Object, Object>
{
  ...
  public String toString()
  {
    ...
    {
      l = this.expireAfterWriteNanos;s.add("expireAfterWrite", 22 + l + "ns");
    }
    if (this.expireAfterAccessNanos != -1L)
    {
      l = this.expireAfterAccessNanos;s.add("expireAfterAccess", 22 + l + "ns");
    }
    ...
    implements Serializable
  {
    ...
    public V get(Object key)
    {
      ...
      if (value == null)
      {
        e = String.valueOf(String.valueOf(this.computingFunction));cause = String.valueOf(String.valueOf(key));throw new NullPointerException(24 + e.length() + cause.length() + e + " returned null for key " + cause + ".");
      }
      return value;
    }
  }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\google\common\collect\MapMaker.class
