...
public abstract class BaseEncoding
{
          ...
          throws IOException
        {
          for (;;)
          {
            ...
            if (readChar == -1)
            {
              ...
              {
                int i = this.readChars;throw new BaseEncoding.DecodingException(32 + "Invalid input length " + i);
              }
              return -1;
            }
            this.readChars += 1;
            ...
            if (this.paddingMatcher.matches(ch))
            {
              ...
              {
                j = this.readChars;throw new BaseEncoding.DecodingException(41 + "Padding cannot start at index " + j);
              }
            ...
            else
            {
              if (this.hitPadding)
              {
                j = ch;int k = this.readChars;throw new BaseEncoding.DecodingException(61 + "Expected padding character but found '" + j + "' at index " + k);
              }
    ...
    extends BaseEncoding
  {
    ...
    public String toString()
    {
      String str1 = String.valueOf(String.valueOf(this.delegate.toString()));String str2 = String.valueOf(String.valueOf(this.separator));int i = this.afterEveryChars;return 31 + str1.length() + str2.length() + str1 + ".withSeparator(\"" + str2 + "\", " + i + ")";
    }
  }
}


/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\google\common\io\BaseEncoding.class
