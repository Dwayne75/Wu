  ...
  implements GenericDeclaration
{
    ...
    extends Invokable<T, T>
  {
      ...
      throws InvocationTargetException, IllegalAccessException
    {
      ...
      {
        String str = String.valueOf(String.valueOf(this.constructor));throw new RuntimeException(8 + str.length() + str + " failed.", e);
      }
    }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\google\common\reflect\Invokable.class
