    ...
    Type capture(Type type)
    {
      ...
      if ((type instanceof WildcardType))
      {
        ...
        if (lowerBounds.length == 0)
        {
          ...
          int i = this.id.incrementAndGet();String str1 = String.valueOf(String.valueOf(Joiner.on('&').join(upperBounds)));String name = 33 + str1.length() + "capture#" + i + "-of ? extends " + str1;
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\google\common\reflect\TypeResolver.class
