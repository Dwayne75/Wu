  ...
  implements Serializable
{
  ...
  {
    int i = this.c;int j = this.d;long l1 = this.k0;long l2 = this.k1;return 81 + "Hashing.sipHash" + i + j + "(" + l1 + ", " + l2 + ")";
  }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\google\common\hash\SipHashFunction.class
