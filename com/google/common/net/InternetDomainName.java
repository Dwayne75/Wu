...
public final class InternetDomainName
{
  ...
  {
    String str1 = String.valueOf(String.valueOf((String)Preconditions.checkNotNull(leftParts)));String str2 = String.valueOf(String.valueOf(this.name));return from(1 + str1.length() + str2.length() + str1 + "." + str2);
  }
