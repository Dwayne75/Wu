...
public abstract class RateLimiter
{
  ...
  public final double getRate()
  {
    // Byte code:
    //   0: aload_0
    //   1: invokespecial 21	com/google/common/util/concurrent/RateLimiter:mutex	()Ljava/lang/Object;
    //   4: dup
    //   5: astore_1
    //   6: monitorenter
    //   7: aload_0
    //   8: invokevirtual 24	com/google/common/util/concurrent/RateLimiter:doGetRate	()D
    //   11: aload_1
    //   12: monitorexit
    //   13: dreturn
    //   14: astore_2
  ...
  final long reserve(int permits)
  {
    // Byte code:
    //   0: iload_1
    //   1: invokestatic 30	com/google/common/util/concurrent/RateLimiter:checkPermits	(I)I
    //   4: pop
    //   5: aload_0
    //   6: invokespecial 21	com/google/common/util/concurrent/RateLimiter:mutex	()Ljava/lang/Object;
    //   9: dup
    //   10: astore_2
    //   11: monitorenter
    //   12: aload_0
    //   13: iload_1
    //   14: aload_0
    //   15: getfield 17	com/google/common/util/concurrent/RateLimiter:stopwatch	Lcom/google/common/util/concurrent/RateLimiter$SleepingStopwatch;
    //   18: invokevirtual 22	com/google/common/util/concurrent/RateLimiter$SleepingStopwatch:readMicros	()J
    //   21: invokevirtual 31	com/google/common/util/concurrent/RateLimiter:reserveAndGetWaitLength	(IJ)J
    //   24: aload_2
    //   25: monitorexit
    //   26: lreturn
    //   27: astore_3
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\google\common\util\concurrent\RateLimiter.class
