...
public class CycleDetectingLockFactory
{
  ...
  private static class LockGraphNode
  {
    ...
    void checkAcquiredLock(CycleDetectingLockFactory.Policy policy, LockGraphNode acquiredLock)
    {
      ...
      //   10: ldc 15
      //   12: aload_2
      //   13: invokevirtual 16	com/google/common/util/concurrent/CycleDetectingLockFactory$LockGraphNode:getLockName	()Ljava/lang/String;
      //   16: invokestatic 17	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
      //   19: dup
      //   20: invokevirtual 18	java/lang/String:length	()I
      //   23: ifeq +9 -> 32
      //   26: invokevirtual 19	java/lang/String:concat	(Ljava/lang/String;)Ljava/lang/String;
      //   29: goto +12 -> 41
      //   32: pop
      //   33: new 9	java/lang/String
      //   36: dup_x1
      //   37: swap
      //   38: invokespecial 20	java/lang/String:<init>	(Ljava/lang/String;)V
      //   41: invokestatic 21	com/google/common/base/Preconditions:checkState	(ZLjava/lang/Object;)V
      //   44: aload_0
      //   45: getfield 6	com/google/common/util/concurrent/CycleDetectingLockFactory$LockGraphNode:allowedPriorLocks	Ljava/util/Map;
      //   48: aload_2
      //   49: invokeinterface 22 2 0
      //   54: ifeq +4 -> 58
      //   57: return
      //   58: aload_0
      //   59: getfield 7	com/google/common/util/concurrent/CycleDetectingLockFactory$LockGraphNode:disallowedPriorLocks	Ljava/util/Map;
      //   62: aload_2
      //   63: invokeinterface 23 2 0
      //   68: checkcast 24	com/google/common/util/concurrent/CycleDetectingLockFactory$PotentialDeadlockException
      //   71: astore_3
      //   72: aload_3
      //   73: ifnull +28 -> 101
      //   76: new 24	com/google/common/util/concurrent/CycleDetectingLockFactory$PotentialDeadlockException
      //   79: dup
      //   80: aload_2
      //   81: aload_0
      //   82: aload_3
      //   83: invokevirtual 25	com/google/common/util/concurrent/CycleDetectingLockFactory$PotentialDeadlockException:getConflictingStackTrace	()Lcom/google/common/util/concurrent/CycleDetectingLockFactory$ExampleStackTrace;
      //   86: aconst_null
      //   87: invokespecial 26	com/google/common/util/concurrent/CycleDetectingLockFactory$PotentialDeadlockException:<init>	(Lcom/google/common/util/concurrent/CycleDetectingLockFactory$LockGraphNode;Lcom/google/common/util/concurrent/CycleDetectingLockFactory$LockGraphNode;Lcom/google/common/util/concurrent/CycleDetectingLockFactory$ExampleStackTrace;Lcom/google/common/util/concurrent/CycleDetectingLockFactory$1;)V
      //   90: astore 4
      //   92: aload_1
      //   93: aload 4
      //   95: invokeinterface 27 2 0
      //   100: return
      //   101: invokestatic 28	com/google/common/collect/Sets:newIdentityHashSet	()Ljava/util/Set;
      //   104: astore 4
      //   106: aload_2
      //   107: aload_0
      //   108: aload 4
      //   110: invokespecial 29	com/google/common/util/concurrent/CycleDetectingLockFactory$LockGraphNode:findPathTo	(Lcom/google/common/util/concurrent/CycleDetectingLockFactory$LockGraphNode;Ljava/util/Set;)Lcom/google/common/util/concurrent/CycleDetectingLockFactory$ExampleStackTrace;
      //   113: astore 5
      //   115: aload 5
      //   117: ifnonnull +26 -> 143
      //   120: aload_0
      //   121: getfield 6	com/google/common/util/concurrent/CycleDetectingLockFactory$LockGraphNode:allowedPriorLocks	Ljava/util/Map;
      //   124: aload_2
      //   125: new 30	com/google/common/util/concurrent/CycleDetectingLockFactory$ExampleStackTrace
      //   128: dup
      //   129: aload_2
      //   130: aload_0
      //   131: invokespecial 31	com/google/common/util/concurrent/CycleDetectingLockFactory$ExampleStackTrace:<init>	(Lcom/google/common/util/concurrent/CycleDetectingLockFactory$LockGraphNode;Lcom/google/common/util/concurrent/CycleDetectingLockFactory$LockGraphNode;)V
      //   134: invokeinterface 32 3 0
      //   139: pop
      //   140: goto +38 -> 178
      //   143: new 24	com/google/common/util/concurrent/CycleDetectingLockFactory$PotentialDeadlockException
      //   146: dup
      //   147: aload_2
      //   148: aload_0
      //   149: aload 5
      //   151: aconst_null
      //   152: invokespecial 26	com/google/common/util/concurrent/CycleDetectingLockFactory$PotentialDeadlockException:<init>	(Lcom/google/common/util/concurrent/CycleDetectingLockFactory$LockGraphNode;Lcom/google/common/util/concurrent/CycleDetectingLockFactory$LockGraphNode;Lcom/google/common/util/concurrent/CycleDetectingLockFactory$ExampleStackTrace;Lcom/google/common/util/concurrent/CycleDetectingLockFactory$1;)V
      //   155: astore 6
      //   157: aload_0
      //   158: getfield 7	com/google/common/util/concurrent/CycleDetectingLockFactory$LockGraphNode:disallowedPriorLocks	Ljava/util/Map;
      //   161: aload_2
      //   162: aload 6
      //   164: invokeinterface 32 3 0
      //   169: pop
      //   170: aload_1
      //   171: aload 6
      //   173: invokeinterface 27 2 0
      //   178: return
      // Line number table:
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\google\common\util\concurrent\CycleDetectingLockFactory.class
