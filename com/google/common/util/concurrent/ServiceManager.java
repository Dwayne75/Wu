...
public final class ServiceManager
{
  ...
  private static final class ServiceManagerState
  {
    ...
    void checkHealthy()
    {
      if (this.states.count(Service.State.RUNNING) != this.numberOfServices)
      {
        String str = String.valueOf(String.valueOf(Multimaps.filterKeys(this.servicesByState, Predicates.not(Predicates.equalTo(Service.State.RUNNING)))));IllegalStateException exception = new IllegalStateException(79 + str.length() + "Expected to be healthy after starting. The following services are not running: " + str);
    ...
    extends Service.Listener
  {
    ...
    public void failed(Service.State from, Throwable failure)
    {
      ...
      if (state != null)
      {
        if (!(this.service instanceof ServiceManager.NoOpService))
        {
          String str1 = String.valueOf(String.valueOf(this.service));String str2 = String.valueOf(String.valueOf(from));ServiceManager.logger.log(Level.SEVERE, 34 + str1.length() + str2.length() + "Service " + str1 + " has failed in the " + str2 + " state.", failure);
        }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\google\common\util\concurrent\ServiceManager.class
