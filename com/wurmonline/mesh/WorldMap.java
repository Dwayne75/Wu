...
public final class WorldMap
{
  ...
  protected void freeChunk(int x, int y)
    throws IOException
  {
    if (this.chunks[x][y] != null)
    {
      ...
      {
        long pos = (x + y * this.width) * 16384L + 12L;
  ...
  public static WorldMap getWorldMap(File file)
    throws IOException
  {
    if (file.exists())
    {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\mesh\WorldMap.class
