...
public final class BushData
{
  ...
  {
    LAVENDER(0, (byte)46, 4, 142, 148, 154, 1.0F, 1.0F, 0.0F, "model.bush.lavendel", 0, 0, true),  ROSE(1, (byte)47, 5, 143, 149, 155, 2.0F, 1.0F, 0.0F, "model.bush.rose", 1, 0, true),  THORN(2, (byte)48, 15, 144, 150, 156, 0.5F, 0.5F, 0.0F, "model.bush.thorn", 2, 0, false),  GRAPE(3, (byte)49, 5, 145, 151, 157, 1.4F, 1.2F, 0.0F, "model.bush.grape", 3, 0, true),  CAMELLIA(4, (byte)50, 3, 146, 152, 158, 1.6F, 1.25F, 0.0F, "model.bush.camellia", 0, 1, true),  OLEANDER(5, (byte)51, 2, 147, 153, 159, 1.55F, 1.45F, 0.0F, "model.bush.oleander", 1, 1, true),  HAZELNUT(6, (byte)71, 2, 160, 161, 162, 1.7F, 1.32F, 0.0F, "model.bush.hazelnut", 2, 1, true),  RASPBERRY(7, (byte)90, 2, 166, 167, 168, 1.7F, 1.32F, 0.0F, "model.bush.raspberry", 3, 1, true),  BLUEBERRY(8, (byte)91, 2, 169, 170, 171, 1.7F, 1.32F, 0.0F, "model.bush.blueberry", 0, 2, true),  LINGONBERRY(9, (byte)92, 2, 172, 172, 172, 1.7F, 1.32F, 0.0F, "model.bush.lingonberry", 1, 2, true);
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\mesh\BushData.class
