  ...
  public void slerp(Quaternion q1, Quaternion q2, float interp)
  {
    ...
    if (1.0D + cosom > 1.0E-8D)
    {
      ...
      if (1.0D - cosom > 1.0E-8D)
      {
        ...
        double sclq1 = Math.sin((1.0D - interp) * omega) / sinom;
    ...
    double sclq1 = Math.sin((1.0D - interp) * 0.5D * 3.141592653589793D);
    double sclq2 = Math.sin(interp * 0.5D * 3.141592653589793D);
    for (i = 0; i < 3; i++) {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\math\Quaternion.class
