    ...
    Thread statsPoller = new Thread("StatsPoller")
    {
      public void run()
      {
        try
        {
          ...
          int numberSkillsLoaded = SkillStat.access$000();
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\server\skills\SkillStat.class
