    ...
    new Thread()
    {
      public void run()
      {
        ...
        try
        {
          ...
          WcDemotion.logger.log(Level.INFO, WcDemotion.this.senderWurmId + " attempting demotion of " + WcDemotion.this.targetWurmId + ", response=" + 
            WcDemotion.this.responseMsg);
          if (WcDemotion.this.responseMsg.length() == 0)
          {
            ...
            {
              WcDemotion.logger.log(Level.INFO, WcDemotion.this.senderWurmId + " triggered demotion for " + (WcDemotion.this.demoteType == 1 ? "CA" : "CM") + " id " + 
              ...
              WcDemotion.logger.log(Level.INFO, 
                WcDemotion.this.senderWurmId + " sending response back to server " + WurmId.getOrigin(WcDemotion.this.getWurmId()));
            }
          }
          else
          {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\server\webinterface\WcDemotion.class
