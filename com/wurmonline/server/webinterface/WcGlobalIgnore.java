  ...
  public void execute()
  {
    new Thread()
    {
      public void run()
      {
        ...
        if (Servers.isThisATestServer()) {
          WcGlobalIgnore.logger.log(Level.INFO, WcGlobalIgnore.this.senderWurmId + "(" + WcGlobalIgnore.this.ignorerName + ") attempting ignore for " + WcGlobalIgnore.this.targetWurmId + " (" + WcGlobalIgnore.this.ignoreTarget + "), response=" + 
            WcGlobalIgnore.this.response + ", Ignore=" + WcGlobalIgnore.this.startIgnore + ", UnIgnore=" + WcGlobalIgnore.this.startUnIgnore);
        }
        if (!WcGlobalIgnore.this.response)
        {
          ...
          if ((pinf.loaded) && ((!Servers.isThisLoginServer()) || (pinf.getCurrentServer() == Servers.getLocalServerId())))
          {
            ...
            {
              WcGlobalIgnore.logger.log(Level.INFO, 
                WcGlobalIgnore.this.senderWurmId + " (" + WcGlobalIgnore.this.ignorerName + ") unignoring " + WcGlobalIgnore.this.targetWurmId + " (" + WcGlobalIgnore.this.ignoreTarget + ")");
            ...
            {
              WcGlobalIgnore.logger.log(Level.INFO, 
                WcGlobalIgnore.this.senderWurmId + " (" + WcGlobalIgnore.this.ignorerName + ") Cannot ignore " + WcGlobalIgnore.this.targetWurmId + " (" + WcGlobalIgnore.this.ignoreTarget + ") as they can mute.");
            ...
            WcGlobalIgnore.logger.log(Level.INFO, 
              WcGlobalIgnore.this.senderWurmId + " (" + WcGlobalIgnore.this.ignorerName + ") sending response back to server " + WurmId.getOrigin(WcGlobalIgnore.this.getWurmId()));
          ...
          {
            WcGlobalIgnore.logger.log(Level.INFO, 
              WcGlobalIgnore.this.senderWurmId + " (" + WcGlobalIgnore.this.ignorerName + ") redirecting of  " + WcGlobalIgnore.this.targetWurmId + " (" + WcGlobalIgnore.this.ignoreTarget + ") to " + pinf
              .getCurrentServer());
          ...
          {
            WcGlobalIgnore.logger.log(Level.INFO, 
              WcGlobalIgnore.this.senderWurmId + " (" + WcGlobalIgnore.this.ignorerName + ") sending response back to server as cannot find player " + WurmId.getOrigin(WcGlobalIgnore.this.getWurmId()));
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\server\webinterface\WcGlobalIgnore.class
