    ...
    new Thread()
    {
      public void run()
      {
        ...
        if ((WcTicket.this.type == 1) && (Servers.isThisLoginServer()))
        {
          ...
          wt = new WcTicket(WcTicket.this.firstBatchNos, WcTicket.this.secondBatchNos);
        ...
        else if (WcTicket.this.type != 3)
        {
          ...
          {
            wt = Tickets.getTicketsChangedSince(WcTicket.this.checkDate);ticketDate = wt.length;
            for (long l1 = 0; l1 < ticketDate; l1++)
            {
              Ticket t = wt[l1];
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\server\webinterface\WcTicket.class
