    ...
    new Thread()
    {
      public void run()
      {
        ...
        try
        {
          ...
          if (isResponse(WcGetHeroes.this.response))
          {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\server\webinterface\WcGetHeroes.class
