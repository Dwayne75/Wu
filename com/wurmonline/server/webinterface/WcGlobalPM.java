        ...
        else if (WcGlobalPM.this.action == 3)
        {
          ...
          if (pInfo.currentServer == Servers.getLocalServerId())
          {
            try
            {
              ...
              if (!p.sendPM(WcGlobalPM.this.power, WcGlobalPM.this.senderName, WcGlobalPM.this.senderId, WcGlobalPM.this.friend, 
                WcGlobalPM.this.message, WcGlobalPM.this.emote, WcGlobalPM.this.kingdom, WurmId.getOrigin(WcGlobalPM.this.getWurmId()), WcGlobalPM.this.override))
              {
                WcGlobalPM wgi = new WcGlobalPM(WurmId.getNextWCCommandId(), (byte)6, WcGlobalPM.this.power, WcGlobalPM.this.senderId, WcGlobalPM.this.senderName, WcGlobalPM.this.kingdom, WcGlobalPM.this.targetServerId, WcGlobalPM.this.targetId, WcGlobalPM.this.targetName, WcGlobalPM.this.friend, WcGlobalPM.this.message, WcGlobalPM.this.emote, WcGlobalPM.this.override);
                wgi.sendToServer(WurmId.getOrigin(WcGlobalPM.this.getWurmId()));
              }
              else if (p.isAFK())
              {
                WcGlobalPM wgi = new WcGlobalPM(WurmId.getNextWCCommandId(), (byte)7, WcGlobalPM.this.power, WcGlobalPM.this.senderId, WcGlobalPM.this.senderName, WcGlobalPM.this.kingdom, WcGlobalPM.this.targetServerId, WcGlobalPM.this.targetId, WcGlobalPM.this.targetName, WcGlobalPM.this.friend, p.getAFKMessage(), true, WcGlobalPM.this.override);
                wgi.sendToServer(WurmId.getOrigin(WcGlobalPM.this.getWurmId()));
              }
            }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\server\webinterface\WcGlobalPM.class
