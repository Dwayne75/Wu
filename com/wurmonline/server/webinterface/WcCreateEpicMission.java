    ...
    new Thread()
    {
      public void run()
      {
        ...
        try
        {
          ...
          es.generateNewMissionForEpicEntity((int)WcCreateEpicMission.this.entityNumber, WcCreateEpicMission.this.entityName, WcCreateEpicMission.this.difficulty, (int)WcCreateEpicMission.this.maxTimeSeconds, 
            WcCreateEpicMission.this.scenarioName, WcCreateEpicMission.this.scenarioNumber, WcCreateEpicMission.this.scenarioQuest, WcCreateEpicMission.this.destroyPreviousMissions);
        }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\server\webinterface\WcCreateEpicMission.class
