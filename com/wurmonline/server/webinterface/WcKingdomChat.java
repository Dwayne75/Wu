    ...
    new Thread()
    {
      public void run()
      {
        ...
        try
        {
          ...
          Players.getInstance().sendGlobalKingdomMessage(null, WcKingdomChat.this.senderId, WcKingdomChat.this.sender, WcKingdomChat.this.message, WcKingdomChat.this.emote, WcKingdomChat.this.kingdom, WcKingdomChat.this.colorR, 
            WcKingdomChat.this.colorG, WcKingdomChat.this.colorB);
        }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\server\webinterface\WcKingdomChat.class
