  ...
  implements HighwayConstants
{
  ...
  void calculate()
  {
    if (this.destinationVillage == null)
    {
      ...
      HashSet<Distanced> distanceSet = new HashSet();
      ...
      Distanced[] distanced = (Distanced[])distanceSet.toArray(new Distanced[distanceSet.size()]);
      
      Arrays.sort(distanced, new Comparator()
      {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\server\highways\PathToCalculate.class
