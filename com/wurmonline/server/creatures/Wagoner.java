  ...
  implements MiscConstants, TimeConstants
{
  ...
  {
    YAWNS((byte)16, 0, true, "Yawns!", true, "Yawns!", true, "Yawns!", true, "Yawns!"),  BED((byte)16, 0, false, "Going to bed before I fall asleep in my chair.", false, "Falling asleep in a chair, I'm getting old. Time for bed!", false, "Time to sleep so I can do it all over again tomorrow, lucky me.", false, "It's been a great day, but time for sleep!"),  ZZZZ((byte)16, 0, true, "zzzZzzzZzz.", true, "zzzZzzZzzz.", true, "zzzzzZzzZz.", true, "zzZzzzzzZz."),  GETUP((byte)16, 0, false, "Time to get up already?", false, "I don't wanna go to school Muuummm... Never mind, I'm up, I'm up, ignore that.", false, "It's too early, why am I up!", false, "Early bird gets the wurm!"),  SLEPT_IN((byte)16, 0, false, "Looks like I slept in!", false, "I swear I just closed my eyes for a few seconds.", false, "Yeesh, can't I sleep in some days without the third degree?", false, "Oops, looks like I was a bit of a sleepy head!"),  MORNING((byte)16, 0, false, "Morning all.", false, "Don't talk to me until I've had my... I don't know.", false, "Yeah yeah, morning, nothing good about it.", false, "Good morning everyone, I hope you have a great day - I know I will!"),  BREAKFAST((byte)4, 0, false, "Ah breakfast!", false, "Is that growling a bear or am I just hungry?", false, "Finally breakfast, let's hope this is better than the last meal.", false, "Breakfast time! What did I get today, I hope it's my favourite."),  LUNCH((byte)4, 0, false, "I hope it's chips.", false, "One can never have too many sandwiches for lunch, unless you have more than two.", false, "Lunch, the one good thing about daytime.", false, "Lunch time! The day goes by so fast when you're having fun."),  DINNER((byte)4, 0, false, "Hog roast, that's what to do with roadkill!", false, "Why can't I eat dinner at a table?", false, "I'm so over spider meat soup.", false, "Dinnertime! Time to use those mushrooms I foraged!"),  DELIVERY((byte)8, 0, false, "Woo hoo, a delivery to do!", false, "Another delivery? Why didn't I listen to my mother and become a carpenter.", false, "Another one? Really? Really?!?", false, "Woo hoo, a delivery to do!"),  SUMMON((byte)8, 0, true, "Cracks a whip, and four wagon creatures appear.", true, "Cracks a whip, and four wagon creatures appear.", true, "Cracks a whip, and four wagon creatures appear.", true, "Cracks a whip, and four wagon creatures appear."),  START_DELIVERY((byte)8, 0, false, "And off I go.", false, "And I'm off like a sausage in the sun.", false, "The sooner I do this the sooner it's over.", false, "Another adventure, I'm excited!"),  LOADING((byte)8, 1, false, "Loading %s.", false, "%s to go in the load, some crates to go. You take one out and load it about, one less crate to go in the load.", false, "%s? Couldn't have made it fewer?", false, "Wow, %s, that's a lot! Someone is going to be happy to receive them all."),  UNLOADING((byte)8, 2, false, "Delivery of %s for %s.", false, "I have %s for %s here, and I only peeked in one of them!", false, "I've got %s for %s here, and they're not going to unload themselves.", false, "HI! I have %s here for %s!"),  DELIVERY_DONE((byte)8, 0, false, "Delivery done, off back home now.", false, "Well, I'm not paid by the hour, time to get going... We should form a union!", false, "Right, that's all of them.  Not here to chat, I'm off.", false, "And that's all of them, I'm off back home.  Have a great day!"),  SEND_TO_VOID((byte)8, 0, true, "Cracks a whip and the wagoner creatures vanish.", true, "Cracks a whip and the wagoner creatures vanish.", true, "Cracks a whip and the wagoner creatures vanish.", true, "Cracks a whip and the wagoner creatures vanish."),  ARRIVED((byte)8, 0, false, "Yay, I've arrived!", false, "What has two thumbs and crates for you?  This wagoner!", false, "All right, all right, I'm here, quit nagging.", false, "I've arrived, and what a beautiful place you have!"),  REPAIR((byte)8, 0, true, "Cleaning the wagon.", false, "Someone scratched my paint job. But it looks better now!.", false, "Another scratch! More work as i'll just have to polish it out.", false, "A scratch, it looks just like a flame!"),  ERROR_VANISHED((byte)2, 0, false, "Delivery vanished, so parking up!", false, "Delivery vanished, so parking up!", false, "Delivery vanished, so parking up!", false, "Delivery vanished, so parking up!"),  ERROR_NO_ROUTE((byte)2, 0, false, "no eye dear!", false, "no eye dear!", false, "no eye dear!", false, "no eye dear!"),  ERROR_STUCK((byte)2, 0, false, "I seem to have stopped moving; maybe I'm stuck?", false, "Is it just me or did the scenery stop moving by?", false, "Ugh, it better not be a broken wheel!", false, "Oh no, it looks like I'm stuck!"),  TEST_STOP((byte)1, 0, false, "Ok, ok, stopping here!", false, "Right here, like this?", false, "Not going to go any further.", false, "Looks like it's time to stop!"),  TEST_GET_READY((byte)1, 0, false, "Ok, ok, i'll get ready for delivery.", false, "Let me go put on my makeup and get ready.", false, "Ugh, guess I better get ready to deliver.", false, "Yay another delivery, I'll get ready as quick as can be!"),  TEST_SLEEP((byte)1, 0, false, "Ok, ok, i'll go to sleep.", false, "Bedtime? Now? But it's not even dark!", false, "Right, nothing worth staying up for, bedtime.", false, "Bedtime? I agree, goodnight!"),  TEST_GETUP((byte)1, 0, false, "Stop poking me, I'll get up.", false, "Didn't your mother tell you not to spoke a sleeping person? You must have been an annoying child.", false, "Poke me with that again and you'll lose it!", false, "Stop poking me, it tickles! I'll get up and ready!"),  TEST_NOWHERE_TO_GO((byte)1, 0, false, "Nowhere to go... Must have been a test of getting ready, waiting for next command.", false, "Wait a minute, there's nowhere to go! You're pranking me arent you!", false, "Are you just pulling my leg with some sort of test?", false, "Oh no, it looks like that was just a test, I'll keep waiting for sure!"),  TEST_DRIVE((byte)1, 0, false, "Ok, ok, I'll drive there.", false, "Over there? You're sorely under-utilising my skills you know.", false, "Alright alright I'm going, quit nagging.", false, "You want me to drive there? Sure thing!"),  TEST_PARK((byte)1, 0, false, "Ok, ok, I'll park up.", false, "Careful, I never learned to parallel park.", false, "All right, all right, I'll park. Jeesh, the nerve of some people.", false, "Park here? Can do!"),  TEST_HOME((byte)1, 0, false, "Guess I'm not wanted anymore, so I'll drive home.", false, "I feel about as welcome as a fart in a plate armour suit, so I'll be going.", false, "Guess no one wants me here, me included. I'm going home.", false, "Don't need me here? That's okay, I'll go home, hope I helped!"),  STUCK_COLLECTING((byte)2, 0, true, "Wonder if I have a puncture.", false, "Beam me up scotty!", false, "Oh no, not stuck again!", false, "Oh I left the handbreak on..."),  STUCK_DELIVERING((byte)2, 0, false, "I have a flat!.", false, "Lucky the wheel is only flat at the bottom!", false, "Oh no, not a flat again!", false, "i get to try my powers out!"),  STUCK_GOING_HOME((byte)2, 0, false, "Looks like I may be home early.", true, "thinks of home!", true, "If only I still had enough karma...", false, "Yay, a use for my karma!");
  ...
  {
    EARLY(4, false, "Getting nice and light.", false, "Was that thunder or my stomach?", false, "I'm so hungry, I could eat a horse!  Even a hell horse!", false, "Breakfast soon!"),  MORNING(5, false, "Morning!", false, "Morning!", false, "Its 5am and all's well!", false, "Its 5am and all's well!", false, "I should be back at camp having breakfast.", false, "I should be back at camp having breakfast.", false, "What a picture when dawn strikes!", false, "If only I was outside, I could see the dawn!"),  LUNCH(11, false, "Almost time for lunch!", false, "Was that thunder or my stomach?", false, "So hungry, I could eat a troll.  Well, most of one, anyway.", false, "Lunch soon!"),  NOON(12, false, "Sun in the sky says it's high noon.", false, "Hard to tell time in the dark, but I think it's noon.", false, "Guess I'll have to eat this packaged spider meal, I wonder what's actually in it?", false, "It's too dark to see what's in this packaged meal, and I think that's for the best.", false, "I hate having to work through lunch.  And when is tea time?", false, "The way this tunnel winds on and on, I'll never get back in time for lunch.", false, "Looks like I'm on the road for lunch today.", false, "Its a good day to have lunch in a tunnel."),  DINNER(17, false, "Almost time for Dinner!", false, "Was that thunder or my stomach?", false, "So hungry, I could eat a bison, horns, tail and all!", false, "Dinner soon!"),  EVENING(20, false, "Getting dark, hope someone has added lamps to the highway?", false, "Getting dark, hope someone has added lamps to the highway!", false, "If it gets much darker I'll be doing a slalom on the highway.", false, "If it gets much darker I'll be doing a slalom on the highway.", false, "Oh, getting dark again, I hate the dark.", false, "Oh, getting dark again, I hate the dark.", false, "I do like seeing the stars!", false, "At least being underground, I dont get distracted by the stars!"),  MIDNIGHT(0, false, "Sure is dark at midnight.", false, "Dark at midnight isn't dark until you're driving in a tunnel.", false, "I'm glad I'm not scared of traveling at night...much...", false, "This tunnel seems a bit spooky at midnight.", false, "Why don't we have bedrolls for those of us who have to travel at night?", false, "I'd like to stretch out in the wagon for a rest along with those crates!", false, "Racing through the night on a delivery run, nothing stops Wurm wagoners!", false, "I don't even notice the late hour when I'm driving through a tunnel like this.");
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\server\creatures\Wagoner.class
