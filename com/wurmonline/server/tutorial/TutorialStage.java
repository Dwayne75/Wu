...
public abstract class TutorialStage
{
  ...
  public String getCurrentBML()
  {
    ...
    return ((TutorialSubStage)this.subStages.get(this.currentSubStage)).getBMLString();
  }
  ...
  public String getUpdateBML()
  {
    ...
    return ((TutorialSubStage)this.subStages.get(this.currentSubStage)).getBMLUpdateString();
  }
  
  public boolean isAwaitingAnyTrigger()
  {
    return ((TutorialSubStage)this.subStages.get(this.currentSubStage)).awaitingTrigger();
  }
  
  public boolean shouldSkipTrigger()
  {
    return (!isAwaitingAnyTrigger()) && (((TutorialSubStage)this.subStages.get(this.currentSubStage)).hadNextTrigger());
  }
  
  public boolean awaitingTrigger(PlayerTutorial.PlayerTrigger trigger)
  {
    return ((TutorialSubStage)this.subStages.get(this.currentSubStage)).hasNextTrigger(trigger);
  }
  
  public void clearTrigger()
  {
    ((TutorialSubStage)this.subStages.get(this.currentSubStage)).clearNextTrigger();
  }
  ...
  public abstract class TutorialSubStage
  {
    ...
    {
      setNextTrigger(PlayerTutorial.PlayerTrigger.NONE);
    }
    ...
    {
      return BMLBuilder.createBMLUpdate(new String[] { BMLBuilder.createButton("next", "Next", 80, 20, true) }).toString();
    }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\server\tutorial\TutorialStage.class
