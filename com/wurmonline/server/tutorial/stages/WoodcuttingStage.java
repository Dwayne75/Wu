  ...
  extends TutorialStage
{
  ...
  {
    this.subStages.add(new CutDownSubStage(getPlayerId()));
    this.subStages.add(new FellTreeSubStage(getPlayerId()));
    this.subStages.add(new CreateLogSubStage(getPlayerId()));
  }
    ...
    extends TutorialStage.TutorialSubStage
  {
    ...
    {
      super(playerId);
      setNextTrigger(PlayerTutorial.PlayerTrigger.CUT_TREE);
    }
    ...
    protected void buildBMLString()
    {
      BMLBuilder builder = BMLBuilder.createBMLBorderPanel(
        ...
        .addText("")
        .addHeader("Woodcutting", Color.LIGHT_GRAY)), null, 
    ...
    extends TutorialStage.TutorialSubStage
  {
    ...
    {
      super(playerId);
      setNextTrigger(PlayerTutorial.PlayerTrigger.FELL_TREE);
    }
    ...
    extends TutorialStage.TutorialSubStage
  {
    ...
    {
      super(playerId);
      setNextTrigger(PlayerTutorial.PlayerTrigger.CREATE_LOG);
    }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\server\tutorial\stages\WoodcuttingStage.class
