  ...
  extends TutorialStage
{
  ...
  {
    this.subStages.add(new FishingStartSubStage(getPlayerId()));
    this.subStages.add(new FishModifiersSubStage(getPlayerId()));
    this.subStages.add(new NettingSubStage(getPlayerId()));
    this.subStages.add(new SpearingSubStage(getPlayerId()));
  }
    ...
    extends TutorialStage.TutorialSubStage
  {
    ...
    protected void buildBMLString()
    {
      BMLBuilder builder = BMLBuilder.createBMLBorderPanel(
        ...
        .addText("")
        .addHeader("Fishing Intro", Color.LIGHT_GRAY)), null, 
    ...
    extends TutorialStage.TutorialSubStage
  {
    ...
    protected void buildBMLString()
    {
      BMLBuilder builder = BMLBuilder.createBMLBorderPanel(
        ...
        BMLBuilder.createVertArrayNode(false)
        .addText("")
        .addHeader("Net Fishing", Color.LIGHT_GRAY)), null, 
    ...
    extends TutorialStage.TutorialSubStage
  {
    ...
    protected void buildBMLString()
    {
      BMLBuilder builder = BMLBuilder.createBMLBorderPanel(
        ...
        BMLBuilder.createVertArrayNode(false)
        .addText("")
        .addHeader("Spear Fishing", Color.LIGHT_GRAY)), null, 
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\server\tutorial\stages\FishingStage.class
