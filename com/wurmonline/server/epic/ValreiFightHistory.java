...
public class ValreiFightHistory
{
  ...
  public void addFighter(long fighterId, String fighterName)
  {
    ...
    {
      this.fighters.put(Long.valueOf(fighterId), new ValreiFighter(fighterId, fighterName));
    }
    else
    {
      ValreiFighter f = (ValreiFighter)this.fighters.get(Long.valueOf(fighterId));
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\server\epic\ValreiFightHistory.class
