...
public class BMLBuilder
{
  ...
  public static BMLBuilder createNormalWindow(String id, String question, BMLBuilder content)
  {
    BMLBuilder header = createCenteredNode(
      createGenericBuilder().addText(question, null, TextType.BOLD, null));
  ...
  {
    NONE(""),  BOLD("bold"),  ITALIC("italic"),  BOLDITALIC("bolditalic");
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\server\utils\BMLBuilder.class
