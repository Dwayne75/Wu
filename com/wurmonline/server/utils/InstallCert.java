...
public final class InstallCert
{
  ...
  public static void installCert(String host, int port, String password, String keystoreName)
    throws Exception
  {
    ...
    implements X509TrustManager
  {
    ...
    public void checkClientTrusted(X509Certificate[] aChain, String authType)
      throws CertificateException
    {
      throw new UnsupportedOperationException();
    }
    
    public void checkServerTrusted(X509Certificate[] aChain, String authType)
      throws CertificateException
    {
      this.chain = aChain;
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\server\utils\InstallCert.class
