  ...
  implements TimeConstants
{
  ...
  private static final String[] day_names = { "day of the Ant", "Luck day", "day of the Wurm", "Wrath day", "day of Tears", "day of Sleep", "day of Awakening" };
  ...
  public static String getTime()
  {
    ...
    String toReturn = StringUtil.format("It is %02d:%02d:%02d", new Object[] { Integer.valueOf(hour), Integer.valueOf(minute), Integer.valueOf(second) });
  ...
  public static final String getTimeFor(long wurmtime)
  {
    ...
    String toReturn = StringUtil.format("%02d:%02d:%02d", new Object[] { Integer.valueOf(hour), Integer.valueOf(minute), Integer.valueOf(second) });
    toReturn = toReturn + " on " + day_names[dayOfWeek] + " in week " + week + " of " + starfall_names[starfall] + " in the year of " + year + ".";
  ...
  public static boolean isEaster()
  {
    ...
    Calendar c = EasterCalculator.findHolyDay(Year.now().getValue());
    return (nowIsAfter(10, 0, c.get(5), c.get(2), c.get(1))) && 
      (nowIsBefore(10, 0, c.get(5) + 2, c.get(2), c.get(1)));
  }
  ...
  public static boolean isHalloween()
  {
    ...
    return nowIsBetween(0, 1, 28, 9, Year.now().getValue(), 23, 59, 5, 10, Year.now().getValue());
  }
    ...
    implements Runnable
  {
    public void run()
    {
      ...
      {
        WurmCalendar.logger.log(Level.WARNING, "Caught exception in ScheduledExecutorService while calling WurmCalendar.tickSecond()", e);
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\server\WurmCalendar.class
