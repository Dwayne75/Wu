...
public class FragmentUtilities
{
  ...
  public static void addRandomEnchantment(Item toEnchant, int enchLevel, float power)
  {
    ...
    FragmentEnchantment f = FragmentEnchantment.getRandomEnchantment(itemClass, enchLevel);
    if (f == null) {
      return;
    }
  ...
  {
    FLAMEAURA((byte)14, new float[] { 0.1F, 0.2F, 0.4F, 0.4F, 0.2F }, new byte[] { 1 }),  FROSTBRAND((byte)33, new float[] { 0.1F, 0.2F, 0.5F, 0.3F, 0.2F }, new byte[] { 1 }),  BLOODTHIRST((byte)45, new float[] { 0.2F, 0.4F, 0.2F, 0.1F, 0.0F }, new byte[] { 1 }),  ROTTINGTOUCH((byte)18, new float[] { 0.0F, 0.0F, 0.2F, 0.4F, 0.4F }, new byte[] { 1 }),  NIMBLENESS((byte)32, new float[] { 0.0F, 0.0F, 0.0F, 0.1F, 0.3F }, new byte[] { 1 }),  LIFETRANSFER((byte)26, new float[] { 0.0F, 0.0F, 0.0F, 0.1F, 0.3F }, new byte[] { 1 }),  MINDSTEALER((byte)31, new float[] { 0.0F, 0.0F, 0.05F, 0.2F, 0.4F }, new byte[] { 1 }),  AURASHAREDPAIN((byte)17, new float[] { 0.0F, 0.1F, 0.3F, 0.2F, 0.1F }, new byte[] { 2 }),  WEBARMOUR((byte)46, new float[] { 0.0F, 0.0F, 0.2F, 0.3F, 0.2F }, new byte[] { 2 }),  WINDOFAGES((byte)16, new float[] { 0.1F, 0.2F, 0.4F, 0.2F, 0.1F }, new byte[] { 1, 3 }),  CIRCLEOFCUNNING((byte)13, new float[] { 0.05F, 0.15F, 0.3F, 0.4F, 0.2F }, new byte[] { 1, 3 }),  BOTD((byte)47, new float[] { 0.0F, 0.05F, 0.2F, 0.4F, 0.2F }, new byte[] { 1, 3 }),  MAGBRASS((byte)Byte.MIN_VALUE, new float[] { 0.05F, 0.1F, 0.05F, 0.025F, 0.0F }, new byte[] { 6 }),  MAGBRONZE((byte)-127, new float[] { 0.1F, 0.125F, 0.05F, 0.0F, 0.0F }, new byte[] { 3 }),  MAGADAMANTINE((byte)-125, new float[] { 0.05F, 0.1F, 0.05F, 0.025F, 0.0F }, new byte[] { 5 }),  MAGGLIMMERSTEEL((byte)-124, new float[] { 0.1F, 0.05F, 0.0F, 0.0F, 0.0F }, new byte[] { 3 }),  MAGGOLD((byte)-123, new float[] { 0.05F, 0.05F, 0.025F, 0.0F, 0.0F }, new byte[] { 6 }),  MAGSILVER((byte)-122, new float[] { 0.05F, 0.1F, 0.05F, 0.025F, 0.0F }, new byte[] { 4 }),  MAGSTEEL((byte)-121, new float[] { 0.05F, 0.025F, 0.0F, 0.0F, 0.0F }, new byte[] { 5 }),  MAGCOPPER((byte)-120, new float[] { 0.1F, 0.15F, 0.05F, 0.0F, 0.0F }, new byte[] { 6 }),  MAGLEAD((byte)-118, new float[] { 0.05F, 0.1F, 0.05F, 0.025F, 0.0F }, new byte[] { 6 }),  MAGZINC((byte)-117, new float[] { 0.05F, 0.025F, 0.0F, 0.0F, 0.0F }, new byte[] { 5 }),  MAGSERYLL((byte)-116, new float[] { 0.025F, 0.05F, 0.1F, 0.125F, 0.075F }, new byte[] { 6 }),  FOBRASS((byte)-115, new float[] { 0.05F, 0.05F, 0.025F, 0.0F, 0.0F }, new byte[] { 3 }),  FOBRONZE((byte)-114, new float[] { 0.05F, 0.1F, 0.125F, 0.05F, 0.025F }, new byte[] { 5 }),  FOTIN((byte)-113, new float[] { 0.1F, 0.125F, 0.05F, 0.0F, 0.0F }, new byte[] { 6 }),  FOADAMANTINE((byte)-112, new float[] { 0.05F, 0.1F, 0.05F, 0.025F, 0.0F }, new byte[] { 6 }),  FOGLIMMERSTEEL((byte)-111, new float[] { 0.025F, 0.0F, 0.0F, 0.0F, 0.0F }, new byte[] { 3 }),  FOGOLD((byte)-110, new float[] { 0.05F, 0.05F, 0.025F, 0.0F, 0.0F }, new byte[] { 3 }),  FOSILVER((byte)-109, new float[] { 0.025F, 0.0F, 0.0F, 0.0F, 0.0F }, new byte[] { 3 }),  FOSTEEL((byte)-108, new float[] { 0.1F, 0.125F, 0.05F, 0.025F, 0.0F }, new byte[] { 6 }),  FOLEAD((byte)-105, new float[] { 0.025F, 0.05F, 0.025F, 0.0F, 0.0F }, new byte[] { 3 }),  FOSERYLL((byte)-103, new float[] { 0.025F, 0.05F, 0.1F, 0.125F, 0.075F }, new byte[] { 6 }),  VYNBRASS((byte)-102, new float[] { 0.05F, 0.1F, 0.05F, 0.025F, 0.0F }, new byte[] { 6 }),  VYNBRONZE((byte)-101, new float[] { 0.05F, 0.1F, 0.125F, 0.05F, 0.025F }, new byte[] { 5 }),  VYNTIN((byte)-100, new float[] { 0.025F, 0.05F, 0.1F, 0.1F, 0.05F }, new byte[] { 6 }),  VYNADAMANTINE((byte)-99, new float[] { 0.05F, 0.1F, 0.05F, 0.025F, 0.0F }, new byte[] { 5 }),  VYNGLIMMERSTEEL((byte)-98, new float[] { 0.025F, 0.05F, 0.1F, 0.05F, 0.0F }, new byte[] { 3 }),  VYNSILVER((byte)-96, new float[] { 0.025F, 0.05F, 0.1F, 0.05F, 0.025F }, new byte[] { 4 }),  VYNSTEEL((byte)-95, new float[] { 0.025F, 0.05F, 0.1F, 0.05F, 0.0F }, new byte[] { 6 }),  VYNCOPPER((byte)-94, new float[] { 0.05F, 0.1F, 0.125F, 0.05F, 0.0F }, new byte[] { 6 }),  VYNLEAD((byte)-92, new float[] { 0.1F, 0.05F, 0.025F, 0.0F, 0.0F }, new byte[] { 4 }),  VYNSERYLL((byte)-90, new float[] { 0.025F, 0.05F, 0.1F, 0.125F, 0.075F }, new byte[] { 6 }),  LIBBRASS((byte)-89, new float[] { 0.05F, 0.025F, 0.0F, 0.0F, 0.0F }, new byte[] { 3 }),  LIBBRONZE((byte)-88, new float[] { 0.025F, 0.05F, 0.025F, 0.0F, 0.0F }, new byte[] { 3 }),  LIBTIN((byte)-87, new float[] { 0.025F, 0.05F, 0.1F, 0.05F, 0.025F }, new byte[] { 6 }),  LIBADAMANTINE((byte)-86, new float[] { 0.025F, 0.05F, 0.1F, 0.05F, 0.0F }, new byte[] { 6 }),  LIBGLIMMERSTEEL((byte)-85, new float[] { 0.025F, 0.05F, 0.1F, 0.05F, 0.0F }, new byte[] { 3 }),  LIBGOLD((byte)-84, new float[] { 0.025F, 0.05F, 0.025F, 0.0F, 0.0F }, new byte[] { 3 }),  LIBSILVER((byte)-83, new float[] { 0.025F, 0.05F, 0.1F, 0.05F, 0.025F }, new byte[] { 4 }),  LIBSTEEL((byte)-82, new float[] { 0.025F, 0.05F, 0.025F, 0.0F, 0.0F }, new byte[] { 5 }),  LIBLEAD((byte)-79, new float[] { 0.025F, 0.05F, 0.025F, 0.0F, 0.0F }, new byte[] { 3 }),  LIBZINC((byte)-78, new float[] { 0.05F, 0.1F, 0.05F, 0.025F, 0.0F }, new byte[] { 6 }),  LIBSERYLL((byte)-77, new float[] { 0.025F, 0.05F, 0.1F, 0.125F, 0.075F }, new byte[] { 6 }),  JACKALBRASS((byte)-76, new float[] { 0.025F, 0.01F, 0.0F, 0.0F, 0.0F }, new byte[] { 6 }),  JACKALGLIMMERSTEEL((byte)-72, new float[] { 0.025F, 0.01F, 0.0F, 0.0F, 0.0F }, new byte[] { 3 }),  JACKALGOLD((byte)-71, new float[] { 0.025F, 0.05F, 0.025F, 0.0F, 0.0F }, new byte[] { 6 }),  JACKALSILVER((byte)-70, new float[] { 0.025F, 0.05F, 0.025F, 0.0F, 0.0F }, new byte[] { 4 }),  JACKALSTEEL((byte)-69, new float[] { 0.025F, 0.05F, 0.1F, 0.05F, 0.01F }, new byte[] { 6 }),  JACKALCOPPER((byte)-68, new float[] { 0.05F, 0.1F, 0.125F, 0.05F, 0.0F }, new byte[] { 4 }),  JACKALIRON((byte)-67, new float[] { 0.025F, 0.01F, 0.0F, 0.0F, 0.0F }, new byte[] { 3 }),  JACKALLEAD((byte)-66, new float[] { 0.025F, 0.0F, 0.0F, 0.0F, 0.0F }, new byte[] { 6 }),  JACKALZINC((byte)-65, new float[] { 0.025F, 0.05F, 0.025F, 0.0F, 0.0F }, new byte[] { 5 }),  JACKALSERYLL((byte)-64, new float[] { 0.025F, 0.05F, 0.1F, 0.125F, 0.075F }, new byte[] { 6 }),  UNKBRASS((byte)-63, new float[] { 0.0F, 0.01F, 0.025F, 0.05F, 0.1F }, new byte[] { 6 }),  UNKBRONZE((byte)-62, new float[] { 0.0F, 0.01F, 0.025F, 0.05F, 0.1F }, new byte[] { 6 }),  UNKTIN((byte)-61, new float[] { 0.0F, 0.01F, 0.025F, 0.05F, 0.1F }, new byte[] { 6 }),  UNKADAMANTINE((byte)-60, new float[] { 0.0F, 0.01F, 0.025F, 0.05F, 0.1F }, new byte[] { 6 }),  UNKGLIMMERSTEEL((byte)-59, new float[] { 0.0F, 0.01F, 0.025F, 0.05F, 0.1F }, new byte[] { 3 }),  UNKGOLD((byte)-58, new float[] { 0.0F, 0.01F, 0.025F, 0.05F, 0.1F }, new byte[] { 6 }),  UNKSILVER((byte)-57, new float[] { 0.0F, 0.01F, 0.025F, 0.05F, 0.1F }, new byte[] { 4 }),  UNKSTEEL((byte)-56, new float[] { 0.0F, 0.01F, 0.025F, 0.05F, 0.1F }, new byte[] { 6 }),  UNKCOPPER((byte)-55, new float[] { 0.0F, 0.01F, 0.025F, 0.05F, 0.1F }, new byte[] { 6 }),  UNKIRON((byte)-54, new float[] { 0.0F, 0.01F, 0.025F, 0.05F, 0.1F }, new byte[] { 6 }),  UNKLEAD((byte)-53, new float[] { 0.0F, 0.01F, 0.025F, 0.05F, 0.1F }, new byte[] { 3 }),  UNKZINC((byte)-52, new float[] { 0.0F, 0.01F, 0.025F, 0.05F, 0.1F }, new byte[] { 6 }),  UNKSERYLL((byte)-51, new float[] { 0.0F, 0.0F, 0.025F, 0.075F, 0.15F }, new byte[] { 6 });
    ...
    static FragmentEnchantment getRandomEnchantment(byte itemClass, int level)
    {
      ...
      float thisVal = 0.0F;
      FragmentEnchantment[] arrayOfFragmentEnchantment2 = values();FragmentEnchantment f = arrayOfFragmentEnchantment2.length;
      for (FragmentEnchantment localFragmentEnchantment1 = 0; localFragmentEnchantment1 < f; localFragmentEnchantment1++)
      {
        FragmentEnchantment f = arrayOfFragmentEnchantment2[localFragmentEnchantment1];
        
        byte[] arrayOfByte2 = f.itemClass;b = arrayOfByte2.length;
        for (byte b1 = 0; b1 < b; b1++)
        {
          byte b = arrayOfByte2[b1];
          if ((b == itemClass) || (b == 6))
          {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\server\items\FragmentUtilities.class
