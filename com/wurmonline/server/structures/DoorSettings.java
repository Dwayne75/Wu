...
{
  public static enum DoorPermissions
    implements Permissions.IPermission
  {
    PASS(1, "Pass Door", "Pass", "Door", "Allows entry through this door even when its locked."),  EXCLUDE(15, "Deny All", "Deny", "All", "Deny all access.");
  ...
  public static enum GatePermissions
    implements Permissions.IPermission
  {
    MANAGE(0, "Manage Item", "Manage", "Item", "Allows managing of these permissions."),  PASS(1, "Pass Gate", "Pass", "Gate", "Allows entry through this gate even when its locked."),  LOCK(2, "(Un)Lock Gate", "(Un)Lock", "Gate", "Allows locking (and unlocking) of this gate."),  EXCLUDE(15, "Deny All", "Deny", "All", "Deny all access.");
  ...
  public static boolean mayPass(PermissionsPlayerList.ISettings is, Creature creature)
  {
    ...
    return hasPermission(is, creature, DoorPermissions.PASS.getBit());
  }
  ...
  public static boolean mayLock(PermissionsPlayerList.ISettings is, Creature creature)
  {
    ...
    return hasPermission(is, creature, GatePermissions.LOCK.getBit());
  }
  ...
  public static boolean isExcluded(PermissionsPlayerList.ISettings is, Creature creature)
  {
    ...
    return hasPermission(is, creature, DoorPermissions.EXCLUDE.getBit());
  }
}


/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\server\structures\DoorSettings.class
