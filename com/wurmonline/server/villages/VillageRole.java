  ...
  implements VillageStatus, MiscConstants
{
  ...
  public static enum RolePermissions
    implements Permissions.IPermission
  {
    BUTCHER(0, "Animals", "Butcher"),  GROOM(1, "Animals", "Groom"),  LEAD(2, "Animals", "Lead"),  MILK_SHEAR(3, "Animals", "Milk and Shear"),  SACRIFICE(4, "Animals", "Sacrifice"),  TAME(5, "Animals", "Tame"),  BUILD(6, "Construction", "Build"),  DESTROY_FENCE(7, "Construction", "Destroy Fence"),  DESTROY_ITEMS(8, "Construction", "Destroy Items"),  PICK_LOCKS(9, "Construction", "Pick Locks"),  PLAN_BUILDINGS(10, "Construction", "Plan Buildings"),  CULTIVATE(11, "Digging", "Cultivate"),  DIG_RESOURCE(12, "Digging", "Dig Resource"),  TERRAFORM(13, "Digging", "Terraform"),  HARVEST_FIELDS(14, "Farming", "Harvest Fields"),  SOW_FIELDS(15, "Farming", "Sow Fields"),  TEND_FIELDS(16, "Farming", "Tend Fields"),  CHOP_DOWN_ALL_TREES(17, "Forestry/Gardening", "Chop Down All Trees"),  CHOP_DOWN_OLD_TREES(18, "Forestry/Gardening", "Chop Down Old Trees"),  CUT_GRASS(19, "Forestry/Gardening", "Cut Grass"),  HARVEST_FRUIT(20, "Forestry/Gardening", "Harvest Fruit"),  MAKE_LAWN(21, "Forestry/Gardening", "Make Lawn"),  PICK_SPROUTS(22, "Forestry/Gardening", "Pick Sprouts"),  PLANT_FLOWERS(23, "Forestry/Gardening", "Plant Flowers"),  PLANT_SPROUTS(24, "Forestry/Gardening", "Plant Sprouts"),  PRUNE(25, "Prune", "Prune"),  ATTACK_CITIZENS(26, "General", "Attack Citizens"),  ATTACK_NON_CITIZENS(27, "General", "Attack Non Citizens"),  CAST_DEITY_SPELLS(28, "General", "Cast Deity Spells"),  CAST_SORCERY_SPELLS(29, "General", "Cast Sorcery Spells"),  FORAGE(30, "General", "Forage/Botanize"),  PLACE_MERCHANTS(31, "General", "May Place Merchants");
  ...
  public static enum MoreRolePermissions
    implements Permissions.IPermission
  {
    MEDITATION_ABILITY(0, "General", "Use Meditation Ability"),  ATTACH_LOCKS(1, "Item Management", "Attach Locks"),  IMPROVE_REPAIR(2, "Item Management", "Improve / Repair"),  LOAD(3, "Item Management", "Load"),  PICKUP(4, "Item Management", "Pickup"),  PICKUP_PLANTED(5, "Item Management", "Pickup Planted Items"),  PULL_PUSH(6, "Item Management", "Pull/Push/Turn"),  MINE_FLOOR(7, "Mining", "Mine Floor"),  MINE_IRON(8, "Mining", "Mine Iron Vein"),  MINE_OTHER(9, "Mining", "Mine Other Vein"),  MINE_ROCK(10, "Mining", "Mine Rock"),  SURFACE_MINING(11, "Mining", "Surface Mining"),  TUNNEL(12, "Mining", "Tunnelling"),  ALLOW_ACTIONS_ON_ALLIED_DEED(13, "Settlement Management", "Allow Actions on Allied Deeds"),  DIPLOMAT(14, "Settlement Management", "Diplomat"),  DESTROY_ANY_BUILDING(15, "Construction", "Destroy Any Building"),  INVITE_CITIZENS(16, "Settlement Management", "Invite Citizens"),  MANAGE_CITIZEN_ROLES(17, "Settlement Management", "Manage Citizen Roles"),  MANAGE_GUARDS(18, "Settlement Management", "Manage Guards"),  MANAGE_MAP(19, "Settlement Management", "Manage Map"),  MANAGE_REPUTATIONS(20, "Settlement Management", "Manage Reputations"),  MANAGE_ROLES(21, "Settlement Management", "Manage Roles"),  MANAGE_SETTINGS(22, "Settlement Management", "Manage Settings"),  MAY_CONFIGURE_TWITTER(23, "Settlement Management", "May Configure Twitter"),  RESIZE(24, "Settlement Management", "Resize"),  MANAGE_ALLOWED_OBJECTS(25, "Settlement Management", "Manage Allowed Objects"),  REINFORCE(26, "Mining", "Add/Remove Reinforcements"),  BREED(27, "Animals", "Breed"),  PACK(28, "Digging", "Pack"),  PAVE(29, "General", "Drop"),  DROP(30, "Item Management", "Drop"),  UNLOAD(31, "Item Management", "Unload");
  ...
  public static enum ExtraRolePermissions
    implements Permissions.IPermission
  {
    BRAND(0, "Animals", "Brand"),  PASS_GATES(1, "General", "Pass Gates"),  PLANT_ITEM(2, "Item Management", "Plant Items"),  SPARE03(3, "Unknown", "Spare");
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\server\villages\VillageRole.class
