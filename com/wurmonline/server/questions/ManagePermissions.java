  ...
  extends Question
{
  ...
  public void sendQuestion()
  {
    ...
    else
    {
      ...
      playerIdName[] trustedIdNames = new playerIdName[((List)trusted).size()];
      for (count = 0; count < ((List)trusted).size(); count++) {
        trustedIdNames[count] = new playerIdName(((Long)((List)trusted).get(count)).longValue());
      }
      ...
      playerIdName[] friendIdNames = new playerIdName[((List)friends).size()];
      for (count = 0; count < ((List)friends).size(); count++) {
        friendIdNames[count] = new playerIdName(((Long)((List)friends).get(count)).longValue());
      }
      ...
      playerIdName[] citizenIdNames = new playerIdName[citizens.size()];
      for (count = 0; count < citizens.size(); count++) {
        citizenIdNames[count] = new playerIdName(((Long)citizens.get(count)).longValue());
      }
    ...
    implements Comparable<playerIdName>
  {
    ...
    {
      return getName().compareTo(pin.getName());
    }
  }
}


/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\server\questions\ManagePermissions.class
