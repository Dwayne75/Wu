  ...
  extends Question
{
  ...
  {
    LinkedList<soundString> soundsList = new LinkedList();
    ...
    this.soundStrings = ((soundString[])soundsList.toArray(new soundString[soundsList.size()]));
  ...
  public void answer(Properties aAnswers)
  {
    ...
    soundString localsoundString1;
    soundString ss;
    if (playSound)
    {
      int sel = getIntProp("sel");
      soundString[] arrayOfsoundString1 = this.soundStrings;int i = arrayOfsoundString1.length;
    ...
    if (select) {
      if (this.root != null)
      {
        ...
        soundString[] arrayOfsoundString2 = this.soundStrings;localsoundString1 = arrayOfsoundString2.length;
        for (ss = 0; ss < localsoundString1; ss++)
        {
          soundString ss = arrayOfsoundString2[ss];
          if (ss.getId() == sel)
          {
  ...
  public void sendQuestion()
  {
    ...
    {
    case 1: 
      Arrays.sort(this.soundStrings, new Comparator()
      {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\server\questions\SoundList.class
