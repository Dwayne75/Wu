  ...
  implements CounterTypes, TimeConstants, CreatureTypes
{
  ...
  private void sendMissionList()
  {
    ...
    if (missions.length > 0)
    {
      ...
      {
      case 1: 
        Arrays.sort(missions, new Comparator()
        {
  ...
  private void sendTriggerList()
  {
    ...
    if (trigs.length > 0)
    {
      ...
      {
      case 1: 
        Arrays.sort(trigs, new Comparator()
        {
  ...
  private void sendEffectList()
  {
    ...
    if (effs.length > 0)
    {
      ...
      {
      case 1: 
        Arrays.sort(effs, new Comparator()
        {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\server\questions\MissionManager.class
