  ...
  extends Question
{
  ...
  public String sendTargetActionRecipes()
  {
    ...
    {
    case 0: 
      Arrays.sort(recipes, new Comparator()
      {
  ...
  public String sendIngredientsList()
  {
    ...
    case 0: 
    case 1: 
      Arrays.sort(this.ingredients, new Comparator()
      {
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\server\questions\CookBookQuestion.class
