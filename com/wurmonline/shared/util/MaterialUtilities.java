  ...
  implements ItemMaterials
{
  ...
  public static final void appendNameWithMaterial(StringBuilder sb, String baseName, byte materialId)
  {
    ...
    else
    {
      ...
      if (pos != -1)
      {
        String baseNameBefore = baseName.substring(0, pos);
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\shared\util\MaterialUtilities.class
