...
public class FishingEnums
{
  ...
  {
    NONE((byte)0, ""),  ROACH((byte)1, "model.fish.roach."),  PERCH((byte)2, "model.fish.perch."),  TROUT((byte)3, "model.fish.trout."),  PIKE((byte)4, "model.fish.pike."),  CATFISH((byte)5, "model.fish.catfish."),  SNOOK((byte)6, "model.fish.snook."),  HERRING((byte)7, "model.fish.herring."),  CARP((byte)8, "model.fish.carp."),  BASS((byte)9, "model.fish.bass."),  SALMON((byte)10, "model.fish.salmon."),  OCTOPUS((byte)11, "model.fish.octopus."),  MARLIN((byte)12, "model.fish.marlin."),  BLUESHARK((byte)13, "model.fish.blueshark."),  DORADO((byte)14, "model.fish.dorado."),  SAILFISH((byte)15, "model.fish.sailfish."),  WHITESHARK((byte)16, "model.fish.whiteshark."),  TUNA((byte)17, "model.fish.tuna."),  MINNOW((byte)18, "model.fish.minnow."),  LOACH((byte)19, "model.fish.loach."),  WURMFISH((byte)20, "model.fish.wurmfish."),  SARDINE((byte)21, "model.fish.sardine."),  CLAM((byte)22, "model.fish.clam.");
  ...
  {
    FISHING_POLE((byte)0, "model.fish.pole.", (short)786),  FISHING_ROD_BASIC((byte)1, "model.fish.rod.basic.", (short)866),  FISHING_ROD_FINE((byte)2, "model.fish.rod.fine.", (short)866),  FISHING_ROD_DEEP_WATER((byte)3, "model.fish.rod.water.", (short)866),  FISHING_ROD_DEEP_SEA((byte)4, "model.fish.rod.sea.", (short)866),  FISHING_ROD_BASIC_WITH_LINE((byte)5, "model.fish.rod.basic.", (short)886),  FISHING_ROD_FINE_WITH_LINE((byte)6, "model.fish.rod.fine.", (short)886),  FISHING_ROD_DEEP_WATER_WITH_LINE((byte)7, "model.fish.rod.water.", (short)886),  FISHING_ROD_DEEP_SEA_WITH_LINE((byte)8, "model.fish.rod.sea.", (short)886);
  ...
  {
    NONE((byte)0, ""),  FEATHER((byte)1, "model.float.feather."),  TWIG((byte)2, "model.float.twig."),  MOSS((byte)3, "model.float.moss."),  BARK((byte)4, "model.float.bark.");
  ...
  {
    NONE((byte)0, ""),  FLY((byte)1, "model.bait.fly."),  CHEESE((byte)2, "model.bait.cheese."),  DOUGH((byte)3, "model.bait.dough."),  WURM((byte)4, "model.bait.wurm."),  SARDINE((byte)5, "model.fish.sardine."),  ROACH((byte)6, "model.fish.roach."),  PERCH((byte)7, "model.fish.perch."),  MINNOW((byte)8, "model.fish.cave.minnow."),  FISH_BAIT((byte)9, "model.bait.fish."),  GRUB((byte)10, "model.bait.grub."),  WHEAT((byte)11, "model.bait.wheat."),  CORN((byte)12, "model.bait.corn.");
  ...
  {
    NONE((byte)0, ""),  LIGHT((byte)1, "model.fishingreel.light."),  MEDIUM((byte)2, "model.fishingreel.medium."),  DEEP_WATER((byte)3, "model.fishingreel.deepwater."),  PROFESSIONAL((byte)4, "model.fishingreel.professional.");
  ...
  {
    NONE((byte)0, ""),  WOOD((byte)1, "model.tool.fish.hook."),  METAL((byte)2, "model.tool.fish.hook."),  BONE((byte)3, "model.tool.fish.hook.");
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\shared\constants\FishingEnums.class
