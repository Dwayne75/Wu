...
public abstract interface ProtoConstants
{
  ...
  {
    crush((byte)0),  slash((byte)1),  pierce((byte)2),  bite((byte)3),  burn((byte)4),  poison((byte)5),  infection((byte)6),  water((byte)7),  cold((byte)8),  internal((byte)9),  acid((byte)10);
  ...
  {
    verylight((byte)1),  light((byte)1),  medium((byte)3),  bad((byte)4),  severe((byte)5);
  ...
  {
    verylight((byte)1),  light((byte)2),  medium((byte)3),  bad((byte)4),  severe((byte)5);
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\shared\constants\ProtoConstants.class
