...
public class ValreiConstants
{
  ...
  public static String getFightActionSummary(ValreiFightAction fightAction)
  {
    ...
    case 5: 
      return 
        "Fighter(" + bb.getLong() + ") vs Defender(" + bb.getLong() + ") " + getAttackStatus(bb.get()) + " for " + bb.getFloat() + " damage";
    case 6: 
    case 7: 
      return 
        "Fighter(" + bb.getLong() + ") vs Defender(" + bb.getLong() + ") " + getSpellType(bb.get()) + "(" + getAttackStatus(bb.get()) + ") for " + bb.getFloat() + " damage";
    case 8: 
  ...
  public static byte[] getAttackData(long fighterId, long defenderId, float damageDealt)
  {
    ...
    bb.put((byte)(damageDealt > 0.0F ? 2 : damageDealt < 0.0F ? 0 : 1));
  ...
  public static byte[] getSpellData(long fighterId, long defenderId, byte spellType, float damageDealt)
  {
    ...
    bb.putLong(defenderId);
    bb.put(spellType);
    bb.put((byte)(damageDealt > 0.0F ? 2 : damageDealt == -1.0F ? 0 : 1));
    bb.putFloat(damageDealt);
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\shared\constants\ValreiConstants.class
