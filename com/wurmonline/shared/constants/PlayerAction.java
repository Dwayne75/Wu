  ...
  implements PlayerActionConstants
{
  ...
  public PlayerAction(String bind, short aId, int aTargetMask, String aName)
  {
    ...
    actionIds.put(Short.valueOf(aId), this);
    this.bind = bind;
  }
  ...
  {
    return (PlayerAction)actionIds.get(Short.valueOf(id));
  }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\com\wurmonline\shared\constants\PlayerAction.class
