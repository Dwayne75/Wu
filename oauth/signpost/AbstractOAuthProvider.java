  ...
  implements OAuthProvider
{
    ...
    throws OAuthMessageSignerException, OAuthNotAuthorizedException, OAuthExpectationFailedException, OAuthCommunicationException
  {
    ...
    if (this.isOAuth10a) {
      return OAuth.addQueryParameters(this.authorizationWebsiteUrl, new String[] { "oauth_token", consumer.getToken() });
    }
    return OAuth.addQueryParameters(this.authorizationWebsiteUrl, new String[] { "oauth_token", consumer.getToken(), "oauth_callback", callbackUrl });
  }
    ...
    throws OAuthMessageSignerException, OAuthCommunicationException, OAuthNotAuthorizedException, OAuthExpectationFailedException
  {
    ...
    try
    {
      ...
      consumer.setTokenWithSecret(token, secret); return;
    }
...
/* Location:              C:\Games\SteamLibrary\steamapps\common\Wurm Unlimited Dedicated Server\server.jar!\oauth\signpost\AbstractOAuthProvider.class
